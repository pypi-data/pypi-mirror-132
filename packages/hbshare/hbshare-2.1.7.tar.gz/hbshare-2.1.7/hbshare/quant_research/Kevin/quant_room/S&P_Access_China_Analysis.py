...
import os
from hbshare.quant_research.Kevin.rm_associated.util.config import style_name, industry_name
...
class AccessChinaAnalysis:
    ...
    def _load_benchmark_weight_series(self, ticker=None):
        ...
        sql_script = "SELECT (select a.SecuCode from hsjy_gp.SecuMain a where a.InnerCode = b.InnerCode and " \
                     ...
                     "b.IndexCode = '{}' and b.EndDate = to_date('{}', 'yyyymmdd')".format(inner_code, self.trade_date)
