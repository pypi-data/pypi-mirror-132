...
import pandas as pd
import numpy as np
from hbshare.quant_research.Kevin.rm_associated.util.data_loader import SectorIndexCalculatorLoader
from hbshare.quant_research.Kevin.rm_associated.util.config import industry_cluster_dict_new
...
if __name__ == '__main__':
    ...
    res = SectorIndexCalculator('20211201', '20211215').get_construct_result()
    # print(res)