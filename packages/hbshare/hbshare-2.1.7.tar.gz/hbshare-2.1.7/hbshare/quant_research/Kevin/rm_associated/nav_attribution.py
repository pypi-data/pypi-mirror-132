...
from hbshare.quant_research.Kevin.rm_associated.util.verifier import verify_type
from hbshare.quant_research.Kevin.rm_associated.util.exception import InputParameterError, PreprocessError
from hbshare.quant_research.Kevin.rm_associated.util.logger import logger
from hbshare.quant_research.Kevin.rm_associated.util.data_loader import NavAttributionLoader
from hbshare.quant_research.Kevin.rm_associated.util.regressions import Regression
...
if __name__ == '__main__':
    # 公募样例：110011
    # res = StyleAttribution(fund_id='001975', fund_type='mutual', start_date='20201231', end_date='20211015',
    #                        factor_type='style_allo', benchmark_id='000985', nav_frequency='day').get_all(processed=False)
    # 私募样例
