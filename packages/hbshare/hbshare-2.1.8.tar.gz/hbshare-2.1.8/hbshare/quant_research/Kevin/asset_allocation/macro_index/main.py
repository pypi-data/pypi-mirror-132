...
from hbshare.quant_research.Kevin.rm_associated.config import engine_params, style_names
from hbshare.quant_research.Kevin.rm_associated.util.config import factor_map_dict
...
if __name__ == '__main__':
    ...
    # pic = StockBondRotation(index_name='HS300', start_date='20150101').draw_picture_premium()
    ...
    # pic = StockTradingCrIndex('20190101', '20210423').draw_cr_picture()
