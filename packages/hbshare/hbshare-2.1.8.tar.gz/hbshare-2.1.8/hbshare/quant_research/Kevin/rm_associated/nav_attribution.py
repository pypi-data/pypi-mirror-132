...
if __name__ == '__main__':
    # 公募样例：110011
    res = StyleAttribution(fund_id='510500', fund_type='mutual', start_date='20191217', end_date='20211217',
                           factor_type='style', benchmark_id='000905', nav_frequency='day').get_all(processed=False)
    # 私募样例
