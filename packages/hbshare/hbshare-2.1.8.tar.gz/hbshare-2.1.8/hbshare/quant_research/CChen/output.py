#!/usr/bin/python
# coding:utf-8
from hbshare.quant_research.CChen.load_data import load_funds_data, load_funds_alpha
from hbshare.quant_research.CChen.fund_perf import ret
import pandas as pd
import numpy as np
import pyecharts.options as opts
from datetime import datetime, timedelta
from pyecharts.charts import Line, Grid, Bar, Boxplot
from pyecharts.globals import ThemeType
from pyecharts.commons.utils import JsCode
import pymysql
from sqlalchemy import create_engine
from hbshare.quant_research.CChen.cons import index_underlying, underlying_code
from hbshare.quant_research.CChen.fut import (
    wind_fin_fut_index,
...
from hbshare.quant_research.CChen.load_hsjy import load_fut_fin
from hbshare.quant_research.CChen.stk import load_index
from hbshare.quant_research.CChen.cons import sql_write_path_hb, HSJY_VIRTUAL_CONTRACT
...
def index_fut_basis_wind(
        ...
        grid_width=1200, grid_height=400, zoom_left=0, zoom_right=100,
        chart_pos_left=10, chart_pos_right=15,
):
