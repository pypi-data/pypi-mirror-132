...
from hbshare.quant_research.CChen.cons import properties_stk_k, db, db_tables
from hbshare.quant_research.CChen.func import generate_table
from hbshare.quant_research.CChen.sql_l import sql_quote
