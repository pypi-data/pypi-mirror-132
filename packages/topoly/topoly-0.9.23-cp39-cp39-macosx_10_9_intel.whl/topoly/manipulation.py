...
class MMCIFDataParser(PdbDataParser):
    ...
    def load_nxyz(self, mmcif_dict): 
        ...
        n_vec = [x for x in mmcif_dict['_atom_site.label_seq_id']]
        x_vec = [x for x in mmcif_dict['_atom_site.Cartn_x']]
        y_vec = [x for x in mmcif_dict['_atom_site.Cartn_y']]
        z_vec = [x for x in mmcif_dict['_atom_site.Cartn_z']]
        nxyz = {}
