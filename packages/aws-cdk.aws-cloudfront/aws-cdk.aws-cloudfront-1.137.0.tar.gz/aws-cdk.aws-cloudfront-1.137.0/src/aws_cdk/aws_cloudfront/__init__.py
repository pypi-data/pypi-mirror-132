...
class CloudFrontWebDistributionProps:
    def __init__(
        ...
        *,
        ...
        :exampleMetadata: lit=test/example.default-cert-alias.lit.ts
...
class S3OriginConfig:
    def __init__(
        ...
        *,
        ...
        :exampleMetadata: lit=test/example.iam-cert-alias.lit.ts
...
class SSLMethod(enum.Enum):
    ...
    :exampleMetadata: lit=test/example.acm-cert-alias.lit.ts
