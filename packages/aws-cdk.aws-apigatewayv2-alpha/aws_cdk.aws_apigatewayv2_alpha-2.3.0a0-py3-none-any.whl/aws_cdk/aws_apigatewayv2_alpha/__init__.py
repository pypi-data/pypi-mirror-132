        ...
        *,
        ...
        Example::
            ...
            http_authorizer_props = apigatewayv2_alpha.HttpAuthorizerProps(
                http_api=http_api,
                identity_source=["identitySource"],
                type=apigatewayv2_alpha.HttpAuthorizerType.JWT,
        ...
        *,
        ...
        Example::
            ...
            http_integration_props = apigatewayv2_alpha.HttpIntegrationProps(
                http_api=http_api,
                integration_type=apigatewayv2_alpha.HttpIntegrationType.LAMBDA_PROXY,
                integration_uri="integrationUri",
        ...
        *,
        ...
        Example::
            ...
            http_route_integration_config = apigatewayv2_alpha.HttpRouteIntegrationConfig(
                payload_format_version=payload_format_version,
                type=apigatewayv2_alpha.HttpIntegrationType.LAMBDA_PROXY,
                uri="uri",
...
class WebSocketRouteOptions:
    def __init__(self, *, integration: WebSocketRouteIntegration) -> None:
