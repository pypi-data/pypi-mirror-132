...
from my_3D_mobject import *
class SpecialThreeDScene:
    pass
...
class Test_boxes(SpecialThreeDScene):
    ...
    def construct(self):
        ...
        boxes = MyBoxes(fill_color=GREY_A, resolution=(24, 24), bottom_size=(0.3, 0.3), gap=0.1)
...
class Boxes_by_image(SpecialThreeDScene):
    ...
    def construct(self):
        ...
        # print(Z)
        boxes = MyBoxes(fill_color=average_color(BLUE_D, GREY_A), bottom_size=(0.18, 0.18), resolution=(60, 45))
