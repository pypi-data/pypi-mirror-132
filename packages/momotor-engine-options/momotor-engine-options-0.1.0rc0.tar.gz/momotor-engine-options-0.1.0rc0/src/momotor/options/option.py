...
from momotor.options.types import OptionTypeLiteral, LocationType, SubDomainDefinitionType
...
class OptionDefinition:
    ...
    def resolve(self, providers: Providers, subdomains: SubDomainDefinitionType = None) -> typing.Any:
