...
class BaseServiceProps:
    def __init__(
        ...
        *,
        ...
        :exampleMetadata: lit=test/integ.service-with-http-namespace.lit.ts
...
class CfnHttpNamespace(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        props = CfnHttpNamespaceProps(description=description, name=name, tags=tags)
    ...
    def __init__(
        ...
        *,
        ...
        props = CfnPublicDnsNamespaceProps(
            description=description, name=name, properties=properties, tags=tags
        )
...
class CnameInstanceBaseProps(BaseInstanceProps):
    def __init__(
        ...
        *,
        ...
        :exampleMetadata: lit=test/integ.service-with-cname-record.lit.ts
...
class DnsServiceProps(BaseServiceProps):
    def __init__(
        ...
        *,
        ...
        :exampleMetadata: lit=test/integ.service-with-public-dns-namespace.lit.ts
...
class PrivateDnsNamespace(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: A name for the Namespace.
        '''
        props = PrivateDnsNamespaceProps(vpc=vpc, description=description, name=name)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[BaseNamespaceProps],
    name_mapping={"description": "description", "name": "name", "vpc": "vpc"},
)
...
class PublicDnsNamespace(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: A name for the Namespace.
        '''
        props = PublicDnsNamespaceProps(description=description, name=name)
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            # namespace is of type INamespace
...
class HttpNamespace(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: A name for the Namespace.
        '''
        props = HttpNamespaceProps(description=description, name=name)
