...
from zypev1.models.playlist_entitlement_metadata import PlaylistEntitlementMetadata
from zypev1.models.check_entitlement_response import CheckEntitlementResponse


class PlaylistEntitlementsController(BaseController):

    """A Controller to access Endpoints in the zypev1 API."""

    def __init__(self, config, call_back=None):
        super(PlaylistEntitlementsController, self).__init__(config, call_back)

    def consumer_playlists_get(self,
                               id=None,
                               created_at=None,
                               expires_at=None,
                               transaction_id=None,
                               ...
                               page=None,
                               per_page=None):
        """Does a GET request to /consumer/playlists.

        List All Playlist Entitlements
        ...
        Args:
            ...
            transaction_type (string, optional): + Examples     + purchase    
                + subscription     + rental
            playlist_id (string, optional): Filter by playlist
        ...
        Returns:
            list of PlaylistEntitlementMetadata: Response from the API.
        ...
        decoded = APIHelper.json_deserialize(_response.text, PlaylistEntitlementMetadata.from_dictionary)

        return decoded

    def consumers_playlists_by_consumer_id_get(self,
                                               consumer_id):
        """Does a GET request to /consumers/{consumer_id}/playlists.

        List Playlist Entitlements

        Args:
            consumer_id (string): ID of the consumer whose playlist
                entitlements will be retrieved

        Returns:
            PlaylistEntitlementMetadata: Response from the API.
        ...
        # Prepare query URL
        _url_path = '/consumers/{consumer_id}/playlists'
    ...
    def consumers_playlists_by_consumer_id_post(self,
                                                body,
                                                consumer_id):
        """Does a POST request to /consumers/{consumer_id}/playlists.

        Create Playlist Entitlement

        Args:
            body (PlaylistEntitlementRequest): TODO: type description here.
    ...
    def consumers_playlists_by_consumer_id_and_id_get(self,
                                                      consumer_id,
                                                      id):
        """Does a GET request to /consumers/{consumer_id}/playlists/{id}.
        ...
        Args:
            consumer_id (string): ID of the consumer whose video entitlements
                will be retrieved
            id (string): ID of the playlist entitlement
        ...
        # Prepare query URL
        _url_path = '/consumers/{consumer_id}/playlists/{id}'
        _url_path = APIHelper.append_url_with_template_parameters(_url_path, {
            'consumer_id': {'value': consumer_id, 'encode': True},
    ...
    def consumers_playlists_by_consumer_id_and_id_put(self,
                                                      consumer_id,
                                                      id,
                                                      body):
        """Does a PUT request to /consumers/{consumer_id}/playlists/{id}.
    ...
    def consumers_playlists_by_consumer_id_and_id_delete(self,
                                                         consumer_id,
                                                         id):
        """Does a DELETE request to /consumers/{consumer_id}/playlists/{id}.
    ...
    def playlists_entitled_by_id_get(self,
                                     id,
                                     access_token):
        """Does a GET request to /playlists/{id}/entitled.
        ...
        # Prepare query URL
        _url_path = '/playlists/{id}/entitled'
        _url_path = APIHelper.append_url_with_template_parameters(_url_path, {
            'id': {'value': id, 'encode': True}
        })
        _query_builder = self.config.get_base_uri()
