...
class BaseResponse(tornado.web.RequestHandler):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.hide_400_error_log:
            def log_request(handler):
                if 400 <= handler.get_status() < 500:
                    return
                tornado.web.Application.log_request(self.application, handler)
            self.application.log_request = log_request
