...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=jgUub
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:jgUuX)->jgUuX:
  pass
 @jgUul
 def get(cls,requested_file_locator:jgUuX):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=jgUub
 @jgUul
 def get(cls,state_file_locator:jgUuX,requested_storage:jgUuX,serializers:Dict[jgUuX,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[jgUuX,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:jgUuX)->jgUuX:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:jgUuX)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:jgUuX)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:jgUuX)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:jgUuX)->jgUuX:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[jgUuX]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:jgUuX,new_key:jgUuX,referenced_by_version:jgUuX=jgUub):
  pass
 @abc.abstractmethod
 def version_exists(self,key:jgUuX)->jgUuL:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:jgUuX,key:jgUuX):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:jgUuX,new_key:jgUuX,base_path:jgUuX)->jgUuL:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[jgUuX]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[jgUuX,jgUuX],remote_location:jgUuX=jgUub)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[jgUuX]:
  ...
  for cpvcs_obj in args:
   if jgUuJ(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif jgUuJ(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[jgUuX,jgUuX],remote_location:jgUuX=jgUub)->List[Union[Revision,Version]]:
