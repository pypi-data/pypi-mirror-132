...
class SSHClient(object):
    ...
    def callback(cls, transferred_bytes, total_bytes):
        logger.info("Transferred ... %.2f%%", transferred_bytes / total_bytes * 100)
    ...
    def upload(self, local_path: Text, remote_directory: Text) -> None:
        ...
        logger.info('Upload %s to %s successfully.', local_path, remote_directory)
    ...
    def upload_working(self, file_name, remote_directory) -> None:
        ...
        logger.info('Upload %s to %s successfully.', full_path, remote_directory)
    ...
    def download(self, remote_path: Text, local_directory: Text):
        ...
        self.__sftp.get(remote_path, os.path.join(local_directory, file_name))
        logger.info('Download %s to %s successfully.', remote_path, local_directory)
