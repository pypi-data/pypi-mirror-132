...
class ConditionWrapper:
    ...
    def __init__(self, table, column=None):
        ...
        self.current_conditions: list = self.conditions
        self.groups = ""
        self.order: list = []

    @property
    def or_(self):
        self.current_conditions.append(("OR", None, None))
        return self
    ...
    @property
    def and_(self):
        self.current_conditions.append(("AND", None, None))
        return self
    ...
    def eq(self, column, value):
        ...
        :return:
        """
        self.current_conditions.append(("=", column, value))
        return self
    ...
    def eq_all(self, params: list):
        ...
        :return:
        """
        [self.eq(*item) for item in params]
        return self
    ...
    def between(self, column, value1, value2):
        ...
        if value1 is None:
            ...
            self.current_conditions.append(("BETWEEN", column, [value1, value2]))
        return self
    ...
    def not_between(self, column, value1, value2):
        ...
        if value1 is None:
            ...
            self.current_conditions.append(("NOT_BETWEEN", column, [value1, value2]))
        return self
    ...
    def like(self, column, value):
        ...
        :return:
        """
        self.current_conditions.append(("LIKE", column, value))
        return self
    ...
    def notLike(self, column, value):
        ...
        :return:
        """
        self.current_conditions.append(("NOT_LIKE", column, value))
        return self
    ...
    def like_left(self, column, value):
        ...
        :return:
        """
        self.current_conditions.append(("LIKE_LEFT", column, value))
        return self
    ...
    def like_right(self, column, value):
        ...
        :return:
        """
        self.current_conditions.append(("LIKE_RIGHT", column, value))
        return self
    ...
    def is_null(self, column):
        ...
        :return:
        """
        self.current_conditions.append(("IS_NULL", column, None))
        return self
    ...
    def is_not_null(self, column):
        ...
        :return:
        """
        self.current_conditions.append(("IS_NOT_NULL", column, None))
        return self
    ...
    def in_(self, column, value):
        ...
        :return:
        """
        self.current_conditions.append(("IN", column, value))
        return self
    ...
    def not_in(self, column, value):
        ...
        :return:
        """
        self.current_conditions.append(("NOT_IN", column, value))
        return self
...
class Conditions(list, ConditionWrapper):
    pass
