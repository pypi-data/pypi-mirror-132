...
class FirehoseStreamAction(
    metaclass=jsii.JSIIMeta,
    jsii_type="@aws-cdk/aws-iot-actions.FirehoseStreamAction",
):
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-iot-actions.FirehoseStreamActionProps",
...
@jsii.enum(jsii_type="@aws-cdk/aws-iot-actions.FirehoseStreamRecordSeparator")
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            s3_put_object_action_props = iot_actions.S3PutObjectActionProps(
