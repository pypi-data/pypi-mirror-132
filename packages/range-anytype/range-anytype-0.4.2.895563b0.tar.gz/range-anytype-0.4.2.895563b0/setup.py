...
if sys.version[0] == "1" :
    raise SystemError("Python version must be >= 2.2 to install this package")
if sys.version[0] == "2" :
    if sys.version[2] not in ("2", "3", "4", "5", "6", "7") :
        raise SystemError("Python version must be >= 2.2 to install this package")
...
setup(
    name="range-anytype",
    version="0.4.2.895563b",
    description="Range object for any type for Python.",
