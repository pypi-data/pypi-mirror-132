...
def matrix_1(): 
    ...
    Входные параметры:
        ...
        Будут ли у вас дроби:[1]Да/[2]Нет
        как вы хотите заполнять матрицу([1]:с клавиатуры/[2]:random 
        Введите количество строк в матрице:
        Введите количество столбцом в матрице:
        Введите интервал в виде двух чисел через пробел:
        Введите значение равное каждому вектору  
    Выходные параметры:
        обратная матрица 
        Cord
        Система уравнений которую вы ввели
        Решение по функции Якоби
    authors:
