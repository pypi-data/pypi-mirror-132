...
def update_system():
    ...
    sh.sudo("/root/runinenv", "/root/canopy", "pip", "install", "-U", "canopy-platform")
...
class Update:
    ...
    def post(self):
        ...
        raise web.Accepted("updating..")
        # TODO redirect to page that polls for ready and reactivates job queue
