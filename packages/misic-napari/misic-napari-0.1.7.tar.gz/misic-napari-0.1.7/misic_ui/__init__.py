...
def segment_single_image(im,params):
    ...
    return res #(yp*255).astype(np.uint8)
...
post_process= True,
run = False,) -> 'napari.types.ImageData':
    '''
    ...
    # print('cur step ',viewer.dims.current_step)
    # print('ndisplay ',viewer.dims.ndisplay)
    # print('ndim',viewer.dims.ndim)
    # print('order ',viewer.dims.current_step)
    # print('displayed ',viewer.dims.current_step)
    # print('displayed_order ',viewer.dims.current_step)
...
def napari_experimental_provide_dock_widget():
    return [get_width,get_roi,segment,segment_stack,save_params,load_params]
