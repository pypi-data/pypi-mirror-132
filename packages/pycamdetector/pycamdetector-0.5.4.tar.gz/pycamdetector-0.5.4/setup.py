...
setup(
  ...
  description = 'Advanced Computer Vision Library which includes Face Detection, Hand Detection, Pose Estimation, '
                'Object Detection and ',   # Give a short description about your library
  ...
  download_url = 'https://github.com/roshaan55/pycamdetector/archive/refs/tags/v_0.5.3.tar.gz',    # I explain this later on
  keywords = ['pycamdetector', 'handtracking', 'facelandmarks', 'pose-estimation', 'object-detection'],   # Keywords that define your package best
