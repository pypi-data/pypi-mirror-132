...
class LoaderBase(with_metaclass(ABCMeta, object)):
    ...
    def load_raw(self, page=None):
        ...
        page_limit = settings.GAR.get('PAGE_LIMIT', 5)
...
class PlaceLoader(AddressObjectLoaderBase):
    ...
    def load_raw(self, page=None):
        ...
        # Значение PAGE_LIMIT по умолчанию 1. С большим PAGE_LIMIT можно заддосить ГАР
        page_limit = settings.GAR.get('PAGE_LIMIT', 1)
