...
class CfnAccessKey(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        props = CfnAccessKeyProps(serial=serial, status=status, user_name=user_name)
    ...
    def __init__(
        ...
        *,
        ...
        props = CfnInstanceProfileProps(
            instance_profile_name=instance_profile_name, path=path, roles=roles
        )
    ...
    def __init__(
        ...
        *,
        ...
        props = CfnSAMLProviderProps(
            name=name, saml_metadata_document=saml_metadata_document, tags=tags
        )
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            # grantable is of type IGrantable
            # principal is of type IPrincipal
            # resource_with_policy is of type IResourceWithPolicy
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            # managed_policy is of type ManagedPolicy
...
class Policy(
    ...
    :exampleMetadata: lit=test/example.attaching.lit.ts
...
class LazyRole(
    ...
    Example::
        ...
        # managed_policy is of type ManagedPolicy
        # policy_document is of type PolicyDocument
        # principal is of type IPrincipal
