...
class AuthenticationApi(object):
    ...
    def get_authorization_token(
        ...
        **kwargs
        ...
        <span style='font-size: 17px;'>Summary</span><br/>Gets an access token using a non-interactive flow. Only available for clients with secrets and owning Master. When no user ID is supplied, master owner user is logged in. Client can only sign in a user created in the same Master.. Return Type: TokenResponse <br/><br/>    # noqa: E501
