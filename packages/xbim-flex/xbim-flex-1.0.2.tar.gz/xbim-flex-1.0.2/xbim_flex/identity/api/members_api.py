...
class MembersApi(object):
    ...
    def id20_tenants_tenant_id_members_get(
        ...
        **kwargs
        ...
        """Get Members by tenantId  # noqa: E501

        <span style='font-size: 17px;'>Summary</span><br/>Team members. Queries support: $filter, $orderby, $select, $expand(including nested filters, selects and expands), $top, $skip. Return Type: ODataTenantUserList For more information about OData responses <a href='https://www.odata.org/getting-started/understand-odata-in-6-steps/'>link</a>. <br/><br/>    # noqa: E501
    ...
    def id20_tenants_tenant_id_members_post(
        ...
        **kwargs
        ...
        """Post Members  # noqa: E501

        <span style='font-size: 17px;'>Summary</span><br/>Creates a new Team member adding an existing user to the tenant. The ability to add users to a limited by tenant role. Return Type: TenantUser <br/><br/>    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def id20_tenants_tenant_id_members_user_id_delete(
        ...
        **kwargs
        ...
        """Delete Members  # noqa: E501

        <span style='font-size: 17px;'>Summary</span><br/>Revokes a user from this Tenant. Requires the Administrator Tenant Role. Return Type:  <br/><br/>    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def id20_tenants_tenant_id_members_user_id_get(
        ...
        **kwargs
        ...
        """Get Members by tenantId userId  # noqa: E501

        <span style='font-size: 17px;'>Summary</span><br/>Gets the specified Tenant Member by their userId. Return Type: TenantUser <br/><br/>    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def id20_tenants_tenant_id_members_user_id_patch(
        ...
        **kwargs
        ...
        """Patch Members  # noqa: E501

        <span style='font-size: 17px;'>Summary</span><br/>Amend an existing team member's team details. Editing users requires Admin rights on the tenant. Return Type: TenantUser <br/><br/>    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
