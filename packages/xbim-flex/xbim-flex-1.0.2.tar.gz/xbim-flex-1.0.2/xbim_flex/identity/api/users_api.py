...
class UsersApi(object):
    ...
    def id20_users_get(
        ...
        **kwargs
        ...
        <span style='font-size: 17px;'>Summary</span><br/>Operations to query a set of data. Queries support: $filter, $orderby, $select, $expand(including nested filters, selects and expands), $top, $skip. Return Type: ODataUserList For more information about OData responses <a href='https://www.odata.org/getting-started/understand-odata-in-6-steps/'>link</a>. <br/><br/>    # noqa: E501
    ...
    def id20_users_post(
        ...
        **kwargs
        ...
        <span style='font-size: 17px;'>Summary</span><br/>Return Type: User <br/><br/>    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def id20_users_user_id_get(
        ...
        **kwargs
        ...
        """Get Users by userId  # noqa: E501

        <span style='font-size: 17px;'>Summary</span><br/>Gets the specified User by their key. Return Type: User <br/><br/>    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
