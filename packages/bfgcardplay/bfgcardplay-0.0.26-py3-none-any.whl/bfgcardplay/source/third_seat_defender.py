...
from bridgeobjects import SUITS, Card, CARD_VALUES
...
class ThirdSeatDefender(ThirdSeat):
    ...
    def _winning_card(self) -> Union[Card, None]:
        ...
        # Play bottom card if it's a winner
        # if cards[-1].value > value_0 + 1 and cards[-1].value > value_1:
