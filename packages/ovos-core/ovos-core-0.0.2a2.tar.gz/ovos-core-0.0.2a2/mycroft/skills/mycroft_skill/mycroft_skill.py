...
class MycroftSkill:
    ...
    Args:
        ...
        skill_id (str): unique skill identifier, defined by SkillLoader class
    """

    def __init__(self, name=None, bus=None, use_settings=True, skill_id=""):
        ...
        # can not remove for upstream api compatibility with args
    ...
    def handle_first_run(self):
        ...
        if intro:
            # TODO support for returning .dialog files for easy localization
            self.speak(intro)
