...
def NML_M_ASSERT_FORM_IS_A_VECTOR(form: list, message: str):
...
def NML_M_ASSERT_FORM_IS_A_HASHSET(form: list, message: str):
...
def NML_M_ASSERT_FORM_IS_A_HASHMAP(form: list, message: str):
