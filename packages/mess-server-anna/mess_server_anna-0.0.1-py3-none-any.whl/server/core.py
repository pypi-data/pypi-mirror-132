...
from server.common.descriptor import Port
...
class MessageProcessor(threading.Thread):
    ...
    def init_socket(self):
        ...
        self.sock = transport
        self.sock.listen(MAX_NUMBER_CONNECTIONS)
        ...
        if message[DESTINATION] in self.names and\
            ...
            try:
                ...
                logger.info(
                    ...
                    f'{message[DESTINATION]} от пользователя {message[SENDER]}.')
            except OSError:
    ...
    def process_client_message(self, message, client):
        ...
        elif ACTION in message and message[ACTION] == REMOVE_CONTACT and ACCOUNT_NAME\
                in message and USER in message \
                and self.names[message[USER]] == client:
        ...
        elif ACTION in message and message[ACTION] == USERS_REQUEST and ACCOUNT_NAME\
                in message \
                and self.names[message[ACCOUNT_NAME]] == client:
            response = REPLY_202
    ...
    def autorize_user(self, message, sock):
        ...
        # Проверяем что пользователь зарегистрирован на сервере.
            ...
            # пользователей.
            if REPLY in ans and ans[REPLY] == 511 and hmac.compare_digest(
                    digest, client_digest):
                self.names[message[USER][ACCOUNT_NAME]] = sock
                client_ip, client_port = sock.getpeername()
                try:
                    send_message(sock, REPLY_200)
                except OSError:
    ...
    def service_update_lists(self):
        ...
        for client in self.names:
            try:
                send_message(self.names[client], REPLY_205)
            except OSError:
