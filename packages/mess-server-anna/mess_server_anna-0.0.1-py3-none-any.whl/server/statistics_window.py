...
class StatWindow(QDialog):
    ...
    def create_stat_model(self):
        ...
        statistics_client = QStandardItemModel()
        statistics_client.setHorizontalHeaderLabels(
        ...
        for row in stat_list:
            ...
            statistics_client.appendRow([user, last_seen, sent, recvd])
        self.stat_table.setModel(statistics_client)
