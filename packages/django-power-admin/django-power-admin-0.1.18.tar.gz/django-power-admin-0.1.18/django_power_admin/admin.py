...
class PowerAdmin(admin.ModelAdmin):
    ...
    def is_extra_view(self, view):
        return getattr(view, "extra_view", getattr(view, "is_object_view", False)) and callable(view)
    ...
    def simple_export_all_button(self):
        return "#"
    simple_export_all_button.short_description = _("Export All")
    simple_export_all_button.icon = "fa fa-download"

    def simple_export_filtered_button(self):
        return "#"
    simple_export_filtered_button.short_description = _("Export Filtered")
    simple_export_filtered_button.icon = "fa fa-download"
    # #################################################################################
