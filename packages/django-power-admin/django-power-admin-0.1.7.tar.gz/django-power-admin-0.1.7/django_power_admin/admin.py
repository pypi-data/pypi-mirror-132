...
class PowerAdmin(admin.ModelAdmin):
    ...
    # Set view flags
    # ---------------------------------------------------------------------------------
    def set_view_flags(self, is_changelist_view=False, is_read_view=False, is_add_view=False, is_change_view=False, is_delete_view=False, is_history_view=False):
        request = get_request()
    ...
    def get_change_list_object_toolbar_buttons(self, buttons_var_name, obj):
        buttons = []
        change_list_object_toolbar_buttons = getattr(self, buttons_var_name, [])
    ...
    edit_action.short_description = _("Change")
    ...
    def get_urls(self):
        urlpatterns = self.get_extra_views()
