...
from bytesep.models.resunet_subbandtime import (
    ConvBlockRes,
    EncoderBlockRes4B,
    DecoderBlockRes4B,
)
...
class AmbisonicToBinaural_UNetSubbandtimePhase(nn.Module, Base):
    def __init__(
        self, input_channels: int, output_channels: int, target_sources_num: int
    ):
        super(AmbisonicToBinaural_UNetSubbandtimePhase, self).__init__()
        ...
        self.encoder_block1 = EncoderBlock(
            in_channels=self.input_channels * self.subbands_num * 3,
            out_channels=32,
            kernel_size=(3, 3),
            downsample=(2, 2),
...
class AmbisonicToBinaural_ResUNetSubbandtimePhase(nn.Module, Base):
    def __init__(
        self, input_channels: int, output_channels: int, target_sources_num: int
    ):
        super(AmbisonicToBinaural_ResUNetSubbandtimePhase, self).__init__()
