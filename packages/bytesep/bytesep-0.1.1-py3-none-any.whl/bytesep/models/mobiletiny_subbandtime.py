...
class MobileTinyConvBlock(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
        ...
        super(MobileTinyConvBlock, self).__init__()
        ...
        self.conv2a = self.conv1a

        self.conv2b = self.conv1b

        self.conv2c = self.conv1c
...
class MobileTinyEncoderBlock(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
        ...
        r"""Encoder block."""
        super(MobileTinyEncoderBlock, self).__init__()

        self.conv_block = MobileTinyConvBlock(
...
class MobileTinyDecoderBlock(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
        ...
        r"""Decoder block."""
        super(MobileTinyDecoderBlock, self).__init__()
        ...
        self.conv_block2 = MobileTinyConvBlock(
...
class MobileTiny_Subbandtime(nn.Module, Base):
    def __init__(
        ...
        self.encoder_block1 = MobileTinyEncoderBlock(
            in_channels=32,
            out_channels=32,
            kernel_size=(3, 3),
            downsample=(2, 2),
        ...
        self.encoder_block2 = self.encoder_block1
        self.encoder_block3 = self.encoder_block2
        self.encoder_block4 = self.encoder_block2
        self.encoder_block5 = self.encoder_block2
        self.encoder_block6 = self.encoder_block2
        ...
        #     momentum=momentum,
        # )
        self.decoder_block1 = MobileTinyDecoderBlock(
            in_channels=32,
            out_channels=32,
            kernel_size=(3, 3),
            upsample=(2, 2),
        ...
        self.decoder_block2 = self.decoder_block1
        self.decoder_block3 = self.decoder_block1
        self.decoder_block4 = self.decoder_block1
        self.decoder_block5 = self.decoder_block1
        self.decoder_block6 = self.decoder_block1
