from . import act_template_multiple_responses_pb2_grpc as importStub

class ActMultipleResponsesService(object):

    def __init__(self, router):
        self.connector = router.get_connection(ActMultipleResponsesService, importStub.ActMultipleResponsesStub)
