from . import act_template_typed_multiple_responses_pb2_grpc as importStub

class ActTypedMultipleResponsesService(object):

    def __init__(self, router):
        self.connector = router.get_connection(ActTypedMultipleResponsesService, importStub.ActTypedMultipleResponsesStub)
