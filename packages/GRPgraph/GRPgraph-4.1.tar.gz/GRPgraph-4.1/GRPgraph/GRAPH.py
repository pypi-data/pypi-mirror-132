...
class Surfases:
    ...
    class Trans:
        def __init__(self):
            pass
        def Theresld(self,img,search_col,thresjd,set_col):
            pygame.transform.threshold(self.surf,img,search_col,thresjd,set_col)
class Kamera:
...
class WinHOW:
    ...
    class draw2D:
                                            def __init__(self,):
                                                pass
                                            def drawrect(col=(),pos=[],size=[],sh=0):
                                            ...
                                            def drawcircle(col=(),pos=[],rad=0,sh=0):
                                            ...
                                            def drawellips(col=(),pos=[],size=[],sh=0):
                                                    rect = pygame.Rect(pos[0],pos[1],size[0],size[1])
                                            ...
                                            def drawtringl(col=(),pos1=[],pos2=[],pos3=[],sh=0):
                                            ...
                                            def drawline(col=(),start_pos=[],end_pos=[],sh=1):
                                            ...
                                            def drawliness(col=(),points=(),ZAMKNT=False,sh=1):
                                            ...
                                            def drawarc(col=(),pos=[],size=[],start_angle=0,stop_angle=0,sh=1):
                                                    rect= pygame.Rect(pos[0],pos[1],size[0],size[1])
