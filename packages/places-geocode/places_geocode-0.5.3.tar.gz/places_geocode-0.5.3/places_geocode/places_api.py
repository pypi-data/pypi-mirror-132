...
try:
    create_convex_array = cdll.LoadLibrary("{}/{}".format(so_path, "create_convex_array.cpython-38-darwin.so"))
    check_dups = cdll.LoadLibrary("{}/{}".format(so_path, "check_dups.cpython-38-darwin.so"))
    zip_coordinate = cdll.LoadLibrary("{}/{}".format(so_path, "zip_coordinate.cpython-38-darwin.so"))
    check_lat_long_length = cdll.LoadLibrary("{}/{}".format(so_path, "check_lat_long_length.cpython-38-darwin.so"))
    check_address_length = cdll.LoadLibrary("{}/{}".format(so_path, "check_address_length.cpython-38-darwin.so"))
    zip_coordinates_elastic = cdll.LoadLibrary("{}/{}".format(so_path, "zip_coordinates_elastic.cpython-38-darwin.so"))
    create_convex_elastic = cdll.LoadLibrary("{}/{}".format(so_path, "create_convex_elastic.cpython-38-darwin.so"))
    coordinate_conv_package = cdll.LoadLibrary("{}/{}".format(so_path, "coordinate_conv_package.cpython-38-darwin.so"))
except:
