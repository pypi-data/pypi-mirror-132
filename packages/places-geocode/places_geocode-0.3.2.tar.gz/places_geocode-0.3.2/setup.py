...
setup(
    ...
    packages=['places_geocode', 'places_geocode/app', 'places_geocode/Logs', 'places_geocode/app/models', 'places_geocode/app/CythonOperations', 'places_geocode/app/CythonOperations/places_geocode/app/dprk_copy'],
    license="MIT",
