...
try:
    spreadsheet_c = CDLL("spreadsheet_c.cpython-38-darwin.so".format(path))
    reverse_spreadsheet = CDLL("reverse_spreadsheet.cpython-38-darwin.so".format(path))
    TFIDF_max = CDLL("TFIDF_max.cpython-38-darwin.so".format(path))
    null_parameters = CDLL("null_parameters.cpython-38-darwin.so".format(path))
    certainty_search = CDLL("certainty_search.cpython-38-darwin.so".format(path))
    radius_arr = CDLL("radius_arr.cpython-38-darwin.so".format(path))
    TFIDF_max_elastic = CDLL("TFIDF_max_elastic.cpython-38-darwin.so".format(path))
except:
