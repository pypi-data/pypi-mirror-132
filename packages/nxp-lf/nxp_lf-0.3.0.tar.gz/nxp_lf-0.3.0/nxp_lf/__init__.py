        ...
        for per_result in result.result_body:
            if ifBackup2lastpass_1:
                ...
                if per_result[2] == 0:
                    ...
                    # cur > lastpass, no action
                    sql = "INSERT INTO lf_history_ss (scope,platform,testcase,lastpass,lastpass_1) VALUES ('{}', '{}', '{}', {}, 0) ON CONFLICT (scope,platform,testcase) DO UPDATE SET lastpass=lf_history_ss.lastpass_1, lastpass_1=0 where {}=lf_history_ss.lastpass".format(
                        result.result_header[2],
                        per_result[0],
                        per_result[1],
                        result.result_header[1],
