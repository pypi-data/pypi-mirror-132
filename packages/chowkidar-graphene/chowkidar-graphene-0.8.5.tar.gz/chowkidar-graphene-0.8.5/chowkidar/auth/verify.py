...
from ..settings import JWT_REFRESH_TOKEN_EXPIRATION_DELTA, ENABLE_FINGERPRINTING
    ...
    if ENABLE_FINGERPRINTING:
        if "fingerprint" in payload:
            ...
            if not (
                ...
                raise AuthError('fingerprint for refresh token', code='FINGERPRINT_MISMATCH')
