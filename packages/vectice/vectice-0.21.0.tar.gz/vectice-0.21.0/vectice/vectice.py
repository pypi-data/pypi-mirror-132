...
class Vectice(Adapter):
    ...
    def __new__(cls, project_token: str, lib: str = None, *args, **kwargs):
        if lib is not None:
            return LibraryFactory.get_library(project_token, lib, *args, **kwargs)
        else:
            return super().__new__(cls)

    def __init__(self, project_token: str, lib: Optional[str] = None, autocode: bool = False):
        super().__init__(project_token=project_token, autocode=autocode)
