...
**harley1992** could always use more documentation, whether as
part of the official **harley1992** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `harley1992` for local
development.

1. Fork the `harley1992` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/harley1992.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd harley1992
    (dvlpt) harley1992$ flake8
    (dvlpt) harley1992$ pytest
    
    (dvlpt) harley1992$ tox
...
.. _issues: https://gitlab.com/b326/harley1992/issues
