...
_RECEIVERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='port_range', full_name='xray.app.proxyman.ReceiverConfig.port_range', index=0,
