...
go to `https://readthedocs.org/dashboard/aetst/advanced`__ (Admin) to configure the following settings:
...
if html_theme == 'alabaster':
    ...
    html_theme_options = dict(
        ...
        # gitlab_url=f"https://gitlab.com/aetst-group/aetst/docs/index.rst",
        navigation_depth=-1,
