...
from eto.internal import rest
from eto.internal.configuration import Configuration
from eto.internal.exceptions import ApiException, ApiTypeError, ApiValueError
from eto.internal.model_utils import (
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_dataset  # this is an instance of the class Endpoint
        api_instance.get_dataset()  # this invokes api_instance.get_dataset.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_dataset.callable or self.callable in this class
