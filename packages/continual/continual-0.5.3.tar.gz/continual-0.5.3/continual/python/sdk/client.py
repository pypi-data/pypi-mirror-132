...
def _get_channel(endpoint, service, options=None):
    ...
    if endpoint == "https://api.continual.ai":
        ...
        if service == "dataingest":
            host = "127.0.0.1:32423"
        if host == "":
...
class Client:
    ...
    def __init__(
        ...
        self._mgmt_channel = _get_channel(self.config.endpoint, "management")
