...
def create_headers(public_key: str, secret_key: str):
...
class Payments:
    def create_token(
        amount: int,
        on_success_endpoint: str,
        user_id: str = None,
        metadata: object = None,
        transfers: list[object] = None,
    ) -> str:
        from zage import public_key, secret_key, base_url, sandbox_url
    ...
    def refund_payment(payment_id: str) -> bool:
        from zage import secret_key, public_key, base_url, sandbox_url
