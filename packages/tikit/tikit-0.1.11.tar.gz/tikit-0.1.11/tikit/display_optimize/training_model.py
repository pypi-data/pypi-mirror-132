...
def infer_templates_table(infer_templates):
    ...
    :type infer_templates:   :class:`tencentcloud.tione.v20211111.models.DescribeInferTemplatesResponse`
    :return:
    :rtype:
    """
    table = PrettyTable()
...
def training_model_table(training_models):
    ...
    :type training_models:   :class:`tencentcloud.tione.v20211111.models.DescribeTrainingModelsResponse`
    :return:
    :rtype:
    """
    table = PrettyTable()
...
def training_model_version_table(training_model_versions):
    ...
    :type training_model_versions:   :class:`tencentcloud.tione.v20211111.models.DescribeTrainingModelVersionsResponse`
    :return:
    :rtype:
    """
    table = PrettyTable()
