...
class CreateTrainingModelRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :param TrainingModelCosPath: 模型cos目录，以/结尾
...
注意：此字段可能返回 null，表示取不到有效值。
        :type Name: str
        :param StorageDataPath: 数据集存储COS路径
注意：此字段可能返回 null，表示取不到有效值。
        :type StorageDataPath: :class:`tencentcloud.tione.v20211111.models.CosPathInfo`
        :param StorageLabelPath: 文件列表信息存储URL
注意：此字段可能返回 null，表示取不到有效值。
        :type StorageLabelPath: :class:`tencentcloud.tione.v20211111.models.CosPathInfo`
        """
    ...
    def __init__(self):
        ...
        :param Filters: 过滤条件
	          Filter.Name: 枚举值: ResourceGroupId (资源组id列表)
	           ...
	           Filter.Values: 当ResourceGroupName对应的Values，长度为1时，支持模糊查询; 不为1时，精确查询
...
class DescribeLogsRequest(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param Service: 查询哪个服务的日志
        :type Service: str
        :param PodName: 查询哪个Pod的日志
        :type PodName: str
        :param StartTime: 日志查询开始时间
        :type StartTime: str
        :param EndTime: 日志查询结束时间
        :type EndTime: str
        :param Limit: 日志查询条数，默认值100，最大值100
        :type Limit: int
        :param Order: 排序方向
        :type Order: str
        :param OrderField: 按哪个字段排序
        :type OrderField: str
        :param Context: 分页的游标
        :type Context: str
...
注意：此字段可能返回 null，表示取不到有效值。
        ...
        :param InstanceStatus: 节点状态 枚举值 DEPLOYING:部署中RUNNING:运行中 DEPLOY_FAILED：部署失败 RELEASED：已释放 EXCEPTION：异常 RELEASING 释放中
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
	...
	//			NOTIFY_AND_MANUAL_RENEW: 表示默认状态(用户未设置，即初始状态手动续费，用户开通了预付费不停服特权也会进行自动续费)，对应计费0
	//			NOTIFY_AND_AUTO_RENEW：表示自动续费
	//			DISABLE_NOTIFY_AND_MANUAL_RENEW 表示明确不自动续费(用户设置，设置后不会发送到期隔离通知给用户)，
	//			若业务无续费概念或无需自动续费，需要设置为NOTIFY_AND_MANUAL_RENEW
注意：此字段可能返回 null，表示取不到有效值。
        :type AutoRenewFlag: str
        :param SpecId: 计费项ID
        :type SpecId: str
        :param SpecAlias: 计费项显示名称：8核40GB V100*1
        :type SpecAlias: str
        """
...
注意：此字段可能返回 null，表示取不到有效值。
        :type Memory: int
        :param GpuType: Gpu卡型号
注意：此字段可能返回 null，表示取不到有效值。
        :type GpuType: str
        :param Gpu: Gpu卡资源，单位为1单位的GpuType
注意：此字段可能返回 null，表示取不到有效值。
        :type Gpu: int
        """
        self.Cpu = None
