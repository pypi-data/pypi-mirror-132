...
def framework_table(framework_response):
    ...
    :type framework_response:   :class:`tencentcloud.tione.v20211111.models.DescribeTrainingFrameworksResponse`
    :return:
    :rtype:
    """
    table = PrettyTable()
    ...
    for framework in framework_response.FrameworkInfos:
        table.add_row([
            framework.Name,
            "\n".join(framework.Versions),
            ", ".join(framework.TrainingModes)
        ])
    table.align = 'l'
    return table
...
def bill_specs_table(bill_specs_response):
    ...
    :type bill_specs_response:   :class:`tencentcloud.tione.v20211111.models.DescribeBillingSpecsResponse`
    :return:
    :rtype:
    """
    table = PrettyTable()
...
def training_task_table(training_task_response):
    ...
    :type training_task_response:   :class:`tencentcloud.tione.v20211111.models.DescribeTrainingTasksResponse`
    :return:
    :rtype:
    """
    paid_dict = {
...
def log_table(log_response):
    ...
    :param log_response:
    :type log_response:   :class:`tencentcloud.tione.v20211111.models.DescribeLogsResponse`
    :return:
    :rtype:
    """
    table = PrettyTable()
