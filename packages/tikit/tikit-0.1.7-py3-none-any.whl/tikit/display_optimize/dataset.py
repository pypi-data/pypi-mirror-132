...
def dataset_table(dataset_response):
    ...
    :type dataset_response:   :class:`tencentcloud.tione.v20211111.models.DescribeDatasetsResponse`
    :return:
    :rtype:
    """
    type_dict = {
...
def detail_structured_table(detail_structured):
    ...
    :type detail_structured:   :class:`tencentcloud.tione.v20211111.models.DescribeDatasetDetailStructuredResponse`
    :return:
    :rtype:
    """
    table = PrettyTable()
...
def detail_unstructured_table(detail_unstructured):
    ...
    :type detail_unstructured:   :class:`tencentcloud.tione.v20211111.models.DescribeDatasetDetailStructuredResponse`
    :return:
    :rtype:
    """
    table = PrettyTable()
