...
class DockerExecutor(BaseExecutor):
    ...
    def _initialize_docker_container(self, module_input):
        try:
            ...
            environment_variables = {'BIOLIB_VERSION': utils.BIOLIB_PACKAGE_VERSION}
            if 'secrets' in module:
                environment_variables.update(module['secrets'])
            ...
            if self._options['job']['app_version'].get('stdout_render_type') == 'text':
