    ...
    """
{
    ...
    "package_data": {
        "renovo-instance-service._jsii": [
            "cdk-library-renovo-instance-service@1.0.27.jsii.tgz"
        ],
        "renovo-instance-service": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.cloud-assembly-schema>=1.134.0, <2.0.0",
        "aws-cdk.core>=1.134.0, <2.0.0",
        "constructs>=3.2.27, <4.0.0",
        "jsii>=1.50.0, <2.0.0",
        "publication>=0.0.3",
        "renovosolutions.aws-cdk-aspects-security-group>=0.2.6, <0.3.0",
        "renovosolutions.aws-cdk-managed-instance-role>=0.1.6, <0.2.0"
    ],
    "classifiers": [
