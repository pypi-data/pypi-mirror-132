...
from .nn import (
    avg_pool_nd, conv_nd, linear, normalization, timestep_embedding,
    zero_module,
)
...
class TimestepEmbedSequential(nn.Sequential, TimestepBlock):
    ...
    def forward(self, x, emb, encoder_out=None):
        ...
        Args:
          x:
          emb:
          encoder_out:  (Default value = None)
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps, y=None):
        ...
        Args:
          ...
          y: an [N] Tensor of labels, if class-conditional. (Default value = None)
...
class InpaintUNetModel(UNetModel):
    ...
    def forward(self, x, timesteps, inpaint_image=None, inpaint_mask=None, **kwargs):
        ...
        Args:
          x:
          timesteps:
          inpaint_image:  (Default value = None)
          inpaint_mask:  (Default value = None)
          **kwargs:
