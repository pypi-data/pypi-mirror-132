    ...
    def cond_fn(
        ...
        def cond_fn(x, t, grad_scale=grad_scale, **kwargs):
            ...
            Args:
              x:
              t:
              grad_scale:  (Default value = grad_scale)
              **kwargs:
...
def create_clip_model(
    ...
    Args:
      config_path: Optional[str]:  (Default value = None)
      device: Optional[torch.device]:  (Default value = None)
      tokenizer: Optional[SimpleTokenizer]:  (Default value = None)
