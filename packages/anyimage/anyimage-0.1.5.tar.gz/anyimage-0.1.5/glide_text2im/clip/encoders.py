...
from .attention import (
    AttentionInfo, DenseAttentionMask, DenseCausalAttentionMask,
    make_full_layout, to_attention_info,
)
...
class ImageEmbedding(nn.Module):
    ...
    def forward(
        ...
        Args:
          x: torch.Tensor:
          t: Optional[torch.Tensor]:  (Default value = None)
...
class TextFeatureExtractor(nn.Module):
    ...
    def forward(
        ...
        Args:
          text: torch.Tensor:
          text_len: torch.Tensor:
          return_probe_features: bool:  (Default value = False)
...
class ImageEncoder(nn.Module):
    ...
    def forward(
        ...
        Args:
          image: torch.Tensor:
          timesteps: Optional[torch.Tensor]:  (Default value = None)
          return_probe_features: bool:  (Default value = False)
