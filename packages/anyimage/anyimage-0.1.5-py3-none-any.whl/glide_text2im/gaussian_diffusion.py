...
def betas_for_alpha_bar(num_diffusion_timesteps, alpha_bar, max_beta=0.999):
    ...
    prevent singularities. (Default value = 0.999)
...
class GaussianDiffusion:
    ...
    def q_sample(self, x_start, t, noise=None):
        ...
        Args:
          ...
          t: the number of diffusion steps (minus 1). Here, 0 means one step.
          noise: if specified, the split-out normal noise. (Default value = None)
    ...
    def p_mean_variance(
        ...
        as input.
          ...
          clip_denoised: if True, clip the denoised signal into [-1, 1]. (Default value = True)
          denoised_fn: if not None, a function which applies to the
        x_start prediction before it is used to sample. Applies before
        clip_denoised. (Default value = None)
          model_kwargs: if not None, a dict of extra keyword arguments to
        pass to the model. This can be used for conditioning. (Default value = None)
    ...
    def condition_mean(self, cond_fn, p_mean_var, x, t, model_kwargs=None):
        ...
        Args:
          ...
          x:
          t:
          model_kwargs:  (Default value = None)
    ...
    def p_sample(
        ...
        Args:
          ...
          clip_denoised: if True, clip the x_start prediction to [-1, 1]. (Default value = True)
          denoised_fn: if not None, a function which applies to the
        x_start prediction before it is used to sample. (Default value = None)
          cond_fn: if not None, this is a gradient function that acts
        similarly to the model. (Default value = None)
          model_kwargs: if not None, a dict of extra keyword arguments to
        pass to the model. This can be used for conditioning. (Default value = None)
    ...
    def p_sample_loop(
        ...
        Should be of the same shape as `shape`. (Default value = None)
          clip_denoised: if True, clip x_start predictions to [-1, 1]. (Default value = True)
          denoised_fn: if not None, a function which applies to the
        x_start prediction before it is used to sample. (Default value = None)
          cond_fn: if not None, this is a gradient function that acts
        similarly to the model. (Default value = None)
        ...
        If not specified, use a model parameter's device. (Default value = None)
          progress: if True, show a tqdm progress bar. (Default value = False)
    ...
    def p_sample_loop_progressive(
        ...
        Args:
          ...
          clip_denoised:  (Default value = True)
          denoised_fn:  (Default value = None)
          cond_fn:  (Default value = None)
          model_kwargs:  (Default value = None)
          device:  (Default value = None)
          progress:  (Default value = False)
