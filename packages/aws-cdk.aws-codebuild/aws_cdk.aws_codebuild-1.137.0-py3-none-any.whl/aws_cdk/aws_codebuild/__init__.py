...
```python
# my_caching_bucket is of type Bucket
    ...
    class ProjectBuildBatchConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param batch_report_mode: ``CfnProject.ProjectBuildBatchConfigProperty.BatchReportMode``.
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            # cache is of type Cache
            # file_system_location is of type IFileSystemLocation
            # key is of type Key
...
class DockerImageOptions:
    def __init__(
        ...
        *,
        ...
        :exampleMetadata: lit=./test/integ.docker-registry.lit.ts
