...
if base_dir:
    os.chdir(base_dir)
with open(os.path.join(base_dir, "kpc", "__about__.py")) as f:
    exec(f.read(), about)
...
setup(
    ...
    url=about["__uri__"],
    project_urls={
        "Bug Tracker": "https://github.com/mcode-cc/kpc/issues",
    },
    ...
    entry_points={'console_scripts': ['kpc = kpc:main']},
