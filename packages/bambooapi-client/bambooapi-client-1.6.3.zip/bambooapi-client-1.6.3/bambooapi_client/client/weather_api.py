...
from bambooapi_client.api.weather_stations_api import WeatherStationsApi
...
class WeatherApi(object):
    ...
    def read_weather_forecasts(
        ...
        if start and stop:
            _meas = self._api_instance.read_weather_forecasts(
                ws_id,
                period='CustomRange',
                period_start=start,
                period_stop=stop,
            ...
            _meas = self._api_instance.read_weather_forecasts(ws_id)
