...
class WorkspaceRun:
    ...
    def exec_code(self):
        ...
        with open("/tmp/code_path.txt", 'w') as path_file:
            path_file.write(self.code_path
                            .replace('/home/work/', '')
                            .replace('_%s' % self.workspace_run_log.workspace_run_id, ''))
        ...
        try:
            ...
            try:
                os.remove('/tmp/code_path.txt')
            except FileNotFoundError:
                pass

            try:
                os.remove("/tmp/code_path_read.txt")
            except FileNotFoundError:
                pass
