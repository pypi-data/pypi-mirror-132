...
class Common(object):
    ...
    def get_current_run_id():
        try:
            with open('/home/work/runs/run_info.json') as json_file:
    ...
    def set_current_notebook(self):
        try:
            with open('/tmp/code_path.txt') as path_file:
                self.notebook_info = path_file.readline()
            os.rename('/tmp/code_path.txt', '/tmp/code_path_read.txt')
