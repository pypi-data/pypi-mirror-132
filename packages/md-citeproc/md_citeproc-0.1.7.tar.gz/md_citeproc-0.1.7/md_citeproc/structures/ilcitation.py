...
class InlineCitation(Citation):
    ...
    def __init__(
        self, line: str, line_no: int, match: re.Match, notation: NotationStyle, keyset: set, warnings: list, strict: bool
    ):
        self.notation: NotationStyle = notation
        super().__init__(line, line_no, match, keyset, warnings, strict)
