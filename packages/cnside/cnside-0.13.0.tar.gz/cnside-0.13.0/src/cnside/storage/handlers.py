...
class ManifestData(BaseModel):
    ...
    manifest_data: Optional[Text] = None
    lockfile_data: Optional[Text] = None
...
class ManifestHandler:
    ...
    def get(self, package_manager: Text, base_dir: Text = None) -> ManifestData:
        ...
        rv = ManifestData(
            ...
            manifest_data=self._get_file_contents(file_path=manifest_path),
            lockfile_data=None if not lockfile_name else self._get_file_contents(file_path=lockfile_path)
        )
        return rv
