...
class EmailSubscription(
    ...
    def bind(
        ...
        :param _topic: -
        '''
        return typing.cast(aws_cdk.aws_sns.TopicSubscriptionConfig, jsii.invoke(self, "bind", [_topic]))
...
class LambdaSubscription(
    ...
    def bind(
        ...
        :param topic: -
        '''
        return typing.cast(aws_cdk.aws_sns.TopicSubscriptionConfig, jsii.invoke(self, "bind", [topic]))
...
class UrlSubscriptionProps(SubscriptionProps):
    ...
    def protocol(self) -> typing.Optional[aws_cdk.aws_sns.SubscriptionProtocol]:
        ...
        return typing.cast(typing.Optional[aws_cdk.aws_sns.SubscriptionProtocol], result)
