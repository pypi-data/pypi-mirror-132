...
def addEMSProgramsBase(self, ScriptType: str = None, verboseMode: bool = True):
    ...
    if 'SetComfTemp' in programlist:
        ...
        self.idf1.newidfobject(
            ...
            Program_Line_6='set ComfTemp = PMOT*0.37+16.8',
    ...
    if 'ApplyCAT' in programlist:
        ...
        self.idf1.newidfobject(
            ...
            Program_Line_20='elseif (AdapStand == 3)',
            Program_Line_21='if (CAT == 1)',
            Program_Line_22='set ACSToffset = 2',
            Program_Line_23='set AHSToffset = -2',
            Program_Line_24='elseif (CAT == 2)',
            Program_Line_25='set ACSToffset = 3',
            Program_Line_26='set AHSToffset = -3',
            Program_Line_27='elseif (CAT == 3)',
            Program_Line_28='set ACSToffset = 4',
            Program_Line_29='set AHSToffset = -4',
    ...
    if 'SetAST' in programlist:
        ...
        self.idf1.newidfobject(
            ...
            Program_Line_194='if (AdapStand == 3) && (ComfMod == 2) && (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_195='set ACST = PMOT*0.37+16.8+ACSToffset+ACSTtol',
            Program_Line_196='elseif (AdapStand == 3) && (ComfMod == 2) && (PMOT < ACSTall)',
            Program_Line_197='set ACST = 23.9+ACSTtol',
            Program_Line_198='elseif (AdapStand == 3) && (ComfMod == 2) && (PMOT > ACSTaul)',
            Program_Line_199='set ACST = 26.8+ACSTtol',
            Program_Line_200='endif',
            Program_Line_201='if (AdapStand == 3) && (ComfMod == 2) && (PMOT >= AHSTall) && (PMOT <= AHSTaul)',
            Program_Line_202='set AHST = PMOT*0.37+16.8+AHSToffset+AHSTtol',
            Program_Line_203='elseif (AdapStand == 3) && (ComfMod == 2) && (PMOT < AHSTall)',
            Program_Line_204='set AHST = 19.6+AHSTtol',
            Program_Line_205='elseif (AdapStand == 3) && (ComfMod == 2) && (PMOT > AHSTaul)',
            Program_Line_206='set AHST = 23.6+AHSTtol',
            Program_Line_207='endif',
            Program_Line_208='if (AdapStand == 3) && (ComfMod == 3) && (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_209='set ACST = PMOT*0.37+16.8+ACSToffset+ACSTtol',
            Program_Line_210='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT < ACSTall)',
            Program_Line_211='set ACST = ACSTall*0.37+16.8+ACSToffset+ACSTtol',
            Program_Line_212='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT > ACSTaul)',
            Program_Line_213='set ACST = ACSTaul*0.37+16.8+ACSToffset+ACSTtol',
            Program_Line_214='endif',
            Program_Line_215='if (AdapStand == 3) && (ComfMod == 3) && (PMOT >= AHSTall) && (PMOT <= AHSTaul)',
            Program_Line_216='set AHST = PMOT*0.37+16.8+AHSToffset+AHSTtol',
            Program_Line_217='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT < AHSTall)',
            Program_Line_218='set AHST = AHSTall*0.37+16.8+AHSToffset+AHSTtol',
            Program_Line_219='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT > AHSTaul)',
            Program_Line_220='set AHST = AHSTaul*0.37+16.8+AHSToffset+AHSTtol',
