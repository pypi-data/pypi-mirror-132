...
# * Gid Imports ----------------------------------------------------------------------------------------->
from gidapptools.gidapptools_qt.resources_helper import AllResourceItemsMeta, ressource_item_factory
import antistasi_logbook.gui.resources.antistasi_logbook_resources
# endregion[Imports]
...
CHECK_MARK_GREEN = ressource_item_factory(file_path='D:/Dropbox/hobby/Modding/Programs/Github/My_Repos/Antistasi_Logbook/designer_files/resources/check_mark_green.svg', qt_path=':/images/check_mark_green.svg')

CLOSE_BLACK = ressource_item_factory(file_path='D:/Dropbox/hobby/Modding/Programs/Github/My_Repos/Antistasi_Logbook/designer_files/resources/close_black.svg', qt_path=':/images/close_black.svg')
...
class AllResourceItems(metaclass=AllResourceItemsMeta):
    ...
    check_mark_green = CHECK_MARK_GREEN
