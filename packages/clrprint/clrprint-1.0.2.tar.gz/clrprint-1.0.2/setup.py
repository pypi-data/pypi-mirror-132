...
setup(
    ...
    keywords=['basic colors', 'color print', 'cmd', 'color idle', 'color terminal',
              'color powershell', 'color idle and terminal', 'color idle, cmd, powershell', 'DEBUG input', 'DEBUG'],
    url='https://github.com/AbhijithAJ/clrprint',
    download_url='https://github.com/AbhijithAJ/clrprint/archive/refs/tags/v1.0.2.tar.gz',
    packages=['clrprint'],
    python_requires=">=3.2",
