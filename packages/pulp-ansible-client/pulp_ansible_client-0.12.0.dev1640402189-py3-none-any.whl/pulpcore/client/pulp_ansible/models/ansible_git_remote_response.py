...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, pulp_created=None, max_retries=None, total_timeout=None, client_cert=None, ca_cert=None, proxy_url=None, headers=None, pulp_labels=None, connect_timeout=None, tls_validation=None, sock_read_timeout=None, url=None, sock_connect_timeout=None, download_concurrency=None, rate_limit=None, pulp_href=None, pulp_last_updated=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
