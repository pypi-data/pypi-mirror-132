...
class AnsibleGitRemote(object):
    ...
    def __init__(self, name=None, max_retries=None, total_timeout=None, client_cert=None, username=None, proxy_password=None, ca_cert=None, proxy_url=None, headers=None, password=None, pulp_labels=None, client_key=None, connect_timeout=None, tls_validation=None, sock_read_timeout=None, url=None, proxy_username=None, sock_connect_timeout=None, download_concurrency=None, rate_limit=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
