...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_href=None, rate_limit=None, ca_cert=None, pulp_labels=None, tls_validation=None, pulp_last_updated=None, sock_connect_timeout=None, download_concurrency=None, total_timeout=None, name=None, client_cert=None, connect_timeout=None, headers=None, proxy_url=None, max_retries=None, url=None, sock_read_timeout=None, pulp_created=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
