...
class AnsibleGitRemote(object):
    ...
    def __init__(self, proxy_password=None, rate_limit=None, ca_cert=None, pulp_labels=None, tls_validation=None, client_key=None, password=None, sock_connect_timeout=None, download_concurrency=None, total_timeout=None, name=None, client_cert=None, connect_timeout=None, username=None, headers=None, proxy_url=None, max_retries=None, url=None, sock_read_timeout=None, proxy_username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
