...
class AnsibleGitRemote(object):
    ...
    def __init__(self, client_key=None, pulp_labels=None, name=None, client_cert=None, sock_connect_timeout=None, proxy_url=None, proxy_password=None, tls_validation=None, url=None, headers=None, connect_timeout=None, max_retries=None, username=None, sock_read_timeout=None, rate_limit=None, proxy_username=None, ca_cert=None, download_concurrency=None, password=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
