...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, client_cert=None, tls_validation=None, pulp_labels=None, sock_connect_timeout=None, name=None, ca_cert=None, max_retries=None, rate_limit=None, pulp_href=None, connect_timeout=None, pulp_last_updated=None, total_timeout=None, url=None, sock_read_timeout=None, download_concurrency=None, headers=None, proxy_url=None, pulp_created=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
