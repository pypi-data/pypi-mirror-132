...
class AnsibleGitRemote(object):
    ...
    def __init__(self, sock_connect_timeout=None, rate_limit=None, pulp_labels=None, download_concurrency=None, url=None, total_timeout=None, username=None, password=None, connect_timeout=None, proxy_url=None, name=None, ca_cert=None, proxy_password=None, client_cert=None, client_key=None, headers=None, proxy_username=None, tls_validation=None, sock_read_timeout=None, max_retries=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
