...
class AnsibleGitRemote(object):
    ...
    def __init__(self, username=None, client_cert=None, tls_validation=None, pulp_labels=None, sock_connect_timeout=None, client_key=None, name=None, ca_cert=None, max_retries=None, rate_limit=None, connect_timeout=None, password=None, proxy_username=None, total_timeout=None, url=None, sock_read_timeout=None, proxy_password=None, download_concurrency=None, headers=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
