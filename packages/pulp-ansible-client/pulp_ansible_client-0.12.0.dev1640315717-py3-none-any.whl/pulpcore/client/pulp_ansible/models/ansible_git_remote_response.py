...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, url=None, proxy_url=None, pulp_created=None, tls_validation=None, ca_cert=None, headers=None, rate_limit=None, pulp_last_updated=None, total_timeout=None, pulp_href=None, client_cert=None, connect_timeout=None, download_concurrency=None, max_retries=None, name=None, sock_read_timeout=None, pulp_labels=None, sock_connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
