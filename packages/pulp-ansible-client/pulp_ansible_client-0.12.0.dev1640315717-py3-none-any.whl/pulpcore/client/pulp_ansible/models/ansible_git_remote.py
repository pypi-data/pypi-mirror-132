...
class AnsibleGitRemote(object):
    ...
    def __init__(self, url=None, username=None, proxy_url=None, client_key=None, tls_validation=None, ca_cert=None, headers=None, rate_limit=None, total_timeout=None, proxy_password=None, client_cert=None, connect_timeout=None, password=None, download_concurrency=None, max_retries=None, proxy_username=None, name=None, sock_read_timeout=None, pulp_labels=None, sock_connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
