...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, url=None, max_retries=None, name=None, proxy_url=None, pulp_created=None, tls_validation=None, pulp_href=None, total_timeout=None, sock_connect_timeout=None, pulp_labels=None, headers=None, sock_read_timeout=None, download_concurrency=None, connect_timeout=None, rate_limit=None, ca_cert=None, pulp_last_updated=None, client_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
