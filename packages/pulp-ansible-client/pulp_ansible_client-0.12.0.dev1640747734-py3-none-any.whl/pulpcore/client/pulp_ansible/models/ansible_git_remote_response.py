...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_labels=None, name=None, client_cert=None, sock_connect_timeout=None, pulp_created=None, proxy_url=None, pulp_last_updated=None, tls_validation=None, url=None, pulp_href=None, headers=None, connect_timeout=None, max_retries=None, sock_read_timeout=None, rate_limit=None, ca_cert=None, download_concurrency=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
