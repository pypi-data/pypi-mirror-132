...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, url=None, max_retries=None, name=None, proxy_url=None, proxy_username=None, proxy_password=None, tls_validation=None, total_timeout=None, sock_connect_timeout=None, pulp_labels=None, headers=None, username=None, sock_read_timeout=None, download_concurrency=None, connect_timeout=None, password=None, rate_limit=None, ca_cert=None, client_key=None, client_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
