...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_href=None, tls_validation=None, pulp_created=None, max_retries=None, url=None, sock_read_timeout=None, download_concurrency=None, pulp_last_updated=None, pulp_labels=None, ca_cert=None, headers=None, client_cert=None, total_timeout=None, name=None, connect_timeout=None, sock_connect_timeout=None, rate_limit=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
