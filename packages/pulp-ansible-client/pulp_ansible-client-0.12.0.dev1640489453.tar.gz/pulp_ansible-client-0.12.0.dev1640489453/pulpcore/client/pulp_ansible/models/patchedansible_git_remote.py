...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, tls_validation=None, max_retries=None, url=None, sock_read_timeout=None, download_concurrency=None, pulp_labels=None, proxy_username=None, password=None, ca_cert=None, headers=None, client_cert=None, username=None, total_timeout=None, name=None, connect_timeout=None, proxy_password=None, sock_connect_timeout=None, rate_limit=None, client_key=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
