...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_href=None, sock_connect_timeout=None, rate_limit=None, pulp_labels=None, download_concurrency=None, url=None, pulp_last_updated=None, total_timeout=None, connect_timeout=None, proxy_url=None, name=None, pulp_created=None, ca_cert=None, client_cert=None, headers=None, tls_validation=None, sock_read_timeout=None, max_retries=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
