...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_href=None, client_cert=None, connect_timeout=None, pulp_labels=None, sock_connect_timeout=None, download_concurrency=None, proxy_url=None, ca_cert=None, name=None, url=None, headers=None, tls_validation=None, pulp_last_updated=None, rate_limit=None, sock_read_timeout=None, total_timeout=None, max_retries=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
