...
class AnsibleGitRemote(object):
    ...
    def __init__(self, proxy_password=None, password=None, client_cert=None, connect_timeout=None, pulp_labels=None, sock_connect_timeout=None, download_concurrency=None, proxy_url=None, ca_cert=None, name=None, url=None, headers=None, tls_validation=None, client_key=None, proxy_username=None, rate_limit=None, sock_read_timeout=None, total_timeout=None, max_retries=None, username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
