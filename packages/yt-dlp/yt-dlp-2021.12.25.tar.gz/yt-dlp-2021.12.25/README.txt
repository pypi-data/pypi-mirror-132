...
[Release version] [CI Status] [License: Unlicense] [Donate] [Supported
Sites] [Discord] [Doc Status] [Commits] [Last Commit] [Downloads] [PyPi
Downloads]
...
-   Based on YOUTUBE-DL 2021.12.17 COMMIT/5014BD6 and YOUTUBE-DLC
...
-   OTHER NEW OPTIONS: Many new options have been added such as --print,
    --wait-for-video, --sleep-requests, --convert-thumbnails,
...
-   IMPROVEMENTS: Regex and other operators in --match-filter, multiple
    ...
    more format selection options, merge multi-video/audio etc
...
You can simply download the correct binary file for your OS: [WINDOWS]
[UNIX-LIKE]
...
PS: The manpages, shell completion files etc. are available in
yt-dlp.tar.gz
...
-   KEYRING - For decrypting cookies of chromium-based browsers on
    Linux. Licensed under MIT
...
6.  MORE CONVERSIONS: In addition to the normal format types
    ...
    suffixes (Eg: 10M), and to Sanitize as filename (flag # for
...
pl_infojson, chapter. For example,
...
of the templates (except default) is empty, that type of file will not
be written. Eg: --write-thumbnail -o "thumbnail:" will write thumbnails
only for playlists and not for video.
...
set a different "description" and "synopsis". Any value set to the meta_
