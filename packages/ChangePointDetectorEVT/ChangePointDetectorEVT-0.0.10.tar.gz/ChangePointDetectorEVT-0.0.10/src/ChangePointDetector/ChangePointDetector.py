...
class ChangePointDetectorSession:
    def __init__(self, data,dates, SeasonalityPeriods=0,ForecastPeriods=3):
    ...
    #This is the main function    
        gs_orig=self.TimeseriesModel.KalmanModel.filter(self.ts.data).filtered_state[-1,:]  #Get underlying trend
...
#         PredictionVariance=PredictionVariance*Prediction
        ...
        TrendVariance=[x*np.linalg.norm(self.ts.data)**2 for x in TrendVariance]
