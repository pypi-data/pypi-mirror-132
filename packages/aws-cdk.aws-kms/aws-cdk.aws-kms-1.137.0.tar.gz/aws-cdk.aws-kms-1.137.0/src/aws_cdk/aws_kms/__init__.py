...
class AliasProps:
    def __init__(
        ...
        *,
        ...
        :exampleMetadata: lit=test/integ.key-sharing.lit.ts
...
class Alias(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        props = AliasProps(
            alias_name=alias_name, removal_policy=removal_policy, target_key=target_key
        )
