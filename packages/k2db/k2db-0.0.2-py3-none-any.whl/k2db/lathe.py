...
from k2db.utils import ConfigHandler, Similarity, get_logger, Tokenizer, next_path,LatheResult
...
class Lathe:
    def __init__(self, **kwargs):
        ...
        if self.config is None:
            self.config = ConfigHandler(config_directory=config_directory)
    ...
    def keyword_search(self,keyword_query=None,**kwargs):
        ...
        show_kms_in_result = kwargs.get('show_kms_in_result',False)
