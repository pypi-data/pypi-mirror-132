...
class IndexHandler:
    ...
    def merge_partial_value_indexes_and_process_max_frequency(self):
        ...
        with ExitStack() as stack:
            partial_value_indexes = [stack.enter_context(shelve.open(fname.removesuffix('.db'),flag='r')) for fname in filenames]
            final_value_index = stack.enter_context(shelve.open(f'{self.config.value_index_filepath.removesuffix(".db")}'))
