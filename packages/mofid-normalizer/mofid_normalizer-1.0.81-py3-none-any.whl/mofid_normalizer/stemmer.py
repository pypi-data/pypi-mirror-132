...
class FindStems:
    ...
    def verb_rule_checker(self, input_word):
        ...
        Returns
        -------
        str, If CAN divide verb based on rules will be return normalized format of that.
        None, If CAN'T divide verb based on rules.
        """
    ...
    def verbs_decomposer(self, word):
        ...
        Returns
        -------
        output: str, if can decomposed verb with our rules else None
        """
        # All verb tenses
    ...
    def noun_part_jointer(self, stem, suffix):
        ...
        Parameters
        ----------
        stem : str, root of the word
        suffix : str, list of suffix for a word

        Returns
        -------
        str, normalized version of word (Sticky version of the word)
        """
