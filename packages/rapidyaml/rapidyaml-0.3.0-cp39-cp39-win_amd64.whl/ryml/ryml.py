...
def emit_malloc(t, id):
    return _ryml.emit_malloc(t, id)

def emit_length(t, id):
    return _ryml.emit_length(t, id)

def emit_to_substr(t, id, s):
    return _ryml.emit_to_substr(t, id, s)
...
class Tree(object):
    ...
    def has_siblings(self, node):
        return _ryml.Tree_has_siblings(self, node)
