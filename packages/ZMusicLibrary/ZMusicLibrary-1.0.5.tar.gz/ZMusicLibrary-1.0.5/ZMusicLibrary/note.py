...
class Note:
    ...
    intervals =         ["P1", "A1", "m2", "M2", "A2", "m3", "M3", "P4", "A4", "D5", "P5", "A5", "m6", "M6", "A6", "D7", "m7", "M7"]
    num_half_tones =    [   0,    1,    1,    2,    3,    3,    4,    5,    6,    6,    7,    8,    8,    9,   10,    9,   10,   11]
    letter_increments = [   0,    0,    1,    1,    1,    2,    2,    3,    3,    4,    4,    4,    5,    5,    5,    6,    6,    6]
    ##################
