...
class MaterializationTypes(AutoName):
    """
    Attributes:
        ephemeral (str): The model isn't materialized, and should be used as a CTE
        view (str): The model is materialized as a View
        table (str): The model is materialized as a table
    """
