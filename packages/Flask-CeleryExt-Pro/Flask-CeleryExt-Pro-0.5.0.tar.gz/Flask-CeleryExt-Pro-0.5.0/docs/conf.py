...
htmlhelp_basename = 'flask-celeryext_namedoc'
...
latex_documents = [
  (master_doc, 'flask-celeryext.tex', u'flask-celeryext Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'flask-celeryext', u'flask-celeryext Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'flask-celeryext', u'Flask-CeleryExt Documentation',
   author, 'flask-celeryext', 'Flask-CeleryExt is a simple integration layer between Celery and Flask.',
   'Miscellaneous'),
]
