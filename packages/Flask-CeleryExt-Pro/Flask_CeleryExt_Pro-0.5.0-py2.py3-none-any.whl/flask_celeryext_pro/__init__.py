...
Initialize the extension like this:
    ...
    >>> from flask_celeryext_pro import FlaskCeleryExt
    >>> app = Flask('testapp')
...
base class:
    ...
    >>> from flask_celeryext_pro import RequestContextTask
...
can also use separately:
    ...
    >>> from flask_celeryext_pro import create_celery_app
    >>> app = Flask('testapp')
...
extension:
    ...
    >>> from flask_celeryext_pro import AppContextTask
    >>> def make_celery(app):
