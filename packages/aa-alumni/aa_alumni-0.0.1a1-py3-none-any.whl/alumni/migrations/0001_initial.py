# Generated by Django 3.1.12 on 2021-07-01 05:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('corporation_id', 'record_id'),
                                               name='CorporationAllianceRecord'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, help_text='Characters with these Alliances in their History will be given Alumni Status', to='eveonline.EveAllianceInfo'),
        ),
        migrations.AddField(
            model_name='alumnisetup',
            name='alumni_corporations',
            field=models.ManyToManyField(
                blank=True, help_text='Characters with these Corps in their History will be given Alumni Status', to='eveonline.EveCorporationInfo'),
        ),
        migrations.AddConstraint(
            model_name='charactercorporationhistory',
