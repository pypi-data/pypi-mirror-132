...
def alumni_check_character(character_id: int) -> bool:
    ...
    if character.corporation_id in alumni_setup.alumni_corporations.all().values('corporation_id'):
        # Cheapo cop-out to end early
        alumni_state.member_characters.add(character)
        return True

    if character.alliance_id in alumni_setup.alumni_alliances.all().values('alliance_id'):
        # Cheapo cop-out to end early
        alumni_state.member_characters.add(character)
        return True
    ...
    for char_corp in char_corp_history:
        if char_corp.corporation_id in alumni_setup.alumni_corporations.all().values('corporation_id'):
            # Cheapo cop-out to end early
            alumni_state.member_characters.add(character)
            return True
