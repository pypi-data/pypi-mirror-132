...
{'root mean squared error', 'root mean squared log error', 'mean bias error', 'relative squared error', 'relative absolute error'}
...
>>root_mean_squared_error(true value, predicted value)
>>root_mean_squared_log_error(true value, predicted value)
>>mean_bias_error(true value, predicted value)
>>relative_squared_error(true value, predicted value)
>>relative_absolute_error(true value, predicted value)
