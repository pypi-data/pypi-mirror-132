...
def split_beams_task(tmp_path, input_dataset_document_with_simple_parameters):
    with SplitBeams(
        ...
        ds = VispBeamTestHeaders(
            dataset_shape=(task.num_files, 2000, 2560), array_shape=(1, 2000, 2560), time_delta=10
        )
        header_generator = (
