...
class SqlStr:
    ...
    @staticmethod
    def update_sql_str(table, target, where, select_in=None, between=None, like=None, compare=None):
        return make_sql_str_util('update', table, update_target=target, where=where, select_in=select_in,
                                 between=between, like=like, compare=compare)

    @staticmethod
    def delete_sql_str(table, where, select_in=None, between=None, like=None, compare=None):
...
class PresMySql(SqlStr):
    ...
    # 执行删除语句
    def to_delete(self, table, where, select_in=None, between=None, like=None, compare=None):
        return self.exec_sql(
            self.delete_sql_str(table, where, select_in=select_in, between=between, like=like, compare=compare))

    # 执行更新语句
    def to_update(self, table, target, where, select_in=None, between=None, like=None, compare=None):
        return self.exec_sql(
    ...
    def to_query(self, table, target=None, where=None, order=None, limit=None, is_all=True, select_in=None,
                 between=None, like=None, compare=None):
        return self.exec_sql(
