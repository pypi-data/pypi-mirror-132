...
Select the :guilabel:`REMOTEACTION.poller` script and save without any parmeters.
...
Schedule ID (``REMOTEACTIONPOLL`` in the example) must be provided as 
an argument.
...
.. automodule:: remote_actions.REMOTEACTION.scripts.poller
    :members:
    :undoc-members:
    :show-inheritance:
