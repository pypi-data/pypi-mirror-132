...
class EmailsApi(object):
    ...
    def list_quarantine_data(self, files, **kwargs):  # noqa: E501
        """Takes a list of email hashes and returns a list of their quarantine data  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_quarantine_data(files, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_quarantine_data_with_http_info(files, **kwargs)  # noqa: E501
        else:
            (data) = self.list_quarantine_data_with_http_info(files, **kwargs)  # noqa: E501
            return data

    def list_quarantine_data_with_http_info(self, files, **kwargs):  # noqa: E501
        """Takes a list of email hashes and returns a list of their quarantine data  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_quarantine_data_with_http_info(files, async_req=True)
        >>> result = thread.get()
        ...
        if ('files' not in params or
                params['files'] is None):
            raise ValueError("Missing the required parameter `files` when calling `list_quarantine_data`")  # noqa: E501
