...
*EmailsApi* | [**list_quarantine_data**](docs/EmailsApi.md#list_quarantine_data) | **POST** /emails/quarantinedata/ | Takes a list of email hashes and returns a list of their quarantine data
...
*ReportsApi* | [**list_processing_reports**](docs/ReportsApi.md#list_processing_reports) | **GET** /reports/processing/ | Retrieves a list of the daily processing reports
...
## Documentation For Models
 ...
 - [ProcessingReportList](docs/ProcessingReportList.md)
 - [ProcessingReportListInner](docs/ProcessingReportListInner.md)
 - [ProcessingReportListInnerObjCounts](docs/ProcessingReportListInnerObjCounts.md)
 ...
 - [ProcessingReportListResponse](docs/ProcessingReportListResponse.md)
