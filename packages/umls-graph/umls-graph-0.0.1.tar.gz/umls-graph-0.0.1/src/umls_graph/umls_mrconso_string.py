...
def make_umls_mrconso_string(mysql_info,save_path="umls_sui_nodes.csv",save_folder=""):
    if save_folder!="":
    ...
    sql = "SELECT distinct SUI FROM mrconso"
    sql_count = "SELECT count(distinct SUI) FROM mrconso"
