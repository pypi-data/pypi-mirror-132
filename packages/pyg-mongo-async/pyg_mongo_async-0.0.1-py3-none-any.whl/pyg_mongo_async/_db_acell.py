from pyg_base import acell, is_date, ulist, logger, cell_clear, as_list, get_DAG, topological_sort, waiter, get_cache
from pyg_mongo._db_cell import db_cell, _load_asof
...
class db_acell(acell):
    ...
    def _clear(self):
        ...
        if self.get(_db) is None: 
            ...
            return self[[_db] + self.db(mode = 'aw')._pk]
