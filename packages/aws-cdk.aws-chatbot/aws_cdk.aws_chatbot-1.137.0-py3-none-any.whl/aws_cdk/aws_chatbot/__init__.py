...
class CfnSlackChannelConfiguration(
    ...
    def __init__(
        ...
        *,
        ...
        :param guardrail_policies: ``AWS::Chatbot::SlackChannelConfiguration.GuardrailPolicies``.
        ...
        :param user_role_required: ``AWS::Chatbot::SlackChannelConfiguration.UserRoleRequired``.
        '''
