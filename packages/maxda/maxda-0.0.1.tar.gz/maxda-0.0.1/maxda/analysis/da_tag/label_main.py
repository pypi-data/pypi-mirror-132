...
from maxda.config.maxda_config import get_nlp_model_path
from maxda.analysis.analysis_interface import DfProcessInterface, RowInterface
from maxda.analysis.da_tag.label_extract import KeywordBaseExtractor, KeywordSegmentExtractor, KeywordExtractUtil
from maxda.analysis.da_tag.label_dict import PandaLabelDictTool, LineLabelDict
from maxda.analysis.da_tag.label_verify import VerifyLabelDict
from maxda.analysis.da_tag.label_core import LabelComponentChecker
...
class LabelBase(RowInterface):
    ...
    def load_config_data(self, **config):
        tag_config_path = config['mappingDictPath']
