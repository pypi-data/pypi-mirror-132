...
from maxda.analysis.da_tag.diatance_tag import continuous_addition
...
class navy_judgment(WaterRuleInterface):
    ...
    def _load(self):
        ...
        self.weibo_water_content_10 = WaterOrdinaryWays.get_clean('weibo_water_content_10')
    def judgment(self, data):
        ...
        if data['content']:
            ...
            # 内容前10个字出现特定词就算水军
            content_10 = text_content[:10]
            for word in self.weibo_water_content_10:
                if word in content_10:
                    return True
            # 判断文本内容是否含有水军判断词
