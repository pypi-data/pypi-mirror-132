...
class PandaTool(object):
    ...
    def load_one_file(input_file_path, sheet_name=0, header=0, dtype="str"):
        ...
        if extension.endswith("xlsx") or extension.endswith("xls"):
            df = pd.read_excel(input_file_path, header=header, encoding='utf_8_sig', sheet_name=sheet_name, dtype=dtype)
    ...
    @staticmethod
    def save(output_file_path, df_content, max_line=999000, index=False, file_match_mode="many-file"):
        """
