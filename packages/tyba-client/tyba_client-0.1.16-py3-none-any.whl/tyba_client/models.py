...
dam_energy_prices = t.List[float]

@dataclass_json
@dataclass
class AncillaryEnergyPrices(object):
    dam: dam_energy_prices
    rtm: t.List[float]
...
class StorageModel(object):
    ...
    energy_prices: t.Union[AncillaryEnergyPrices,dam_energy_prices]
