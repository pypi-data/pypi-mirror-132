...
@LastEditTime: 2021-12-29 16:08:23
...
class HorseracelampListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        horseracelamp_list = self.business_process_executed(order_base_model.get_horseracelamp_list(act_id, module_id,is_search_module, page_size), ref_params={})
