...
@LastEditTime: 2021-12-17 16:12:40
...
class TaskBaseModel(FrameBaseModel):
    ...
    def process_share(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,check_new_user=False,check_user_nick=True,continue_request_expire=5):
        """
    ...
    def process_common_task(self,task_type,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,check_new_user=False,check_user_nick=True,continue_request_expire=5):
        """
        :description: 处理通用的任务 只限制领取数量和领取的时间时可以使用
        :param app_id:应用标识
        :param act_id:活动标识
        :param module_id:活动模块标识
        :param user_id:用户标识
