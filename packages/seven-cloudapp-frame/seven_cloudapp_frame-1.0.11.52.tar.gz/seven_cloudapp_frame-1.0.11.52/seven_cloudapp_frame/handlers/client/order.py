...
@LastEditTime: 2021-12-30 11:52:05
    ...
    def get_async(self):
        ...
        if invoke_result_data.success == False:
            ...
            if invoke_result_data.data:
                condition = invoke_result_data.data.get("condition", f"create_date>'{TimeHelper.add_hours_by_format_time(hour=-1)}'")
        order_base_model = OrderBaseModel(context=self)
        horseracelamp_list = self.business_process_executed(order_base_model.get_horseracelamp_list(act_id, module_id, is_search_module, condition, page_size), ref_params={})
