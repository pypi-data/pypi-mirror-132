...
@LastEditTime: 2021-12-20 18:31:22
...
class IpInfoListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        return self.response_json_success(IpBaseModel(context=self).get_ip_info_list(app_id, act_id, page_size, page_index,is_cache=False))
