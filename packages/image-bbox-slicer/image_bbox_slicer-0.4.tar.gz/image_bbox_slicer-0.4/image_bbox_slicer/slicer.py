"""
Slicer functionality of ``image_bbox_slicer``.
"""
import os
import csv
import glob
...
class Slicer(object):
    ...
    def config_ann_dirs(self, ann_src, ann_dst=os.path.join(os.getcwd(), 'sliced_annotations')):
        """Configures paths to source and destination directories after validating them.
        Suitable when doing only annotations slicing.
