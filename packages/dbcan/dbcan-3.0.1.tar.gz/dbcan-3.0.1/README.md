...
Updated
---
- V3.0.1  please use `pip install run-dbcan==3.0.1` for update
    ...
    5. Re-range the code. The command line is `run_dbcan` without the suffix `.py`. Please check the command lines below.
    6. db is fls 
