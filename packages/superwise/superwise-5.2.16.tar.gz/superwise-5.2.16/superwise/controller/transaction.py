...
class TransactionController(BaseController):
    ...
    def __init__(self, client, sw):
        """
        constructor for DataController class
    ...
    def log_records(self, task_id: str, records: List[dict], version_id: Optional[str] = None):
        ...
        :param task_id: string - model id
        :param version_id: string - version id  of the model -   Optional[for prediction records]
        :param records: List[dict] - list of records of data,  each record is a dict.
        :return transaction_id: string - uuid of the log operation
        """
    ...
    def log_from_gcs(self, file_path: str, service_account: Dict):
        ...
        :param file_path: gcs file path
        :param service_account: dict of the service account.
        :return transaction_id: string - uuid of the log operation
        """
    ...
    def log_file(self, file_path: str, _origin_path: Optional[str] = None):
        ...
        :param _origin_path: url for file stored in customer bucket - for internal usage[Optional]
        :return transaction_id: string - uuid of the log operation
        """
