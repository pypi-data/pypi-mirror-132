...
class SqueakAdminStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTwitterStreamStatus = channel.unary_unary(
                '/squeaknode.SqueakAdmin/GetTwitterStreamStatus',
                request_serializer=proto_dot_squeak__admin__pb2.GetTwitterStreamStatusRequest.SerializeToString,
                response_deserializer=proto_dot_squeak__admin__pb2.GetTwitterStreamStatusReply.FromString,
                )
...
def add_SqueakAdminServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetTwitterStreamStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.GetTwitterStreamStatus,
                    request_deserializer=proto_dot_squeak__admin__pb2.GetTwitterStreamStatusRequest.FromString,
                    response_serializer=proto_dot_squeak__admin__pb2.GetTwitterStreamStatusReply.SerializeToString,
            ),
    }
...
class SqueakAdmin(object):
    ...
    @staticmethod
    def GetTwitterStreamStatus(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/squeaknode.SqueakAdmin/GetTwitterStreamStatus',
            proto_dot_squeak__admin__pb2.GetTwitterStreamStatusRequest.SerializeToString,
            proto_dot_squeak__admin__pb2.GetTwitterStreamStatusReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
