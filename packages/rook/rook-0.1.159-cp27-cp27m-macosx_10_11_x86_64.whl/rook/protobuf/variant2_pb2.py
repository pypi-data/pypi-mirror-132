...
Error2 = _reflection.GeneratedProtocolMessageType('Error2', (_message.Message,), dict(
  DESCRIPTOR = _ERROR2,
...
Variant2 = _reflection.GeneratedProtocolMessageType('Variant2', (_message.Message,), dict(
