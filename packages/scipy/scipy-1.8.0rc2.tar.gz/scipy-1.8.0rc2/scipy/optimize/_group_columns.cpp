...
namespace __pythran__group_columns
{
  ...
  typename group_sparse::type<argument_type0, argument_type1, argument_type2, argument_type3>::result_type group_sparse::operator()(argument_type0&& m, argument_type1&& n, argument_type2&& indices, argument_type3&& indptr) const
  {
    ...
    {
      long  __target139969091411632 = n;
      for (long  i=0L; i < __target139969091411632; i += 1L)
      {
        ...
        {
          long  __target139969091254928 = indptr[pythonic::operator_::add(i, 1L)];
          for (long  k=indptr[i]; k < __target139969091254928; k += 1L)
          {
            union_[indices[k]] = 1L;
          }
        }
        {
          long  __target139969091255456 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, groups));
          for (long  j=0L; j < __target139969091255456; j += 1L)
          {
            ...
            {
              long  __target139969091307072 = indptr[pythonic::operator_::add(j, 1L)];
              for (long  k_=indptr[j]; k_ < __target139969091307072; k_ += 1L)
              {
            ...
            {
              {
                long  __target139969091372128 = indptr[pythonic::operator_::add(j, 1L)];
                for (long  k__=indptr[j]; k__ < __target139969091372128; k__ += 1L)
                {
  ...
  typename group_dense::type<argument_type0, argument_type1, argument_type2>::result_type group_dense::operator()(argument_type0&& m, argument_type1&& n, argument_type2&& A) const
  {
    ...
    {
      long  __target139969090664672 = n;
      for (long  i=0L; i < __target139969090664672; i += 1L)
      {
        if (pythonic::operator_::ge(groups[i], 0L))
        {
          continue;
        ...
        {
          long  __target139969090858432 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, groups));
          for (long  j=0L; j < __target139969090858432; j += 1L)
          {
            if (pythonic::operator_::lt(groups[j], 0L))
            {
              all_grouped = false;
            ...
            typename pythonic::lazy<decltype(false)>::type intersect = false;
            {
              long  __target139969091417088 = m;
              for (long  k=0L; k < __target139969091417088; k += 1L)
              {
