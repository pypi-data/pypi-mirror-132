...
class RundeckJobs(object):
    ...
    min_retry_delay = os.environ.get("RD_OPTION_MIN_RETRY_DELAY", 60)
    max_retry_delay = os.environ.get("RD_OPTION_MIN_RETRY_DELAY", 180)
    number_of_retries = os.environ.get("RD_OPTION_NUMBER_OF_RETRIES", 3)
