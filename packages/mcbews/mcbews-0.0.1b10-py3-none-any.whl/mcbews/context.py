...
from . import minecraft_properties as mp
...
class ConvertErrorContext(BotContext):
    def __init__(self, converter, argument, *ctx_args, **ctx_kwargs):
        super().__init__(*ctx_args, **ctx_kwargs)
...
class TooManyArgumentsContext(BotContext):
    def __init__(self, command, arguments, *ctx_args, **ctx_kwargs):
        super().__init__(*ctx_args, **ctx_kwargs)
        self.command = command
        self.arguments = arguments

class NotAuthorizedContext (BotContext):
    def __init__(self, command, author, *ctx_args, **ctx_kwargs):
        super().__init__(*ctx_args, **ctx_kwargs)
        self.command = command
        self.author = author
