...
setup(
    ...
    version='2.0.5',                          # Update the version number for new releases
    author="Voya",
...
#    packages=find_packages(include=['dann5', 'dann5.*']),
    ...
    package_data={'dann5': ['dann5/d5o2.cp39-win_amd64.pyd']},
    include_package_data = True,
    install_requires=['pybind11'],
    python_requires=">=3.9",
    data_files=[('dann5', ['dann5/d5o2.cp39-win_amd64.pyd'])],
