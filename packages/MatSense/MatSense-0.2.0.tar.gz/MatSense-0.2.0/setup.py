...
setuptools.setup(
    ...
    url='https://github.com/atomiechen/MatSense',  # Optional
    ...
    # project.
    author='Atomie CHEN',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='atomic_cwh@163.com',  # Optional
    ...
    # larger catalog.
    keywords='matrix sensor, signal processing, 3D visualization',  # Optional
