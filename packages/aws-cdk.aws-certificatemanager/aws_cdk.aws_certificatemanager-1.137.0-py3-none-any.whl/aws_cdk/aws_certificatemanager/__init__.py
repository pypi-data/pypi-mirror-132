...
class PrivateCertificate(
    ...
    Example::
        ...
        # certificate_authority is of type ICertificateAuthority
        
        private_certificate = certificatemanager.PrivateCertificate(self, "MyPrivateCertificate",
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            private_certificate_props = certificatemanager.PrivateCertificateProps(
                certificate_authority=certificate_authority,
                domain_name="domainName",
