    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            asset_props = apprunner_alpha.AssetProps(
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            ecr_props = apprunner_alpha.EcrProps(
                repository=repository,
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            ecr_public_props = apprunner_alpha.EcrPublicProps(
                image_identifier="imageIdentifier",
...
class GitHubConnection(
    ...
    Example::
        ...
        git_hub_connection = apprunner_alpha.GitHubConnection("arn")
    '''
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            github_repository_props = apprunner_alpha.GithubRepositoryProps(
                configuration_source=apprunner_alpha.ConfigurationSourceType.REPOSITORY,
                connection=git_hub_connection,
                repository_url="repositoryUrl",
...
class Runtime(
    ...
    Example::
        ...
        runtime = apprunner_alpha.Runtime.of("name")
    '''
...
class Service(
    ...
    Example::
        ...
        service = apprunner_alpha.Service(self, "MyService",
            source=source,
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            service_props = apprunner_alpha.ServiceProps(
                source=source,
...
class Source(
    ...
    def from_ecr(
        ...
        *,
        ...
        '''
        props = EcrProps(
            image_configuration=image_configuration, repository=repository, tag=tag
        )
    ...
    def from_ecr_public(
        ...
        *,
        ...
        props = EcrPublicProps(
            image_configuration=image_configuration, image_identifier=image_identifier
        )
