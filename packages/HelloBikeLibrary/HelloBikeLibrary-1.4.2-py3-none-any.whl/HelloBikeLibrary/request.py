...
# @Last Modified time: 2021-10-29 16:14:44
		...
		with sessions.Session() as session:
			...
			# soa序列化和反序列化
				...
				if rep.status_code == 200:
					...
					return rep.status_code,rep.text
			elif url != "https://fox-backend.hellobike.cn/gct/soarequest" and isServer(): #and isServer()
				logger.info('server')
				us = UseMysql()
				host = us.getOfficeEnv()
				del us
				data = kwargs.get('data',{})
				# logger.info(host)
				fwUrl = "http://{host}/api/fw".format(host=host)
				
				data['method'] = method
				data['url'] = url
				data['headers'] = kwargs.get('headers',{})


				rep = session.request(url=fwUrl, method='post', json=data)
...
if __name__ == '__main__':
	...
	# url = 'http://fox.hellobike.cn:8088/gct/ci/soas?env=fat&serviceName=AppHellobikeRideApiService'
	# headers={'content-type':'application/x-www-form-urlencoded'}
	# print(request.request_client(url=url,method='get',headers=headers))

	data = {"addr":"10.71.53.165:9997","iface":"com.easybike.rideprocess.ifaces.RideIface","method":"detail","request":{"arg0":{"systemCode":"62","token":"d17bea5685644865952429db7cafc4a6","_xff":"58.246.57.146","action":"user.ride.detail","clientId":"","orderGuid":"16354933314441200331126","orderId":"","userNewId":"1200331126","_fingerPrintHash":"","_riskId":"2d88cbdba5c44366a067931b821b7253","adCode":"361002","startTime":0,"_uuid":"d0747cbf74b7470b9b3ca6205c61e9a3","ticket":"MTU5NTQ4Nzg0Ng==.7b3TC+dag3QDu9kl5MIJjpjlgihesVu16rrSrpjEw0U=","version":"5.86.0","cityCode":"0794","riskControlData":{"userAgent":"Mozilla/5.0 (Linux; Android 9; Redmi K20 Build/PKQ1.190302.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/72.0.3626.121 Mobile Safari/537.36","mobileNoInfo":"","ssidName":"HelloBike","capability":"NONE","roam":"","batteryLevel":"39","deviceLat":27.96560028643023,"deviceLon":116.3332115950345,"systemCode":"62","network":"Wifi"},"ip":"58.246.57.146","_userAgent":"okhttp/3.12.2"}}}
	print(request.request_client(data=data,method='post'))
