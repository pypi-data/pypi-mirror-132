...
def query(appId,appSec,sql,*params,datasource=SS_DATASOURCE.DS_EFORM):
    if not datasource is SS_DATASOURCE:
        raise Exception('ERROR:must use enum SS_DATASOURCE!!!!')
