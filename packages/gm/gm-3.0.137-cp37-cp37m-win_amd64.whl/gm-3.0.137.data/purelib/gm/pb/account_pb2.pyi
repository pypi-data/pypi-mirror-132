...
class Position(Message):
    ...
    fpnl_open: float = ...
    """持仓浮动盈亏,基于开仓均价，适用于期货((price-vwap_open)*volume*multiplier)"""
