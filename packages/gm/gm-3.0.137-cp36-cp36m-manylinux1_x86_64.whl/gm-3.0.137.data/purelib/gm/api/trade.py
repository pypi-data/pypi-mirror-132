...
def option_preorder_valid_volume(symbol, price, side, account=""):
    # type: (Text, float, int, Text) -> int
    """
    获取可开数量 \n
    params: \n
    \t symbol:              标的代码
    ...
    if c_status_fail(status, 'py_gmi_get_entrustable_volume_by_symbol_pb') or rsp_str is None:
        return None
