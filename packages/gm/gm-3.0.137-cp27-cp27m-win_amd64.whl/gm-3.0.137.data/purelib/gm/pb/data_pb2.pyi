...
class Quote(Message):
    ...
    def ClearField(self, field_name: Literal[u"ask_p",b"ask_p",u"ask_v",b"ask_v",u"bid_p",b"bid_p",u"bid_v",b"bid_v"]) -> None: ...
...
class Instrument(Message):
    ...
    is_suspended: int = ...
    multiplier: float = ...
    """deprecated: move to InstrumentInfo"""

    margin_ratio: float = ...
    """deprecated: moved to InstrumentInfo"""
    ...
    def HasField(self, field_name: Literal[u"created_at",b"created_at",u"info",b"info"]) -> bool: ...
    def ClearField(self, field_name: Literal[u"adj_factor",b"adj_factor",u"created_at",b"created_at",u"info",b"info",u"is_suspended",b"is_suspended",u"lower_limit",b"lower_limit",u"margin_ratio",b"margin_ratio",u"multiplier",b"multiplier",u"position",b"position",u"pre_close",b"pre_close",u"pre_settle",b"pre_settle",u"sec_level",b"sec_level",u"settle_price",b"settle_price",u"strike_price",b"strike_price",u"symbol",b"symbol",u"upper_limit",b"upper_limit"]) -> None: ...
