...
def calculate_price(s: float, k: float, r: float, v: float, t: float, cp: float = 1., d1: float = None):
    # bs理论价格
    check_value(cp)
    if v <= 0:
        return max(0, cp * (s-k))
...
def calculate_delta(s: float, k: float, r: float, v: float, t: float, cp: float = 1., cash: bool = False, d1: float = None) -> float:
    # 计算delta
...
def calculate_vega(s: float, k: float, r: float, v: float, t: float, cash: bool = False, d1: float = None) -> float:
    # 计算 vage
    if v <= 0:
        return 0
...
def calculate_theta(s: float, k: float, r: float, v: float, t: float, cp: float = 1., cash: bool = False, d1: float = None) -> float:
    # 计算 theta
    check_value(cp, v=v)
...
def calculate_rho(s: float, k: float, r: float, v: float, t: float, cp: float = 1., cash: bool = False, d1: float = None) -> float:
    # 计算 rho
    check_value(cp, v=v)
...
def calculate_gamma(s: float, k: float, r: float, v: float, t: float,  cash: bool = False, d1: float = None) -> float:
    # 计算 gamma
    check_value(v=v)
...
def calculate_greeks(s: float, k: float, r: float, v: float, t: float, cp: float = 1., cash: bool = False, d1: float = None) -> float:
    # 计算 greeks
    check_value(v=v)
...
def calculate_iv(p: float, s: float, k: float, r: float, t: float, cp: float = 1.) -> float:
