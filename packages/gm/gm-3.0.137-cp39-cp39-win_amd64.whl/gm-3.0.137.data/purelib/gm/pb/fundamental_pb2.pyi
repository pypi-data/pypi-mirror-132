...
class GetOptionSymbolsByExchangeReq(Message):
    ...
    def ClearField(self, field_name: Literal[u"call_or_put",b"call_or_put",u"exchange",b"exchange",u"trade_date",b"trade_date"]) -> None: ...
...
class GetOptionSymbolsByInAtOutReq(Message):
    ...
    def ClearField(self, field_name: Literal[u"call_or_put",b"call_or_put",u"execute_month",b"execute_month",u"in_at_out",b"in_at_out",u"price",b"price",u"price_type",b"price_type",u"trade_time",b"trade_time",u"underlying_symbol",b"underlying_symbol"]) -> None: ...
