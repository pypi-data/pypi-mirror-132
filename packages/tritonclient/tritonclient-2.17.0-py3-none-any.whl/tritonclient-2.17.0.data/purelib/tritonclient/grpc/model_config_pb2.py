...
_MODELSEQUENCEBATCHING = _descriptor.Descriptor(
  ...
  nested_types=[_MODELSEQUENCEBATCHING_CONTROL, _MODELSEQUENCEBATCHING_CONTROLINPUT, _MODELSEQUENCEBATCHING_STATE, _MODELSEQUENCEBATCHING_STRATEGYDIRECT, _MODELSEQUENCEBATCHING_STRATEGYOLDEST, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
