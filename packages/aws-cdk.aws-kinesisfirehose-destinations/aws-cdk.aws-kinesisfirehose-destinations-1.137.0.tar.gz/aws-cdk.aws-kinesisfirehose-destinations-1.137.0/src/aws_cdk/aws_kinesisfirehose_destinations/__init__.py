...
class BackupMode(enum.Enum):
    ...
    :exampleMetadata: lit=../aws-kinesisfirehose-destinations/test/integ.s3-bucket.lit.ts
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            # compression is of type Compression
            # data_processor is of type IDataProcessor
            # key is of type Key
