...
```python
from bumbo-ivan.api import API
...
You can create custom middleware classes by inheriting from the `bumbo-ivan.middleware.Middleware` class and overriding its two methods
that are called before and after each request:

```python
from bumbo-ivan.api import API
from bumbo-ivan.middleware import Middleware
