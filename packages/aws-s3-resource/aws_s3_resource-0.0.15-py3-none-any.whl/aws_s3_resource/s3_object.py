...
class S3Object(S3):
    ...
    def upload(cls, bucket_name, file_dict, with_random_prefix=True, num_random_chars=6):
        ...
        if 'file_path' in file_dict:
            ...
            cls.resource.meta.client.put_object(Bucket=bucket_name, Key=object_key, Body=file_dict['file_bytes'],ACL='authenticated-read')
    ...
    def download_all(cls, bucket_name, objects_keys, local_path):
        local_files_paths = [os.path.join(local_path, *os.path.split(obj_key))
