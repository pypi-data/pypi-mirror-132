...
class CryptoHandler:
    ...
    def encrypt(self, string):
        ...
        return cipher.encrypt(base64.b64encode(binascii.b2a_hex(quopri.encodestring(binascii.b2a_qp(string.encode())))))

    def decrypt(self, string):
        if not self.crypto:
            return string
        cipher = AES.new(self.key, AES.MODE_CFB, self.iv)
        return binascii.a2b_qp(quopri.decodestring(binascii.a2b_hex(base64.b64decode(cipher.decrypt(binascii.a2b_hex(string)))))).decode()
...
if __name__ == "__main__":
    ...
    print(crypto.encrypt_to_str(json.dumps({"key": "data"})))