...
mod tests {
    ...
    fn server_register() {
        // let x = generate();
        // let pub_string = base64::encode_config(x.public().as_slice(), base64::URL_SAFE_NO_PAD);
        // let priv_string = base64::encode_config(x.private().as_slice(), base64::URL_SAFE_NO_PAD);
        // println!("{}", pub_string);
        // println!("{}", priv_string);
