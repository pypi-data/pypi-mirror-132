...
class FeatureEngineer:
    ...
    def create_data(self,df):
        ...
        if 'calamar_22' in self.additional_indicators:
            df = self.add_clamar(df,5,'calamar_22')
...
class DayTradeFeatureEngineer:
    ...
    def create_data(self,df):
        ...
        if 'vix_fix_5000' in self.additional_indicators:
            df = self.add_vix_fix(df,5000,'vix_fix_5000')
        if 'sharpe_5000' in self.additional_indicators:
            df = self.add_sharpe(df,5000,'sharpe_5000')
        if 'sortino_5000' in self.additional_indicators:
            df = self.add_sortino(df,5000,'sortino_5000')
        if 'calamar_5000' in self.additional_indicators:
            df = self.add_clamar(df,5000,'calamar_5000')
        if 'max_value_price_5000' in self.additional_indicators:
            df = self.add_max_value(df,5000,'max_value_price_5000','close')
        if 'min_value_price_5000' in self.additional_indicators:
            df = self.add_min_value(df,5000,'min_value_price_5000','close')
        if 'max_value_volume_5000' in self.additional_indicators:
            df = self.add_max_value(df,5000,'max_value_volume_5000','volume')
        if 'min_value_volume_5000' in self.additional_indicators:
            df = self.add_min_value(df,5000,'min_value_volume_5000','volume')
        
        if 'vix_fix_10000' in self.additional_indicators:
            df = self.add_vix_fix(df,10000,'vix_fix_10000')
        if 'sharpe_10000' in self.additional_indicators:
            df = self.add_sharpe(df,10000,'sharpe_10000')
        if 'sortino_10000' in self.additional_indicators:
            df = self.add_sortino(df,10000,'sortino_10000')
        if 'calamar_10000' in self.additional_indicators:
            df = self.add_clamar(df,10000,'calamar_10000')
        if 'max_value_price_10000' in self.additional_indicators:
            df = self.add_max_value(df,10000,'max_value_price_10000','close')
        if 'min_value_price_10000' in self.additional_indicators:
            df = self.add_min_value(df,10000,'min_value_price_10000','close')
        if 'max_value_volume_10000' in self.additional_indicators:
            df = self.add_max_value(df,10000,'max_value_volume_10000','volume')
        if 'min_value_volume_10000' in self.additional_indicators:
            df = self.add_min_value(df,10000,'min_value_volume_10000','volume')
        
        if 'vix_fix_50000' in self.additional_indicators:
            df = self.add_vix_fix(df,50000,'vix_fix_50000')
        if 'sharpe_50000' in self.additional_indicators:
            df = self.add_sharpe(df,50000,'sharpe_50000')
        if 'sortino_50000' in self.additional_indicators:
            df = self.add_sortino(df,50000,'sortino_50000')
        if 'calamar_50000' in self.additional_indicators:
            df = self.add_clamar(df,50000,'calamar_50000')
        if 'max_value_price_50000' in self.additional_indicators:
            df = self.add_max_value(df,50000,'max_value_price_50000','close')
        if 'min_value_price_50000' in self.additional_indicators:
            df = self.add_min_value(df,50000,'min_value_price_50000','close')
        if 'max_value_volume_50000' in self.additional_indicators:
            df = self.add_max_value(df,50000,'max_value_volume_50000','volume')
        if 'min_value_volume_50000' in self.additional_indicators:
            df = self.add_min_value(df,50000,'min_value_volume_50000','volume')
