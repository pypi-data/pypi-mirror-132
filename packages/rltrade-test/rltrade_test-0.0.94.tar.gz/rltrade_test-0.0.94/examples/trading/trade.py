...
demo = True
trade_period = ('2021-01-02','2021-11-30') #example testing day
accountid = "DU1770002"
path = 'models/etfs'
...
env_kwargs = {
    ...
    "ticker_col_name":"tic",
    "filter_threshold":1.0, #between 0.1 to 1, select percentage of top stocks 0.3 means 30% of top stocks
