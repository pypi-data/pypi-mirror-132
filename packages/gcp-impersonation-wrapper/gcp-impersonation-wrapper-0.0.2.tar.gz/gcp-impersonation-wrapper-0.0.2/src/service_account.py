...
from src.impersonated_service_account import ImpersonatedServiceAccount
...
class ServiceAccount:
    ...
    def list_all_impersonatable_service_account_objects(self) -> list:
        self.service_accounts = self.service.projects().serviceAccounts().list(
            name=f"projects/{self.project_id}").execute()
