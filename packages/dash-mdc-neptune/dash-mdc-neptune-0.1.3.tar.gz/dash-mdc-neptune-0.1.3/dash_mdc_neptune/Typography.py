...
- variant (string; default 'h6'):
    ...
    @_explicitize_args
    def __init__(self, component=Component.UNDEFINED, variant=Component.UNDEFINED, text=Component.UNDEFINED, **kwargs):
        self._prop_names = ['component', 'text', 'variant']
        self._type = 'Typography'
        self._namespace = 'dash_mdc_neptune'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['component', 'text', 'variant']
