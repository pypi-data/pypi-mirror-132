...
from hydenv.examples.gapminder import HydenvGapMinderExample

CLIs = [HydenvHoboExamples, HydenvSpaceExamples, HydenvOSMExamples, HydenvEarthquakeExamples, HydenvWorldBorderExample, HydenvGPXExample, HydenvRaspiLoggerExample, HydenvOWMExample, HydenvNetatmoExample, HydenvGapMinderExample]
...
class HydenvExamples:
    ...
    def gapminder(self):
        """
        Gapminder example.\n
        Loads the Gapminder dataset from plotly library and uploads it to the 
        database.
        """
        cli = HydenvGapMinderExample(connection=self.__connection, quiet=self.quiet)
        cli.run()
