...
class tAudKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tAudKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tAudKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tAudKey._cache_davs(dvc)
