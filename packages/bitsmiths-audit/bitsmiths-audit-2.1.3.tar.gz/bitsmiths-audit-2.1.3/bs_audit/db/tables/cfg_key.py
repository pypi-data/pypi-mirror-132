...
class tCfgKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tCfgKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tCfgKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tCfgKey._cache_davs(dvc)
