...
class HttpRunner(object):
    ...
    def __run_step_request(self, step: TStep) -> StepData:
        ...
        try:
            ...
            # # 本地编写的脚本才会存储到db
            # if self.__project_meta.mode == "off-line":
            #     self.build_api_testcase_step(self._id, self.__teststeps, "admin", "admin", False)
            #     # self.__write_db(self.__config, self.__teststeps, False)
