...
class CfnUserPoolClient(
    ...
    :exampleMetadata: lit=test/integ.cognito.lit.ts
    ...
    def __init__(
        ...
        *,
        ...
        props = CfnUserPoolResourceServerProps(
            identifier=identifier, name=name, scopes=scopes, user_pool_id=user_pool_id
        )
    ...
    def __init__(
        ...
        *,
        ...
        props = CfnUserPoolUICustomizationAttachmentProps(
            client_id=client_id, css=css, user_pool_id=user_pool_id
        )
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"attribute_mapping": "attributeMapping", "user_pool": "userPool"},
)
