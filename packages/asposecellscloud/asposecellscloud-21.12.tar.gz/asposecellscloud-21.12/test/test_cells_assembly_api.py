...
global_api = None
class TestCellsAssemblyApi(unittest.TestCase):
    ...
    def test_cells_assembly(self):
        ...
        result = self.api.post_assemble({ "assemblytest.xlsx" :assemblytest,  "datasource.xlsx":datasource},"ds")
        # print(result)
        pass
