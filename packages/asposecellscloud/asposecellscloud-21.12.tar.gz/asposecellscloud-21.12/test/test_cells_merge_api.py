...
global_api = None
class TestCellsMergeApi(unittest.TestCase):
    ...
    def test_cells_merge(self):
        ...
        result = self.api.post_merge({ "assemblytest.xlsx" :assemblytest,  "datasource.xlsx":datasource})
        # print(result)
        pass
    def test_cells_merge_pdf(self):
        assemblytest = os.path.dirname(os.path.realpath(__file__)) + "/../TestData/" + "assemblytest.xlsx"
        datasource = os.path.dirname(os.path.realpath(__file__)) + "/../TestData/" + "datasource.xlsx"
        result = self.api.post_merge({ "assemblytest.xlsx" :assemblytest,  "datasource.xlsx":datasource},format ="pdf")
        # print(result)
        pass
