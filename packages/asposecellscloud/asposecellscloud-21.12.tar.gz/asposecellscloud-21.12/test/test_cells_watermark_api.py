...
global_api = None
class TestCellsWaterMarkApi(unittest.TestCase):
    ...
    def test_cells_watermark(self):
        ...
        result = self.api.post_watermark({ "assemblytest.xlsx" :assemblytest,  "datasource.xlsx":datasource},"aspose.cells cloud","#fff")
        # print(result)
        pass
