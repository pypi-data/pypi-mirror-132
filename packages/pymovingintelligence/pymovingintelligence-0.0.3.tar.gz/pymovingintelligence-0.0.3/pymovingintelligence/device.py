...
class Device:
    ...
    #     self.current_maximum_speed = JsonUtils.get_attribute(way, ['tags', 'maxspeed'], 0)
    ...
    #         self.current_address.city = JsonUtils.get_attribute(street, ['tags', 'addr:city'], None)
    #         self.current_address.address = JsonUtils.get_attribute(street, ['tags', 'addr:street'], None)
    #         self.current_address.house_number = JsonUtils.get_attribute(street, ['tags', 'addr:housenumber'], None)
    #         self.current_address.postal_code = JsonUtils.get_attribute(street, ['tags', 'addr:postcode'], None)
    #         self.current_address.country = JsonUtils.get_attribute(street, ['tags', 'addr:country'], None)
    #     else:
    #         self.current_address = None

    #         if (way is not None):
    #             self.current_address = Address(None)
    #             self.current_address.address = JsonUtils.get_attribute(way, ['tags', 'ref'], 0)
    ...
    #             self.current_address = Address(None)
    #         self.current_address.country = JsonUtils.get_attribute(country, ['tags', 'int_name'], None)
