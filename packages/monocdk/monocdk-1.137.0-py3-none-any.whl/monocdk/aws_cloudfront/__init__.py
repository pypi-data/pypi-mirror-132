    ...
    class CacheBehaviorProperty:
        def __init__(
            ...
            *,
            ...
            :param response_headers_policy_id: ``CfnDistribution.CacheBehaviorProperty.ResponseHeadersPolicyId``.
    ...
    class DefaultCacheBehaviorProperty:
        def __init__(
            ...
            *,
            ...
            :param response_headers_policy_id: ``CfnDistribution.DefaultCacheBehaviorProperty.ResponseHeadersPolicyId``.
...
class CfnKeyGroup(
    ...
    @jsii.data_type(
        ...
        jsii_struct_bases=[],
        name_mapping={"comment": "comment", "items": "items", "name": "name"},
    )
...
class CfnResponseHeadersPolicy(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        response_headers_policy_config: typing.Union["CfnResponseHeadersPolicy.ResponseHeadersPolicyConfigProperty", _IResolvable_a771d0ef],
    ) -> None:
        '''Create a new ``AWS::CloudFront::ResponseHeadersPolicy``.

        :param scope: - scope in which this resource is defined.
        :param id: - scoped id of the resource.
        :param response_headers_policy_config: ``AWS::CloudFront::ResponseHeadersPolicy.ResponseHeadersPolicyConfig``.
        '''
    ...
    class AccessControlAllowHeadersProperty:
        def __init__(self, *, items: typing.Sequence[builtins.str]) -> None:
            '''
            :param items: ``CfnResponseHeadersPolicy.AccessControlAllowHeadersProperty.Items``.
    ...
    class AccessControlAllowMethodsProperty:
        def __init__(self, *, items: typing.Sequence[builtins.str]) -> None:
            '''
            :param items: ``CfnResponseHeadersPolicy.AccessControlAllowMethodsProperty.Items``.
    ...
    class AccessControlAllowOriginsProperty:
        def __init__(self, *, items: typing.Sequence[builtins.str]) -> None:
            '''
            :param items: ``CfnResponseHeadersPolicy.AccessControlAllowOriginsProperty.Items``.
    ...
    class AccessControlExposeHeadersProperty:
        def __init__(self, *, items: typing.Sequence[builtins.str]) -> None:
            '''
            :param items: ``CfnResponseHeadersPolicy.AccessControlExposeHeadersProperty.Items``.
    ...
    class ContentSecurityPolicyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param content_security_policy: ``CfnResponseHeadersPolicy.ContentSecurityPolicyProperty.ContentSecurityPolicy``.
            :param override: ``CfnResponseHeadersPolicy.ContentSecurityPolicyProperty.Override``.
    ...
    class ContentTypeOptionsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param override: ``CfnResponseHeadersPolicy.ContentTypeOptionsProperty.Override``.
    ...
    class CorsConfigProperty:
        def __init__(
            ...
            *,
            ...
            access_control_allow_headers: typing.Union["CfnResponseHeadersPolicy.AccessControlAllowHeadersProperty", _IResolvable_a771d0ef],
            access_control_allow_methods: typing.Union["CfnResponseHeadersPolicy.AccessControlAllowMethodsProperty", _IResolvable_a771d0ef],
            access_control_allow_origins: typing.Union["CfnResponseHeadersPolicy.AccessControlAllowOriginsProperty", _IResolvable_a771d0ef],
            access_control_expose_headers: typing.Optional[typing.Union["CfnResponseHeadersPolicy.AccessControlExposeHeadersProperty", _IResolvable_a771d0ef]] = None,
            ...
            '''
            :param access_control_allow_credentials: ``CfnResponseHeadersPolicy.CorsConfigProperty.AccessControlAllowCredentials``.
            :param access_control_allow_headers: ``CfnResponseHeadersPolicy.CorsConfigProperty.AccessControlAllowHeaders``.
            :param access_control_allow_methods: ``CfnResponseHeadersPolicy.CorsConfigProperty.AccessControlAllowMethods``.
            :param access_control_allow_origins: ``CfnResponseHeadersPolicy.CorsConfigProperty.AccessControlAllowOrigins``.
            :param access_control_expose_headers: ``CfnResponseHeadersPolicy.CorsConfigProperty.AccessControlExposeHeaders``.
            :param access_control_max_age_sec: ``CfnResponseHeadersPolicy.CorsConfigProperty.AccessControlMaxAgeSec``.
            :param origin_override: ``CfnResponseHeadersPolicy.CorsConfigProperty.OriginOverride``.
    ...
    class CustomHeaderProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param header: ``CfnResponseHeadersPolicy.CustomHeaderProperty.Header``.
            :param override: ``CfnResponseHeadersPolicy.CustomHeaderProperty.Override``.
            :param value: ``CfnResponseHeadersPolicy.CustomHeaderProperty.Value``.
    ...
    class CustomHeadersConfigProperty:
        def __init__(
            self,
            *,
            items: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union["CfnResponseHeadersPolicy.CustomHeaderProperty", _IResolvable_a771d0ef]]],
        ) -> None:
            '''
            :param items: ``CfnResponseHeadersPolicy.CustomHeadersConfigProperty.Items``.
    ...
    class FrameOptionsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param frame_option: ``CfnResponseHeadersPolicy.FrameOptionsProperty.FrameOption``.
            :param override: ``CfnResponseHeadersPolicy.FrameOptionsProperty.Override``.
    ...
    class ReferrerPolicyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param override: ``CfnResponseHeadersPolicy.ReferrerPolicyProperty.Override``.
            :param referrer_policy: ``CfnResponseHeadersPolicy.ReferrerPolicyProperty.ReferrerPolicy``.
    ...
    class ResponseHeadersPolicyConfigProperty:
        def __init__(
            ...
            *,
            comment: typing.Optional[builtins.str] = None,
            cors_config: typing.Optional[typing.Union["CfnResponseHeadersPolicy.CorsConfigProperty", _IResolvable_a771d0ef]] = None,
            custom_headers_config: typing.Optional[typing.Union["CfnResponseHeadersPolicy.CustomHeadersConfigProperty", _IResolvable_a771d0ef]] = None,
            name: builtins.str,
            security_headers_config: typing.Optional[typing.Union["CfnResponseHeadersPolicy.SecurityHeadersConfigProperty", _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''
            :param comment: ``CfnResponseHeadersPolicy.ResponseHeadersPolicyConfigProperty.Comment``.
            :param cors_config: ``CfnResponseHeadersPolicy.ResponseHeadersPolicyConfigProperty.CorsConfig``.
            :param custom_headers_config: ``CfnResponseHeadersPolicy.ResponseHeadersPolicyConfigProperty.CustomHeadersConfig``.
            :param name: ``CfnResponseHeadersPolicy.ResponseHeadersPolicyConfigProperty.Name``.
            :param security_headers_config: ``CfnResponseHeadersPolicy.ResponseHeadersPolicyConfigProperty.SecurityHeadersConfig``.
    ...
    class SecurityHeadersConfigProperty:
        def __init__(
            self,
            *,
            content_security_policy: typing.Optional[typing.Union["CfnResponseHeadersPolicy.ContentSecurityPolicyProperty", _IResolvable_a771d0ef]] = None,
            content_type_options: typing.Optional[typing.Union["CfnResponseHeadersPolicy.ContentTypeOptionsProperty", _IResolvable_a771d0ef]] = None,
            frame_options: typing.Optional[typing.Union["CfnResponseHeadersPolicy.FrameOptionsProperty", _IResolvable_a771d0ef]] = None,
            referrer_policy: typing.Optional[typing.Union["CfnResponseHeadersPolicy.ReferrerPolicyProperty", _IResolvable_a771d0ef]] = None,
            strict_transport_security: typing.Optional[typing.Union["CfnResponseHeadersPolicy.StrictTransportSecurityProperty", _IResolvable_a771d0ef]] = None,
            xss_protection: typing.Optional[typing.Union["CfnResponseHeadersPolicy.XSSProtectionProperty", _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''
            :param content_security_policy: ``CfnResponseHeadersPolicy.SecurityHeadersConfigProperty.ContentSecurityPolicy``.
            :param content_type_options: ``CfnResponseHeadersPolicy.SecurityHeadersConfigProperty.ContentTypeOptions``.
            :param frame_options: ``CfnResponseHeadersPolicy.SecurityHeadersConfigProperty.FrameOptions``.
            :param referrer_policy: ``CfnResponseHeadersPolicy.SecurityHeadersConfigProperty.ReferrerPolicy``.
            :param strict_transport_security: ``CfnResponseHeadersPolicy.SecurityHeadersConfigProperty.StrictTransportSecurity``.
            :param xss_protection: ``CfnResponseHeadersPolicy.SecurityHeadersConfigProperty.XSSProtection``.
    ...
    class StrictTransportSecurityProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param access_control_max_age_sec: ``CfnResponseHeadersPolicy.StrictTransportSecurityProperty.AccessControlMaxAgeSec``.
            :param include_subdomains: ``CfnResponseHeadersPolicy.StrictTransportSecurityProperty.IncludeSubdomains``.
            :param override: ``CfnResponseHeadersPolicy.StrictTransportSecurityProperty.Override``.
            :param preload: ``CfnResponseHeadersPolicy.StrictTransportSecurityProperty.Preload``.
    ...
    class XSSProtectionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param mode_block: ``CfnResponseHeadersPolicy.XSSProtectionProperty.ModeBlock``.
            :param override: ``CfnResponseHeadersPolicy.XSSProtectionProperty.Override``.
            :param protection: ``CfnResponseHeadersPolicy.XSSProtectionProperty.Protection``.
            :param report_uri: ``CfnResponseHeadersPolicy.XSSProtectionProperty.ReportUri``.
...
class ResponseCustomHeadersBehavior:
    def __init__(
        ...
        *,
        ...
        '''(experimental) Configuration for a set of HTTP response headers that are sent for requests that match a cache behavior that’s associated with this response headers policy.
...
class ResponseHeadersFrameOptions:
    def __init__(
        ...
        *,
        ...
        '''(experimental) Determines whether CloudFront includes the X-Frame-Options HTTP response header and the header’s value.
...
class ResponseHeadersReferrerPolicy:
    def __init__(
        ...
        *,
        ...
        '''(experimental) Determines whether CloudFront includes the Referrer-Policy HTTP response header and the header’s value.
...
class ResponseHeadersStrictTransportSecurity:
    def __init__(
        ...
        *,
        ...
        '''(experimental) Determines whether CloudFront includes the Strict-Transport-Security HTTP response header and the header’s value.
...
class ResponseHeadersXSSProtection:
    def __init__(
        ...
        *,
        ...
        '''(experimental) Determines whether CloudFront includes the X-XSS-Protection HTTP response header and the header’s value.
...
class ResponseSecurityHeadersBehavior:
    def __init__(
        ...
        *,
        ...
        :param frame_options: (experimental) Determines whether CloudFront includes the X-Frame-Options HTTP response header and the header’s value. Default: - no frame options
        :param referrer_policy: (experimental) Determines whether CloudFront includes the Referrer-Policy HTTP response header and the header’s value. Default: - no referrer policy
        :param strict_transport_security: (experimental) Determines whether CloudFront includes the Strict-Transport-Security HTTP response header and the header’s value. Default: - no strict transport security
        :param xss_protection: (experimental) Determines whether CloudFront includes the X-XSS-Protection HTTP response header and the header’s value. Default: - no xss protection
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            viewer_certificate_options = cloudfront.ViewerCertificateOptions(
                aliases=["aliases"],
                security_policy=cloudfront.SecurityPolicyProtocol.SSL_V3,
                ssl_method=cloudfront.SSLMethod.SNI
            )
