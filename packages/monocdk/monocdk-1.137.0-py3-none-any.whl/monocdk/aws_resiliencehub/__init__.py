...
class CfnApp(
    ...
    def __init__(
        ...
        *,
        ...
        resource_mappings: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union["CfnApp.ResourceMappingProperty", _IResolvable_a771d0ef]]],
    ...
    class ResourceMappingProperty:
        def __init__(
            ...
            *,
            ...
            physical_resource_id: typing.Union["CfnApp.PhysicalResourceIdProperty", _IResolvable_a771d0ef],
...
class CfnResiliencyPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        policy: typing.Union[_IResolvable_a771d0ef, typing.Mapping[builtins.str, typing.Union["CfnResiliencyPolicy.FailurePolicyProperty", _IResolvable_a771d0ef]]],
