...
class CfnDatastore(
    ...
    class IotSiteWiseMultiLayerStorageProperty:
        def __init__(
            self,
            *,
            customer_managed_s3_storage: typing.Union["CfnDatastore.CustomerManagedS3StorageProperty", _IResolvable_a771d0ef],
        ) -> None:
            '''
        ...
        def customer_managed_s3_storage(
            self,
        ) -> typing.Union["CfnDatastore.CustomerManagedS3StorageProperty", _IResolvable_a771d0ef]:
            ...
            return typing.cast(typing.Union["CfnDatastore.CustomerManagedS3StorageProperty", _IResolvable_a771d0ef], result)
