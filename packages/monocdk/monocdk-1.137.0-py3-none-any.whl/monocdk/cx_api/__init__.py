...
class CloudArtifact(metaclass=jsii.JSIIMeta, jsii_type="monocdk.cx_api.CloudArtifact"):
    ...
    Example::
        ...
        # cloud_assembly is of type CloudAssembly
...
class CloudAssemblyBuilder(
    ...
    Example::
        ...
        # cloud_assembly_builder is of type CloudAssemblyBuilder
...
@jsii.data_type(
    ...
    name_mapping={"data": "data", "trace": "trace", "type": "type"},
)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[_MetadataEntry_b98ee123],
    name_mapping={"data": "data", "trace": "trace", "type": "type", "path": "path"},
)
