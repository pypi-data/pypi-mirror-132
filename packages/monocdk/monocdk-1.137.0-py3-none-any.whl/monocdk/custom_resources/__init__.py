...
from monocdk import CustomResource
import monocdk as logs
import monocdk as iam
import monocdk as cr
...
class AwsCustomResource(
    ...
    Example::
        ...
        from monocdk import custom_resources
        
        # aws_custom_resource_policy is of type AwsCustomResourcePolicy
        # duration is of type Duration
        # parameters is of type object
        # physical_resource_id is of type PhysicalResourceId
        # role is of type Role
        
        aws_custom_resource = custom_resources.AwsCustomResource(self, "MyAwsCustomResource",
            policy=aws_custom_resource_policy,
...
class AwsCustomResourcePolicy(
    ...
    Example::
        ...
        aws_custom_resource_policy = custom_resources.AwsCustomResourcePolicy.from_sdk_calls(
            resources=["resources"]
        )
    '''
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            aws_custom_resource_props = custom_resources.AwsCustomResourceProps(
                policy=aws_custom_resource_policy,
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            aws_sdk_call = custom_resources.AwsSdkCall(
                action="action",
                service="service",
...
class PhysicalResourceId(
    ...
    Example::
        ...
        physical_resource_id = custom_resources.PhysicalResourceId.from_response("responsePath")
    '''
...
class PhysicalResourceIdReference(
    ...
    Example::
        ...
        physical_resource_id_reference = custom_resources.PhysicalResourceIdReference()
    '''
...
class SdkCallsPolicyOptions:
    def __init__(self, *, resources: typing.Sequence[builtins.str]) -> None:
        ...
        Example::
            ...
            sdk_calls_policy_options = custom_resources.SdkCallsPolicyOptions(
                resources=["resources"]
            )
        '''
        self._values: typing.Dict[str, typing.Any] = {
