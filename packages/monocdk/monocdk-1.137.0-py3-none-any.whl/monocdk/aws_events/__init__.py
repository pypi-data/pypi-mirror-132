...
```python
# on_commit_rule is of type Rule
...
class Archive(
    ...
    Example::
        ...
        # detail is of type object
        # duration is of type Duration
        # event_bus is of type EventBus
...
class CfnConnection(
    ...
    Example::
        ...
        # auth_parameters is of type object
...
class CfnEventBus(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        props = CfnEventBusProps(event_source_name=event_source_name, name=name)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"event_source_name": "eventSourceName", "name": "name"},
)
    ...
    class CapacityProviderStrategyItemProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param base: ``CfnRule.CapacityProviderStrategyItemProperty.Base``.
            :param capacity_provider: ``CfnRule.CapacityProviderStrategyItemProperty.CapacityProvider``.
            :param weight: ``CfnRule.CapacityProviderStrategyItemProperty.Weight``.
    ...
    class EcsParametersProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param capacity_provider_strategy: ``CfnRule.EcsParametersProperty.CapacityProviderStrategy``.
            :param enable_ecs_managed_tags: ``CfnRule.EcsParametersProperty.EnableECSManagedTags``.
            :param enable_execute_command: ``CfnRule.EcsParametersProperty.EnableExecuteCommand``.
            ...
            :param placement_constraints: ``CfnRule.EcsParametersProperty.PlacementConstraints``.
            :param placement_strategies: ``CfnRule.EcsParametersProperty.PlacementStrategies``.
            :param platform_version: ``CfnRule.EcsParametersProperty.PlatformVersion``.
            :param propagate_tags: ``CfnRule.EcsParametersProperty.PropagateTags``.
            :param reference_id: ``CfnRule.EcsParametersProperty.ReferenceId``.
            :param tag_list: ``CfnRule.EcsParametersProperty.TagList``.
    ...
    class PlacementConstraintProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param expression: ``CfnRule.PlacementConstraintProperty.Expression``.
            :param type: ``CfnRule.PlacementConstraintProperty.Type``.
    ...
    class PlacementStrategyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param field: ``CfnRule.PlacementStrategyProperty.Field``.
            :param type: ``CfnRule.PlacementStrategyProperty.Type``.
    ...
    class TagProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param key: ``CfnRule.TagProperty.Key``.
            :param value: ``CfnRule.TagProperty.Value``.
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            # construct is of type Construct
            # role is of type Role
            # rule_target_input is of type RuleTargetInput
