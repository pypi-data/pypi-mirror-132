...
class CfnEnvironment(
    ...
    def __init__(
        ...
        *,
        ...
        federation_parameters: typing.Optional[typing.Union["CfnEnvironment.FederationParametersProperty", _IResolvable_a771d0ef]] = None,
        kms_key_id: typing.Optional[builtins.str] = None,
        name: builtins.str,
        superuser_parameters: typing.Optional[typing.Union["CfnEnvironment.SuperuserParametersProperty", _IResolvable_a771d0ef]] = None,
    ) -> None:
