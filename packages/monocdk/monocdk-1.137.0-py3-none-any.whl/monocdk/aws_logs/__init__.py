...
class CfnLogGroup(
    ...
    def __init__(
        ...
        *,
        ...
        :param tags: ``AWS::Logs::LogGroup.Tags``.
        '''
    ...
    def __init__(
        ...
        *,
        ...
        props = CfnQueryDefinitionProps(
            log_group_names=log_group_names, name=name, query_string=query_string
        )
...
class CfnResourcePolicy(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: - scope in which this resource is defined.
        :param id: - scoped id of the resource.
        :param policy_document: ``AWS::Logs::ResourcePolicy.PolicyDocument``.
        :param policy_name: ``AWS::Logs::ResourcePolicy.PolicyName``.
        '''
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            # filter_pattern is of type IFilterPattern
...
class ResourcePolicy(
    ...
    '''(experimental) Creates Cloudwatch log group resource policies.
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            # filter_pattern is of type IFilterPattern
            # log_subscription_destination is of type ILogSubscriptionDestination
    ...
    def __init__(
        ...
        *,
        ...
        props = CrossAccountDestinationProps(
            destination_name=destination_name, role=role, target_arn=target_arn
        )
