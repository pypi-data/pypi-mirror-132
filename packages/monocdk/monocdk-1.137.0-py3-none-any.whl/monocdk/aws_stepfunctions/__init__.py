...
```python
from monocdk import Construct, Stack
import monocdk as sfn
import monocdk as tasks
...
class CfnStateMachine(
    ...
    Example::
        ...
        cfn_state_machine = stepfunctions.CfnStateMachine(self, "MyCfnStateMachine",
            ...
            # the properties below are optional
            definition=stepfunctions.CfnStateMachine.DefinitionProperty(),
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            # result_selector is of type object
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            # metric_dimensions is of type object
            # parameters is of type object
...
class Task(State, metaclass=jsii.JSIIMeta, jsii_type="monocdk.aws_stepfunctions.Task"):
    ...
    Example::
        ...
        # duration is of type Duration
        # parameters is of type object
        # step_functions_task is of type IStepFunctionsTask
