...
domain = es.Domain(self, "Domain",
    ...
    fine_grained_access_control=es.aws_elasticsearch.AdvancedSecurityOptions(master_user_arn=user.user_arn),
    encryption_at_rest=es.aws_elasticsearch.EncryptionAtRestOptions(enabled=True),
