...
class CfnLicense(
    ...
    def __init__(
        ...
        *,
        ...
        entitlements: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union["CfnLicense.EntitlementProperty", _IResolvable_a771d0ef]]],
        home_region: builtins.str,
        issuer: typing.Union["CfnLicense.IssuerDataProperty", _IResolvable_a771d0ef],
        license_metadata: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union["CfnLicense.MetadataProperty", _IResolvable_a771d0ef]]]] = None,
