...
class CfnContact(
    ...
    class TargetsProperty:
        def __init__(
            self,
            *,
            channel_target_info: typing.Optional[typing.Union["CfnContact.ChannelTargetInfoProperty", _IResolvable_a771d0ef]] = None,
            contact_target_info: typing.Optional[typing.Union["CfnContact.ContactTargetInfoProperty", _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''
