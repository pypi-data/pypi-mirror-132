...
```python
tag_options_for_portfolio = servicecatalog.TagOptions({
    "cost_center": ["Data Insights", "Marketing"]
})
portfolio.associate_tag_options(tag_options_for_portfolio)

tag_options_for_product = servicecatalog.TagOptions({
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            # cloud_formation_template is of type CloudFormationTemplate
...
class CloudFormationTemplate(
    ...
    :stability: experimental
    :exampleMetadata: fixture=portfolio-product
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            # cfn_rule_condition_expression is of type ICfnRuleConditionExpression
