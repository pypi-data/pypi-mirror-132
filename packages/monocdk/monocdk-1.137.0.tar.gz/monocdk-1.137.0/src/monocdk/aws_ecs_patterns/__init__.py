...
queue_processing_fargate_service = ecs_patterns.QueueProcessingFargateService(self, "Service",
    ...
    task_subnets=ecs.aws_ec2.SubnetSelection(subnet_type=ec2.SubnetType.ISOLATED)
)
```
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            # container_image is of type ContainerImage
            # duration is of type Duration
            # hosted_zone is of type HostedZone
            # log_driver is of type LogDriver
...
class QueueProcessingServiceBase(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        capacity_provider_strategies: typing.Optional[typing.Sequence[_CapacityProviderStrategy_4ea39d95]] = None,
        circuit_breaker: typing.Optional[_DeploymentCircuitBreaker_552a9618] = None,
        cluster: typing.Optional[_ICluster_42c4ec1a] = None,
...
class ScheduledEc2TaskDefinitionOptions:
    def __init__(self, *, task_definition: _Ec2TaskDefinition_d26421bc) -> None:
        ...
        Example::
            ...
            # ec2_task_definition is of type Ec2TaskDefinition
...
class ScheduledFargateTaskDefinitionOptions:
    def __init__(self, *, task_definition: _FargateTaskDefinition_e47783a5) -> None:
        ...
        Example::
            ...
            # fargate_task_definition is of type FargateTaskDefinition
