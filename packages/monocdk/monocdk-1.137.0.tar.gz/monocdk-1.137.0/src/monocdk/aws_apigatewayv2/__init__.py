...
class BatchHttpRouteOptions:
    def __init__(self, *, integration: "HttpRouteIntegration") -> None:
        ...
        Example::
            ...
            # http_route_integration is of type HttpRouteIntegration
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"api_endpoint": "apiEndpoint", "http_api_id": "httpApiId"},
)
        ...
        *,
        ...
        Example::
            ...
            http_integration_props = apigatewayv2.HttpIntegrationProps(
                http_api=http_api,
                integration_type=apigatewayv2.HttpIntegrationType.LAMBDA_PROXY,
                integration_uri="integrationUri",
...
class HttpRouteAuthorizerBindOptions:
    def __init__(self, *, route: "IHttpRoute", scope: constructs.Construct) -> None:
        ...
        Example::
            ...
            # http_route is of type HttpRoute
        ...
        *,
        ...
        Example::
            ...
            http_route_integration_config = apigatewayv2.HttpRouteIntegrationConfig(
                payload_format_version=payload_format_version,
                type=apigatewayv2.HttpIntegrationType.LAMBDA_PROXY,
                uri="uri",
...
class WebSocketApi(
    ...
    def add_route(
        ...
        *,
        ...
        :stability: experimental
        '''
        options = WebSocketRouteOptions(authorizer=authorizer, integration=integration)
...
class WebSocketRouteAuthorizerBindOptions:
    def __init__(self, *, route: IWebSocketRoute, scope: constructs.Construct) -> None:
        ...
        Example::
            ...
            # construct is of type Construct
            # web_socket_route is of type WebSocketRoute
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"authorizer": "authorizer", "integration": "integration"},
)
...
class HttpApi(
    ...
    def from_http_api_attributes(
        ...
        *,
        ...
        :stability: experimental
        '''
        attrs = HttpApiAttributes(api_endpoint=api_endpoint, http_api_id=http_api_id)
