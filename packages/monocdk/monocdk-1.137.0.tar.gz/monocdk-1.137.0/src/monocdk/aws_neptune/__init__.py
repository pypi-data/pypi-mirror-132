...
class CfnDBCluster(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        associated_roles: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union["CfnDBCluster.DBClusterRoleProperty", _IResolvable_a771d0ef]]]] = None,
