...
class CfnInstanceAccessControlAttributeConfiguration(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        access_control_attributes: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union["CfnInstanceAccessControlAttributeConfiguration.AccessControlAttributeProperty", _IResolvable_a771d0ef]]]] = None,
        instance_arn: builtins.str,
    ) -> None:
