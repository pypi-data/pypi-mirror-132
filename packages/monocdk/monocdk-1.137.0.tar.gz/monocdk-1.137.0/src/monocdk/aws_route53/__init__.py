...
class RecordSet(
    ...
    Example::
        ...
        # record_target is of type RecordTarget
    ...
    def __init__(
        ...
        *,
        ...
        props = SrvRecordProps(
            values=values, comment=comment, record_name=record_name, ttl=ttl, zone=zone
        )
...
class ARecord(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        props = ARecordProps(
            target=target, comment=comment, record_name=record_name, ttl=ttl, zone=zone
        )
...
class AddressRecordTarget(
    ...
    Example::
        ...
        # alias_record_target is of type IAliasRecordTarget
    ...
    def __init__(
        ...
        *,
        ...
        props = CaaAmazonRecordProps(
            comment=comment, record_name=record_name, ttl=ttl, zone=zone
        )
