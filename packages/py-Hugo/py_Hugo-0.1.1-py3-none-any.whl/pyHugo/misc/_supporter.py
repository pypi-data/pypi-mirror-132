...
ALIVE_NAME = hugo_bot.me.first_name
BOTLOG_CHATID = BOTLOG = int(udB.get("LOG_CHANNEL"))


bot = borg = friday = jarvis = hugo_bot
...
class Config((object)):
    if ENV:
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Hugo")
        ...
        PLUGIN_CHANNEL = int(os.environ.get("PLUGIN_CHANNEL", -1001708237199))
