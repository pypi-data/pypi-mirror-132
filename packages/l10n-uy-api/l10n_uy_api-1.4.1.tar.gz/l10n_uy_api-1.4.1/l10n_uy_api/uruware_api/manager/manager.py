...
class Manager(object):
    ...
    def get_total_to_pay(self):
        return self.get_total_amount() + round_half_away_from_zero(self.get_mnt_non_invoiceable(),2) + round_half_away_from_zero(self.get_mnt_negative_non_invoiceable(),2)
