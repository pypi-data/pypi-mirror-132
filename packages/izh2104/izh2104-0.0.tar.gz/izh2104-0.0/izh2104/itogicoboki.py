...
def doc():
  print('izhitog', '\n=====', '\nОбеспечивает', '\n1. Численное дифференцирование и интегрирование', '\n2. Выполнение основные операций с матрицами'
        ...
        , '\nlagrange'
        , '\n--------------------------—'
        , '\nАвторы: Устинов Кирилл, Жаров Антон, Храмцов Максим')
