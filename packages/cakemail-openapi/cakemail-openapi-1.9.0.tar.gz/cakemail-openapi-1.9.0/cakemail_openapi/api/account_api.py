...
class AccountApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_self_account_endpoint = _Endpoint(
            settings={
                'response_type': (AccountResponse,),
                'auth': [
                    'OAuth2PasswordBearer'
                ],
                'endpoint_path': '/accounts/self',
                'operation_id': 'get_self_account',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_self_account_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/accounts/self',
                'operation_id': 'patch_self_account',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def get_self_account(
        ...
        **kwargs
        ...
        return self.get_self_account_endpoint.call_with_http_info(**kwargs)

    def patch_self_account(
        self,
        patch_self_account,
        **kwargs
    ):
        ...
        Args:
            patch_self_account (PatchSelfAccount):
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['patch_self_account'] = \
            patch_self_account
        return self.patch_self_account_endpoint.call_with_http_info(**kwargs)
