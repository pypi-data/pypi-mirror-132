...
import pagarmecoreapi.models.get_seller_response
...
class GetOrderItemResponse(object):
    ...
    def from_dictionary(cls,
        ...
        get_seller_response = pagarmecoreapi.models.get_seller_response.GetSellerResponse.from_dictionary(dictionary.get('GetSellerResponse')) if dictionary.get('GetSellerResponse') else None
