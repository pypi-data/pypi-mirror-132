    ...
    class SourceProperty:
        def __init__(
            ...
            *,
            ...
            :param min_latency: ``CfnFlow.SourceProperty.MinLatency``.
            ...
            :param source_ingest_port: ``CfnFlow.SourceProperty.SourceIngestPort``.
...
class CfnFlowOutput(
    ...
    def __init__(
        ...
        *,
        ...
        :param min_latency: ``AWS::MediaConnect::FlowOutput.MinLatency``.
