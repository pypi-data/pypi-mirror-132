...
class J1939_22:
    ...
    def send_pgn(self, data_page, pdu_format, pdu_specific, priority, src_address, data, time_limit=0, tos=2, trailer_format=0, frame_format=FrameFormat.FEFF):
        ...
        if data_length <= self.DataLength.TP:
            ...
            if time_limit == 0:
                ...
                session = 0 # session 0: FEFF, session 1: FBFF
