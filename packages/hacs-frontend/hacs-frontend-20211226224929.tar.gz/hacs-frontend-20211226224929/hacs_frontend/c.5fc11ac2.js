      ...
      >
        <div class="searchandfilter" ?narrow=${this.narrow}>
          ...
          <mwc-select
            ...
            @closed=${u}
          >
            ${f.map(t=>r`<mwc-list-item .value=${t}>
                  ${this.hacs.localize("dialog_add_repo.sort_by_values."+t)||t}
                </mwc-list-item>`)}
          </mwc-select>
        </div>
