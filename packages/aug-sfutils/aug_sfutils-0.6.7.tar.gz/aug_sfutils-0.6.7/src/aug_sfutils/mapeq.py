...
def rz2brzt(eqm, r_in, z_in, t_in=None):
    ...
    return interpBr/(eqm.psi_fac*dz), \
           interpBz/(eqm.psi_fac*dr), \
           interpBt/np.abs(eqm.psi_fac) * eqm.phi_sign
...
# Eq 12 in COCOs paper
    ...
    return Br/(eqm.psi_fac*dz), \
           Bz/(eqm.psi_fac*dr), \
           Bt/np.abs(eqm.psi_fac) * eqm.phi_sign
