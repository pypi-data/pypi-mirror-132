...
setup(
    ...
    url='https://github.com/enricofacca/python-reverse_communication_iterative_solver',
    ...
    entry_points={
        'console_scripts': [
            'reverse-communication-iterative-solver = reverse_communication_iterative_solver.cli:main',
        ]
    },
)
