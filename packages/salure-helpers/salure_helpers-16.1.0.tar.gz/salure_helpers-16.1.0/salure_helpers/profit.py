...
class UpdateConnector:
    ...
    def sickleave(self, data: dict, overload_fields: dict = None, method='POST') -> requests.Response:
        """
        :param data: Fields that are allowed are listed in allowed fields array. Update this whenever necessary
        :param overload_fields: The custom fields in this dataset. Give the key of the field and the value. For example: {DFEDS8-DSF9uD-DDSA: 'Vrij veld'}
        :param method: request type
        ...
        allowed_fields = ['guid', 'employment_id', 'safety_net', 'end_date', 'end_date_report_date', 'reason_ending', 'end_date_expected', 'available_first_day', 'total_hours']
        ...
        if method == 'DELETE':
            ...
            fields_to_update.update({"ThAb": data['total_hours']}) if 'total_hours' in data else fields_to_update
    ...
    def update_sickleave(self, data: dict, overload_fields: dict = None, method='PUT') -> requests.Response:
        """
        :param data: Fields that are allowed are listed in allowed fields array. Update this whenever necessary
        :param overload_fields: The custom fields in this dataset. Give the key of the field and the value. For example: {DFEDS8-DSF9uD-DDSA: 'Vrij veld'}
        :param method: request type
