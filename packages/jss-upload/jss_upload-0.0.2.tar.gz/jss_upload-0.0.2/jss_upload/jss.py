...
import json
import hashlib
from utils.const import END_POINT, ACCESS_KEY, SECRET_KEY


class Jss:

    def __init__(self, end_point=END_POINT, access_key=ACCESS_KEY, secret_key=SECRET_KEY):
        """创建一个 jss 客户端实例
             @public
    ...
    def _encode_post_data(post_data):
        ...
        sha1.update(post_data_str.encode('utf-8'))
    ...
    def has_data(self, post_data, bucket_name="pfinder-data-bucket"):
        file_name = self._encode_post_data(post_data)
