...
class InferencerApi(object):
    ...
    def list_registered_models(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: APIResponseTypingDictUuidUUIDRticAppControllersRticControllerRTiCModelMetaData
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def list_registered_models_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(APIResponseTypingDictUuidUUIDRticAppControllersRticControllerRTiCModelMetaData, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='APIResponseTypingDictUuidUUIDRticAppControllersRticControllerRTiCModelMetaData',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def register_model(self, model_name, framework_type, inference_hardware, model_weights_source, weights_path, **kwargs):  # noqa: E501
        ...
        :param bool deploy_async: Whether to wait for the model to be in state 'available' (sync), or deploy it in the background (async). If set to True (default) - The http response will be sent right away, with the state 'deploying'. If set to False, The response will return only when the model reaches 'available' state. Please take HTTP Timeouts into account when using this flag.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def register_model_with_http_info(self, model_name, framework_type, inference_hardware, model_weights_source, weights_path, **kwargs):  # noqa: E501
        ...
        if 'deploy_async' in local_var_params and local_var_params['deploy_async'] is not None:  # noqa: E501
            query_params.append(('deploy_async', local_var_params['deploy_async']))  # noqa: E501
