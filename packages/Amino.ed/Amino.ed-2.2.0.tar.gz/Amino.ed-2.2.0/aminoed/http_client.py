...
from .utils.helpers import _generate_signature, generate_device
...
class AminoHttpClient:
    ...
    async def post(self, url: str, json: dict = None, data: str = None, type: str = None):
        ...
        headers["NDC-MSG-SIG"] = await _generate_signature(self.session, dumps(json) or data)
