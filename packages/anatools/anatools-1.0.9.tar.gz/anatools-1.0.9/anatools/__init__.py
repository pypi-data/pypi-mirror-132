...
- The ``anatools.client`` package exposes the Platform API to the User. Everything that a user can do through the UI can be done via the SDK through the ``anatools.client`` package.
