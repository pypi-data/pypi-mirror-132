...
Usage:
  lk ( b | balance  )                        [ -j | -J ] <address>
  lk ( s | save     ) <contract> [--as=<name>]           <address>
  lk ( d | deploy   ) <contract> [ -v | -q ] [ -j | -J ] [--v=<value>] [--as=<name>]     [--] [<args>...]
  lk ( x | execute  ) <contract> [ -v | -q ] [ -j | -J ] [--v=<value>] ( -a | <function> [--] [<args>...] )
  lk -h | --help
  lk --version
