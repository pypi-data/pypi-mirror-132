...
class V1KubernetesClusterStatus(object):
    ...
    def __init__(self, azure: 'V1AzureClusterDriverStatus' = None, bastion_host_ip: 'str' = None, eks: 'V1EKSCusterDriverStatus' = None, ingress_ca_cert: 'str' = None, ingress_load_balancer_hostname: 'str' = None, ingress_load_balancer_ip: 'str' = None, ssh_private_key: 'str' = None, ssh_public_key: 'str' = None, _configuration=None):  # noqa: E501
    ...
    def ingress_ca_cert(self, ingress_ca_cert: 'str'):
        ...
        if (self._configuration.client_side_validation and
                ingress_ca_cert is not None and not re.search(r'^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$', ingress_ca_cert)):  # noqa: E501
            raise ValueError(r"Invalid value for `ingress_ca_cert`, must be a follow pattern or equal to `/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/`")  # noqa: E501
