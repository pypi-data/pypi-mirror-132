...
KEY_TO_TRIGGER = {"tray": "Tray icon", "status": "Status icon", "title": "Titlebar", "close": "Close button",
                  "left": "Left click", "middle": "Middle click", "right": "Right click",
                  "doubleclick": "Doubleclick", "up": "Wheel up", "down": "Wheel down"}
