...
setuptools.setup(
    name="ml_framework",  # should match the package folder
    packages=["ml_framework"],  # should match the package folder
    version="0.0.17",  # important for updates
    ...
    project_urls={  # Optional
        "Bug Tracker": "https://github.com/antsticky/AILib//issues"
    },
