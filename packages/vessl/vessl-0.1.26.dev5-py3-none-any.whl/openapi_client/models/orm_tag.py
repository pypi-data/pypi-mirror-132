...
class OrmTag(object):
    ...
    def __init__(self, color=None, created_dt=None, edges=None, id=None, name=None, tag_project=None, type=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
        ...
        if name is not None:
            self.name = name
        if tag_project is not None:
            self.tag_project = tag_project
        if type is not None:
            self.type = type
    ...
    def tag_project(self):
        """Gets the tag_project of this OrmTag.  # noqa: E501


        :return: The tag_project of this OrmTag.  # noqa: E501
        :rtype: int
        """
        return self._tag_project

    @tag_project.setter
    def tag_project(self, tag_project):
        """Sets the tag_project of this OrmTag.


        :param tag_project: The tag_project of this OrmTag.  # noqa: E501
        :type tag_project: int
        """

        self._tag_project = tag_project

    @property
    def type(self):
        """Gets the type of this OrmTag.  # noqa: E501


        :return: The type of this OrmTag.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this OrmTag.


        :param type: The type of this OrmTag.  # noqa: E501
        :type type: str
        """
