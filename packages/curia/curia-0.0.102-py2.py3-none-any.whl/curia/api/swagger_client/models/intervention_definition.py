...
class InterventionDefinition(object):
    ...
    def __init__(self, id=None, person_set=None, model_populations=None, created_at=None, created_by=None, updated_at=None, last_updated_by=None, version=None):  # noqa: E501
