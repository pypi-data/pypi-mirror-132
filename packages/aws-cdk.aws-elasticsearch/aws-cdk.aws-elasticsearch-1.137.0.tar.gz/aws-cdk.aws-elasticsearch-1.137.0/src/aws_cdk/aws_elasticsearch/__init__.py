...
class CfnDomain(
    ...
    Example::
        ...
        # access_policies is of type object
    ...
    class ColdStorageOptionsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param enabled: ``CfnDomain.ColdStorageOptionsProperty.Enabled``.
    ...
    class ElasticsearchClusterConfigProperty:
        def __init__(
            self,
            *,
            cold_storage_options: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnDomain.ColdStorageOptionsProperty"]] = None,
            ...
            '''
            :param cold_storage_options: ``CfnDomain.ElasticsearchClusterConfigProperty.ColdStorageOptions``.
...
class CognitoOptions:
    def __init__(
        ...
        *,
        ...
        :exampleMetadata: fixture=migrate-opensearch
