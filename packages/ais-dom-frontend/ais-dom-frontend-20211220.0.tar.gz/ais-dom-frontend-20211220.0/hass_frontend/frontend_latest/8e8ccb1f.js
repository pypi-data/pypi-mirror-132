      ...
      <ha-app-layout>
        <app-header fixed slot="header">
          <app-toolbar>
            ...
            ${null!==(e=this.hass.user)&&void 0!==e&&e.is_admin?i.dy`<mwc-icon-button @click=${this._openZonesEditor}
