/*! For license information please see 0a4a7783.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[83935],{54930:(e,r,t)=>{t.d(r,{D:()=>p});var i=t(87480),n=t(32207),o=t(38103),s=t(59685),a=t(88668),c=t(84298);class l extends n.oi{constructor(){super(...arguments),this.indeterminate=!1,this.progress=0,this.density=0,this.closed=!1}open(){this.closed=!1}close(){this.closed=!0}render(){const e={"mdc-circular-progress--closed":this.closed,"mdc-circular-progress--indeterminate":this.indeterminate},r=48+4*this.density,t={width:`${r}px`,height:`${r}px`};return n.dy`
      <div
      ...
      </div>`}renderDeterminateContainer(){const e=48+4*this.density,r=e/2,t=this.density>=-3?18+11*this.density/6:12.5+5*(this.density+3)/4,i=6.2831852*t,o=(1-this.progress)*i,s=this.density>=-3?4+this.density*(1/3):3+(this.density+3)*(1/6);return n.dy`
      ...
      </div>`}renderIndeterminateSpinnerLayer(){const e=48+4*this.density,r=e/2,t=this.density>=-3?18+11*this.density/6:12.5+5*(this.density+3)/4,i=6.2831852*t,o=.5*i,s=this.density>=-3?4+this.density*(1/3):3+(this.density+3)*(1/6);return n.dy`
    ...
    `:i.dy``}},{kind:"method",key:"renderEntity",value:function(e,r){const t=this.hass.states[e.entity];return e={tap_action:{action:r?"more-info":"toggle"},hold_action:{action:"more-info"},...e},t?i.dy`
      <div class="wrapper">
        <ha-icon-button
          ...
          .config=${e}
          class=${(0,a.$)({"state-on":!T.has(t.state)})}
          .icon=${e.icon||(0,h.M)(t)}
    ...
    `}}]}}),i.oi)}))}}]);
//# sourceMappingURL=0a4a7783.js.map