...
class Sessions:
    ...
    def list(
        ...
        *,
        ...
        Args:
            ...
            caller_id: return only sessions with provided phone number
            or agent/sales representative login
    ...
    def get_filter_topics(self, **kwargs):
        """
        **kwargs: dict
            types: Optional[str] = ""
            date_range: str = ""
            ...
            include_unprocessed: bool = False
        """
        return self._http_client.get("/sessions/filter/topics", params=kwargs)
