...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, pulp_labels=None, retain_repo_versions=None, versions_href=None, description=None, latest_version_href=None, pulp_created=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
