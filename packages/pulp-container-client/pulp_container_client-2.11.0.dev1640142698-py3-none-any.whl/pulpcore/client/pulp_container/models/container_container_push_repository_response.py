...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, retain_repo_versions=None, description=None, pulp_href=None, pulp_labels=None, versions_href=None, pulp_created=None, name=None, local_vars_configuration=None):  # noqa: E501
