...
class AlbController(
    ...
    Example::
        ...
        # alb_controller_version is of type AlbControllerVersion
        # cluster is of type Cluster
    ...
    def __init__(
        ...
        *,
        ...
        props = AlbControllerProps(
            cluster=cluster, policy=policy, repository=repository, version=version
        )
...
class CfnCluster(
    ...
    def __init__(
        ...
        *,
        ...
        :param logging: ``AWS::EKS::Cluster.Logging``.
        ...
        :param tags: ``AWS::EKS::Cluster.Tags``.
    ...
    class ClusterLoggingProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param enabled_types: ``CfnCluster.ClusterLoggingProperty.EnabledTypes``.
    ...
    class KubernetesNetworkConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param ip_family: ``CfnCluster.KubernetesNetworkConfigProperty.IpFamily``.
            :param service_ipv4_cidr: ``CfnCluster.KubernetesNetworkConfigProperty.ServiceIpv4Cidr``.
            :param service_ipv6_cidr: ``CfnCluster.KubernetesNetworkConfigProperty.ServiceIpv6Cidr``.
    ...
    class LoggingProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param cluster_logging: ``CfnCluster.LoggingProperty.ClusterLogging``.
    ...
    class LoggingTypeConfigProperty:
        def __init__(self, *, type: typing.Optional[builtins.str] = None) -> None:
            '''
            :param type: ``CfnCluster.LoggingTypeConfigProperty.Type``.
    ...
    class ResourcesVpcConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param endpoint_private_access: ``CfnCluster.ResourcesVpcConfigProperty.EndpointPrivateAccess``.
            :param endpoint_public_access: ``CfnCluster.ResourcesVpcConfigProperty.EndpointPublicAccess``.
            :param public_access_cidrs: ``CfnCluster.ResourcesVpcConfigProperty.PublicAccessCidrs``.
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            # alb_controller_version is of type AlbControllerVersion
            # endpoint_access is of type EndpointAccess
            # key is of type Key
            # kubernetes_version is of type KubernetesVersion
            # layer_version is of type LayerVersion
            # policy is of type object
            # role is of type Role
            # security_group is of type SecurityGroup
            # size is of type Size
            # subnet is of type Subnet
            # subnet_filter is of type SubnetFilter
            # vpc is of type Vpc
