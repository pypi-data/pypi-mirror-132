...
class WriterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MergeEntities = channel.unary_unary(
                '/fdbwriter.Writer/MergeEntities',
                request_serializer=nucliadb__protos_dot_writer__pb2.MergeEntitiesRequest.SerializeToString,
                response_deserializer=nucliadb__protos_dot_writer__pb2.OpStatus.FromString,
                )
...
class WriterServicer(object):
    ...
    def MergeEntities(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_WriterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'MergeEntities': grpc.unary_unary_rpc_method_handler(
                    servicer.MergeEntities,
                    request_deserializer=nucliadb__protos_dot_writer__pb2.MergeEntitiesRequest.FromString,
                    response_serializer=nucliadb__protos_dot_writer__pb2.OpStatus.SerializeToString,
            ),
...
class Writer(object):
    ...
    def MergeEntities(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/fdbwriter.Writer/MergeEntities',
            nucliadb__protos_dot_writer__pb2.MergeEntitiesRequest.SerializeToString,
            nucliadb__protos_dot_writer__pb2.OpStatus.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
