...
class Relation(google.protobuf.message.Message):
    ...
    class _RelationTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_RelationType.V], builtins.type):
        ...
        ORIGIN = Relation.RelationType.V(1)
        """origin related resource"""
    ...
    def HasField(self, field_name: typing_extensions.Literal["entity",b"entity","label",b"label","other",b"other","resource",b"resource","target",b"target","user",b"user"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["entity",b"entity","label",b"label","other",b"other","properties",b"properties","relation",b"relation","resource",b"resource","target",b"target","user",b"user"]) -> None: ...
