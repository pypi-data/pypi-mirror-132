...
from obserware.readers.procwind.controller import (kill_process,
                                                   resume_process,
                                                   suspend_process,
                                                   terminate_process)
from obserware.readers.procwind.provider import \
    return_mainscreen_onetimed_statistics
from obserware.screens.procwind.interface import Ui_procwind


class ProcWind(QDialog, Ui_procwind):
    def __init__(self, prociden, parent=None):
    ...
    def handle_elements(self):
        self.prepare_mainscreen_contents()
    ...
    def prepare_mainscreen_contents(self):
