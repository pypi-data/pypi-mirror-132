...
class CfnGateway(
    ...
    class GatewayPlatformProperty:
        def __init__(
            self,
            *,
            greengrass: typing.Union["CfnGateway.GreengrassProperty", _IResolvable_da3f097b],
        ) -> None:
            '''
        ...
        def greengrass(
            self,
        ) -> typing.Union["CfnGateway.GreengrassProperty", _IResolvable_da3f097b]:
            ...
            return typing.cast(typing.Union["CfnGateway.GreengrassProperty", _IResolvable_da3f097b], result)
