    ...
    def __init__(
        ...
        *,
        ...
        props = ApplicationListenerCertificateProps(
            certificates=certificates, listener=listener
        )
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"certificates": "certificates", "listener": "listener"},
)
    ...
    def from_target_group_attributes(
        ...
        *,
        ...
        attrs = TargetGroupAttributes(
            load_balancer_arns=load_balancer_arns, target_group_arn=target_group_arn
        )
