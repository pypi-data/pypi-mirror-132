...
class BucketDeployment(
    ...
    Example::
        ...
        bucket_deployment = s3_deployment.BucketDeployment(self, "MyBucketDeployment",
            ...
            memory_limit=123,
            metadata=s3_deployment.UserDefinedObjectMetadata(),
            prune=False,
            retain_on_delete=False,
            role=role,
            ...
            storage_class=s3_deployment.StorageClass.STANDARD,
            use_efs=False,
            vpc=vpc,
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            bucket_deployment_props = s3_deployment.BucketDeploymentProps(
                destination_bucket=bucket,
                sources=[source],
...
class CacheControl(
    ...
    Example::
        ...
        cache_control = s3_deployment.CacheControl.from_string("s")
    '''
