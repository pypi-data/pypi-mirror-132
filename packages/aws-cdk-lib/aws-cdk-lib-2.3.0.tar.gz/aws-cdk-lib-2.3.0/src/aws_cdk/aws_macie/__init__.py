...
class CfnFindingsFilter(
    ...
    class FindingCriteriaProperty:
        def __init__(
            self,
            *,
            criterion: typing.Optional[typing.Union["CfnFindingsFilter.CriterionProperty", _IResolvable_da3f097b]] = None,
        ) -> None:
            '''
        ...
        def criterion(
            self,
        ) -> typing.Optional[typing.Union["CfnFindingsFilter.CriterionProperty", _IResolvable_da3f097b]]:
            ...
            return typing.cast(typing.Optional[typing.Union["CfnFindingsFilter.CriterionProperty", _IResolvable_da3f097b]], result)
