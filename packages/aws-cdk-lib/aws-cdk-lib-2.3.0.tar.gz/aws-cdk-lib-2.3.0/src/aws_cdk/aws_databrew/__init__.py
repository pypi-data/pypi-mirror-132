...
class CfnJob(
    ...
    @jsii.data_type(
        jsii_type="aws-cdk-lib.aws_databrew.CfnJob.ParameterMapProperty",
        jsii_struct_bases=[],
        name_mapping={},
    )
    ...
    class StatisticOverrideProperty:
        def __init__(
            self,
            *,
            parameters: typing.Union["CfnJob.ParameterMapProperty", _IResolvable_da3f097b],
        ...
        def parameters(
            self,
        ) -> typing.Union["CfnJob.ParameterMapProperty", _IResolvable_da3f097b]:
            ...
            return typing.cast(typing.Union["CfnJob.ParameterMapProperty", _IResolvable_da3f097b], result)
...
class CfnRecipe(
    ...
    @jsii.data_type(
        jsii_type="aws-cdk-lib.aws_databrew.CfnRecipe.ParameterMapProperty",
        jsii_struct_bases=[],
        name_mapping={},
    )
    class ParameterMapProperty:
