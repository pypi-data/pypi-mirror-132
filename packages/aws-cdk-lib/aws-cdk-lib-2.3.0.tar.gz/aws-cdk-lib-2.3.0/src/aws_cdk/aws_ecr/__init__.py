...
class CfnPublicRepository(
    ...
    Example::
        ...
        # repository_catalog_data is of type object
        # repository_policy_text is of type object
...
class CfnReplicationConfiguration(
    ...
    class ReplicationRuleProperty:
        def __init__(
            ...
            *,
            ...
            :param repository_filters: ``CfnReplicationConfiguration.ReplicationRuleProperty.RepositoryFilters``.
    ...
    class RepositoryFilterProperty:
        def __init__(self, *, filter: builtins.str, filter_type: builtins.str) -> None:
            '''
            :param filter: ``CfnReplicationConfiguration.RepositoryFilterProperty.Filter``.
            :param filter_type: ``CfnReplicationConfiguration.RepositoryFilterProperty.FilterType``.
