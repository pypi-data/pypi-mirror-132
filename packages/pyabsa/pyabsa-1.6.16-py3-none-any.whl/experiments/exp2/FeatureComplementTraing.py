# -*- coding: utf-8 -*-
# file: FeatureComplementTraing.py
# time: 2021/12/27
# author: yangheng <yangheng@m.scnu.edu.cn>
# github: https://github.com/yangheng95
# Copyright (C) 2021. All Rights Reserved.
from augment import nlpaug_augment, text_attack_augment
...
# nlpaug_augment(ABSADatasetList.Laptop14)
...
# nlpaug_augment(ABSADatasetList.Restaurant14)
# Trainer(config=apc_config_english,
...
# nlpaug_augment(ABSADatasetList.Restaurant15)
# Trainer(config=apc_config_english,
...
# nlpaug_augment(ABSADatasetList.Restaurant16)
# Trainer(config=apc_config_english,
