...
class CfnStream(
    ...
    def __init__(
        ...
        *,
        ...
        stream_mode_details: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnStream.StreamModeDetailsProperty"]] = None,
        ...
        :param stream_mode_details: ``AWS::Kinesis::Stream.StreamModeDetails``.
    ...
    class StreamModeDetailsProperty:
        def __init__(self, *, stream_mode: builtins.str) -> None:
            '''
            :param stream_mode: ``CfnStream.StreamModeDetailsProperty.StreamMode``.
