import random
import time
from robertcommon.system.driver.opcda import OPCDADriver, get_sessions, get_info
...
def test_case():
    ...
    dict_config = {
                        ...
                        'host': '192.168.1.172:8804',                  #'host': '192.168.1.36:8804',
                        'enabled': True,
                        'group': f'opcda1',
                        'action': '',       #
                        'read_limit': 50,
...
def test_service():
    ...
    dict_config = {
        ...
        'host': 'localhost',  # 'host': '192.168.1.36:8804',
        'enabled': True,
        'group': f'opcda1',
        'action': '',  #
        'read_limit': 50,
    ...
    while True:
        try:
            ...
            #print(get_sessions('192.168.1.36'))
