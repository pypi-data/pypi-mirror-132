...
out[0] = p[10]*(x[1] - p[11]) - 0.0001*x[0];
out[1] = (1.0/2.0)*(-p[9]*(x[1] - p[11]) - y[0]*(p[6]*y[0] + y[4]*sin(x[0] - y[5])) - y[1]*(p[6]*y[1] + y[4]*cos(x[0] - y[5])) + u[0])/p[8];
out[2] = (-x[2] - y[0]*(-p[1] + p[0]) + u[1])/p[2];
out[3] = (-x[3] + y[1]*(-p[4] + p[3]))/p[5];

}
void g_ini_eval(double *out,double *x,double *y,double *u,double *p,double Dt){

out[0] = p[6]*y[1] + p[1]*y[0] - x[2] + y[4]*cos(x[0] - y[5]);
out[1] = p[6]*y[0] - p[4]*y[1] - x[3] + y[4]*sin(x[0] - y[5]);
out[2] = y[0]*y[4]*sin(x[0] - y[5]) + y[1]*y[4]*cos(x[0] - y[5]) - y[2];
out[3] = y[0]*y[4]*cos(x[0] - y[5]) - y[1]*y[4]*sin(x[0] - y[5]) - y[3];
out[4] = p[12]*y[4]*sin(p[13] - y[5])/p[7] + y[2];
out[5] = p[12]*y[4]*cos(p[13] - y[5])/p[7] + y[3] - pow(y[4], 2)/p[7];
...
out[0] = u[0];
out[1] = y[0]*(p[6]*y[0] + y[4]*sin(x[0] - y[5])) + y[1]*(p[6]*y[1] + y[4]*cos(x[0] - y[5]));
out[2] = u[1];
...
out[10] = (1.0/2.0)*(-y[0]*y[4]*cos(x[0] - y[5]) + y[1]*y[4]*sin(x[0] - y[5]))/p[8];
out[14] = (1.0/2.0)*(-2*p[6]*y[0] - y[4]*sin(x[0] - y[5]))/p[8];
out[15] = (1.0/2.0)*(-2*p[6]*y[1] - y[4]*cos(x[0] - y[5]))/p[8];
out[18] = (1.0/2.0)*(-y[0]*sin(x[0] - y[5]) - y[1]*cos(x[0] - y[5]))/p[8];
out[19] = (1.0/2.0)*(y[0]*y[4]*cos(x[0] - y[5]) - y[1]*y[4]*sin(x[0] - y[5]))/p[8];
out[40] = -y[4]*sin(x[0] - y[5]);
out[48] = cos(x[0] - y[5]);
out[49] = y[4]*sin(x[0] - y[5]);
out[50] = y[4]*cos(x[0] - y[5]);
out[58] = sin(x[0] - y[5]);
out[59] = -y[4]*cos(x[0] - y[5]);
out[60] = y[0]*y[4]*cos(x[0] - y[5]) - y[1]*y[4]*sin(x[0] - y[5]);
out[64] = y[4]*sin(x[0] - y[5]);
out[65] = y[4]*cos(x[0] - y[5]);
out[68] = y[0]*sin(x[0] - y[5]) + y[1]*cos(x[0] - y[5]);
out[69] = -y[0]*y[4]*cos(x[0] - y[5]) + y[1]*y[4]*sin(x[0] - y[5]);
out[70] = -y[0]*y[4]*sin(x[0] - y[5]) - y[1]*y[4]*cos(x[0] - y[5]);
out[74] = y[4]*cos(x[0] - y[5]);
out[75] = -y[4]*sin(x[0] - y[5]);
out[78] = y[0]*cos(x[0] - y[5]) - y[1]*sin(x[0] - y[5]);
out[79] = y[0]*y[4]*sin(x[0] - y[5]) + y[1]*y[4]*cos(x[0] - y[5]);
out[88] = p[12]*sin(p[13] - y[5])/p[7];
out[89] = -p[12]*y[4]*cos(p[13] - y[5])/p[7];
out[98] = p[12]*cos(p[13] - y[5])/p[7] - 2*y[4]/p[7];
out[99] = p[12]*y[4]*sin(p[13] - y[5])/p[7];
...
out[2] = (1.0/2.0)*(-y[0]*y[4]*cos(x[0] - y[5]) + y[1]*y[4]*sin(x[0] - y[5]))/p[8];
out[4] = (1.0/2.0)*(-2*p[6]*y[0] - y[4]*sin(x[0] - y[5]))/p[8];
out[5] = (1.0/2.0)*(-2*p[6]*y[1] - y[4]*cos(x[0] - y[5]))/p[8];
out[6] = (1.0/2.0)*(-y[0]*sin(x[0] - y[5]) - y[1]*cos(x[0] - y[5]))/p[8];
out[7] = (1.0/2.0)*(y[0]*y[4]*cos(x[0] - y[5]) - y[1]*y[4]*sin(x[0] - y[5]))/p[8];
out[12] = -y[4]*sin(x[0] - y[5]);
out[16] = cos(x[0] - y[5]);
out[17] = y[4]*sin(x[0] - y[5]);
out[18] = y[4]*cos(x[0] - y[5]);
out[22] = sin(x[0] - y[5]);
out[23] = -y[4]*cos(x[0] - y[5]);
out[24] = y[0]*y[4]*cos(x[0] - y[5]) - y[1]*y[4]*sin(x[0] - y[5]);
out[25] = y[4]*sin(x[0] - y[5]);
out[26] = y[4]*cos(x[0] - y[5]);
out[28] = y[0]*sin(x[0] - y[5]) + y[1]*cos(x[0] - y[5]);
out[29] = -y[0]*y[4]*cos(x[0] - y[5]) + y[1]*y[4]*sin(x[0] - y[5]);
out[30] = -y[0]*y[4]*sin(x[0] - y[5]) - y[1]*y[4]*cos(x[0] - y[5]);
out[31] = y[4]*cos(x[0] - y[5]);
out[32] = -y[4]*sin(x[0] - y[5]);
out[34] = y[0]*cos(x[0] - y[5]) - y[1]*sin(x[0] - y[5]);
out[35] = y[0]*y[4]*sin(x[0] - y[5]) + y[1]*y[4]*cos(x[0] - y[5]);
out[37] = p[12]*sin(p[13] - y[5])/p[7];
out[38] = -p[12]*y[4]*cos(p[13] - y[5])/p[7];
out[40] = p[12]*cos(p[13] - y[5])/p[7] - 2*y[4]/p[7];
out[41] = p[12]*y[4]*sin(p[13] - y[5])/p[7];
...
out[10] = -0.25*Dt*(-y[0]*y[4]*cos(x[0] - y[5]) + y[1]*y[4]*sin(x[0] - y[5]))/p[8];
out[14] = -0.25*Dt*(-2*p[6]*y[0] - y[4]*sin(x[0] - y[5]))/p[8];
out[15] = -0.25*Dt*(-2*p[6]*y[1] - y[4]*cos(x[0] - y[5]))/p[8];
out[18] = -0.25*Dt*(-y[0]*sin(x[0] - y[5]) - y[1]*cos(x[0] - y[5]))/p[8];
out[19] = -0.25*Dt*(y[0]*y[4]*cos(x[0] - y[5]) - y[1]*y[4]*sin(x[0] - y[5]))/p[8];
out[40] = -y[4]*sin(x[0] - y[5]);
out[48] = cos(x[0] - y[5]);
out[49] = y[4]*sin(x[0] - y[5]);
out[50] = y[4]*cos(x[0] - y[5]);
...
out[0] = 5.0000000000000002e-5*Dt + 1;
out[1] = -0.5*Dt*p[10];
out[11] = 0.25*p[9]*Dt/p[8] + 1;
out[22] = 0.5*Dt/p[2] + 1;
out[24] = -0.5*Dt*(p[1] - p[0])/p[2];
out[33] = 0.5*Dt/p[5] + 1;
out[35] = -0.5*Dt*(-p[4] + p[3])/p[5];
out[44] = p[1];
out[45] = p[6];
out[54] = p[6];
out[55] = -p[4];
...
out[2] = -0.25*Dt*(-y[0]*y[4]*cos(x[0] - y[5]) + y[1]*y[4]*sin(x[0] - y[5]))/p[8];
out[4] = -0.25*Dt*(-2*p[6]*y[0] - y[4]*sin(x[0] - y[5]))/p[8];
out[5] = -0.25*Dt*(-2*p[6]*y[1] - y[4]*cos(x[0] - y[5]))/p[8];
out[6] = -0.25*Dt*(-y[0]*sin(x[0] - y[5]) - y[1]*cos(x[0] - y[5]))/p[8];
out[7] = -0.25*Dt*(y[0]*y[4]*cos(x[0] - y[5]) - y[1]*y[4]*sin(x[0] - y[5]))/p[8];
out[12] = -y[4]*sin(x[0] - y[5]);
out[16] = cos(x[0] - y[5]);
out[17] = y[4]*sin(x[0] - y[5]);
out[18] = y[4]*cos(x[0] - y[5]);
...
out[0] = 5.0000000000000002e-5*Dt + 1;
out[1] = -0.5*Dt*p[10];
out[3] = 0.25*p[9]*Dt/p[8] + 1;
out[8] = 0.5*Dt/p[2] + 1;
out[9] = -0.5*Dt*(p[1] - p[0])/p[2];
out[10] = 0.5*Dt/p[5] + 1;
out[11] = -0.5*Dt*(-p[4] + p[3])/p[5];
out[14] = p[1];
out[15] = p[6];
out[20] = p[6];
out[21] = -p[4];
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_build_test(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_build_test(void) { return NULL; }
#  else
     initbuild_test(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_build_test(void)
{
  return _cffi_init("build_test", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initbuild_test(void)
{
  _cffi_init("build_test", 0x2601, &_cffi_type_context);
}
#endif
