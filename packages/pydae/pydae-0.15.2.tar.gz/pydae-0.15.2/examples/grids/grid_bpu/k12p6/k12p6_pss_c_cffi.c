...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_k12p6_pss_c_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_k12p6_pss_c_cffi(void) { return NULL; }
#  else
     initk12p6_pss_c_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_k12p6_pss_c_cffi(void)
{
  return _cffi_init("k12p6_pss_c_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initk12p6_pss_c_cffi(void)
{
  _cffi_init("k12p6_pss_c_cffi", 0x2601, &_cffi_type_context);
}
#endif
