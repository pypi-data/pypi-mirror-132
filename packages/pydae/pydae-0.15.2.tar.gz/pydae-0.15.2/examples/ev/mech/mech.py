...
class mech_class: 
    ...
    def __init__(self): 
        ...
        self.outputs_list = ['f_w', 'f_d', 'f_r', 'tau_r', 'p_r', 'nu_kmh'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 3, 0, 1, 0, 3, 0, 2]
    sp_jac_ini_ja = [0, 2, 4, 6, 8]
    sp_jac_ini_nia = 4
    sp_jac_ini_nja = 4
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 3, 0, 1, 0, 3, 0, 2]
    sp_jac_run_ja = [0, 2, 4, 6, 8]
    sp_jac_run_nia = 4
    sp_jac_run_nja = 4
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 3, 0, 1, 0, 3, 0, 2]
    sp_jac_trap_ja = [0, 2, 4, 6, 8]
    sp_jac_trap_nia = 4
    sp_jac_trap_nja = 4
