...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_mech_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_mech_cffi(void) { return NULL; }
#  else
     initmech_cffi(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_mech_cffi(void)
{
  return _cffi_init("mech_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initmech_cffi(void)
{
  _cffi_init("mech_cffi", 0x2601, &_cffi_type_context);
}
#endif
