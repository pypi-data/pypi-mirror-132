...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_ima_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_ima_cffi(void) { return NULL; }
#  else
     initima_cffi(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_ima_cffi(void)
{
  return _cffi_init("ima_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initima_cffi(void)
{
  _cffi_init("ima_cffi", 0x2601, &_cffi_type_context);
}
#endif
