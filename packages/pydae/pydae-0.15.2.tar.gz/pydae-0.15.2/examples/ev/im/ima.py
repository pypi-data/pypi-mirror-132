...
class ima_class: 
    ...
    def __init__(self): 
        ...
        self.N_z = 9 
        self.N_store = 10000 
        self.params_list = ['L_m', 'R_s', 'L_ls', 'R_r', 'L_lr', 'N_pp', 'J_r', 'B_r', 'K_p', 'K_i'] 
        self.params_values_list  = [1.0, 0.01, 0.01, 0.01, 0.01, 2.0, 1.0, 0.1, 1.0, 1.0] 
        self.inputs_ini_list = ['v_sd', 'v_sq', 'tau_l', 'omega'] 
        self.inputs_ini_values_list  = [0.0, 325.0, 0, 314.1592653589793] 
        self.inputs_run_list = ['v_sd', 'v_sq', 'tau_l', 'omega'] 
        self.inputs_run_values_list = [0.0, 325.0, 0, 314.1592653589793] 
        self.outputs_list = ['i_sd', 'i_sq', 'i_rd', 'i_rq', 'i_pk', 'tau_b', 'tau_l', 'p_s', 'q_s'] 
        self.x_list = ['omega_r'] 
        self.y_run_list = ['tau_r', 'lambda_sd', 'lambda_sq', 'lambda_rd', 'lambda_rq'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['tau_r', 'lambda_sd', 'lambda_sq', 'lambda_rd', 'lambda_rq'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 1, 2, 3, 4, 5, 2, 3, 4, 2, 3, 5, 0, 2, 4, 5, 0, 3, 4, 5]
    sp_jac_ini_ja = [0, 2, 7, 10, 13, 17, 21]
    sp_jac_ini_nia = 6
    sp_jac_ini_nja = 6
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 1, 2, 3, 4, 5, 2, 3, 4, 2, 3, 5, 0, 2, 4, 5, 0, 3, 4, 5]
    sp_jac_trap_ja = [0, 2, 7, 10, 13, 17, 21]
    sp_jac_trap_nia = 6
    sp_jac_trap_nja = 6
