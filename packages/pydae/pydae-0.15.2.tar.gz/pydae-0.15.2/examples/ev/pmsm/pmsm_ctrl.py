...
class pmsm_ctrl_class: 
    ...
    def __init__(self): 
        ...
        self.N_z = 4 
        self.N_store = 10000 
        self.params_list = ['L_s', 'R_s', 'N_pp', 'Phi', 'K_p', 'K_i'] 
        self.params_values_list  = [0.01, 0.01, 2.0, 1.0, 1.0, 1.0] 
        self.inputs_ini_list = ['tau_r_ref', 'i_d_ref', 'omega_r'] 
        self.inputs_ini_values_list  = [0.0, 0.0, 0.0] 
        self.inputs_run_list = ['tau_r_ref', 'i_d_ref', 'omega_r'] 
        self.inputs_run_values_list = [0.0, 0.0, 0.0] 
        self.outputs_list = ['u_d', 'u_q', 'tau_r_ref', 'v_pk'] 
        self.x_list = ['i_d', 'i_q', 'xi_i_d', 'xi_i_q'] 
        self.y_run_list = ['tau_r', 'omega_e', 'v_d', 'v_q', 'i_q_ref'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['tau_r', 'omega_e', 'v_d', 'v_q', 'i_q_ref'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 5, 6, 0, 1, 5, 7, 0, 1, 8, 1, 4, 5, 0, 1, 2, 5, 6, 0, 1, 3, 5, 7, 8, 8]
    sp_jac_ini_ja = [0, 4, 8, 9, 11, 13, 14, 19, 25, 26]
    sp_jac_ini_nia = 9
    sp_jac_ini_nja = 9
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 5, 6, 0, 1, 5, 7, 0, 2, 1, 3, 8, 1, 4, 5, 0, 1, 2, 5, 6, 0, 1, 3, 5, 7, 8, 8]
    sp_jac_trap_ja = [0, 4, 8, 10, 13, 15, 16, 21, 27, 28]
    sp_jac_trap_nia = 9
    sp_jac_trap_nja = 9
