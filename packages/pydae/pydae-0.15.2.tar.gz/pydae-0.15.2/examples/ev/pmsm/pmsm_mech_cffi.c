...
out[4] = y[0]/(p[9]*p[6]);
out[5] = 0.5*p[13]*p[11]*p[12]*pow(x[4], 2)*y[5];
out[6] = p[10]*p[7]*p[8]*y[5];
out[7] = y[0];
out[8] = y[6]*y[0];
out[9] = 3.6000000000000001*x[4];
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_pmsm_mech_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_pmsm_mech_cffi(void) { return NULL; }
#  else
     initpmsm_mech_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_pmsm_mech_cffi(void)
{
  return _cffi_init("pmsm_mech_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initpmsm_mech_cffi(void)
{
  _cffi_init("pmsm_mech_cffi", 0x2601, &_cffi_type_context);
}
#endif
