...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_im_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_im_cffi(void) { return NULL; }
#  else
     initim_cffi(void) { }
#  endif
#  endif
...
PyInit_im_cffi(void)
{
  return _cffi_init("im_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initim_cffi(void)
{
  _cffi_init("im_cffi", 0x2601, &_cffi_type_context);
}
#endif
