...
class pmsm_mech_class: 
    ...
    def __init__(self): 
        ...
        self.N_z = 10 
        self.N_store = 10000 
        self.params_list = ['L_s', 'R_s', 'N_pp', 'Phi', 'K_p', 'K_i', 'R_w', 'G', 'M', 'K_w', 'C_rr', 'Rho', 'S_f', 'C_x', 'K_sign'] 
        self.params_values_list  = [0.01, 0.01, 2.0, 1.0, 1.0, 1.0, 0.316, 9.81, 1200.0, 1.0, 0.03, 1.225, 2.13, 0.32, 100] 
        self.inputs_ini_list = ['tau_r_ref', 'i_d_ref', 'beta'] 
        self.inputs_ini_values_list  = [0.0, 0.0, 0.0] 
        self.inputs_run_list = ['tau_r_ref', 'i_d_ref', 'beta'] 
        self.inputs_run_values_list = [0.0, 0.0, 0.0] 
        self.outputs_list = ['u_d', 'u_q', 'tau_r_ref', 'v_pk', 'f_w', 'f_d', 'f_r', 'tau_r', 'p_r', 'nu_kmh'] 
        self.x_list = ['i_d', 'i_q', 'xi_i_d', 'xi_i_q', 'nu', 'x_pos'] 
        self.y_run_list = ['tau_r', 'omega_e', 'v_d', 'v_q', 'i_q_ref', 'snu', 'omega_r'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['tau_r', 'omega_e', 'v_d', 'v_q', 'i_q_ref', 'snu', 'omega_r'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 7, 8, 0, 1, 7, 9, 0, 1, 10, 4, 6, 11, 4, 5, 1, 6, 7, 12, 0, 1, 2, 7, 8, 0, 1, 3, 7, 9, 10, 10, 4, 11, 4, 12]
    sp_jac_ini_ja = [0, 4, 8, 9, 11, 14, 16, 18, 20, 25, 31, 32, 34, 36]
    sp_jac_ini_nia = 13
    sp_jac_ini_nja = 13
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 7, 8, 0, 1, 7, 9, 0, 2, 1, 3, 10, 4, 6, 11, 4, 5, 1, 6, 7, 12, 0, 1, 2, 7, 8, 0, 1, 3, 7, 9, 10, 10, 4, 11, 4, 12]
    sp_jac_trap_ja = [0, 4, 8, 10, 13, 16, 18, 20, 22, 27, 33, 34, 36, 38]
    sp_jac_trap_nia = 13
    sp_jac_trap_nja = 13
