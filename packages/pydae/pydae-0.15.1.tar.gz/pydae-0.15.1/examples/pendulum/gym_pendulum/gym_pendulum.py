...
import gym_pendulum_cffi as jacs
...
class gym_pendulum_class: 
    ...
    def __init__(self): 
        ...
        self.inputs_ini_list = ['theta_m'] 
        self.inputs_ini_values_list  = [0.08726646259971647] 
        self.inputs_run_list = ['tau_ref'] 
        self.inputs_run_values_list = [10] 
        self.outputs_list = ['theta'] 
        self.x_list = ['theta', 'omega'] 
        self.y_run_list = ['theta_m', 'tau'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['tau_ref', 'tau'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [1, 0, 3, 2, 3, 0]
    sp_jac_ini_ja = [0, 1, 3, 5, 6]
    sp_jac_ini_nia = 4
    sp_jac_ini_nja = 4
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 0, 1, 3, 3, 0, 2]
    sp_jac_trap_ja = [0, 2, 5, 6, 8]
    sp_jac_trap_nia = 4
    sp_jac_trap_nja = 4
