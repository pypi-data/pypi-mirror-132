...
out[0] = x[1];
out[1] = 1.5*p[1]*sin(x[0])/p[0] + 3*y[1]/(pow(p[0], 2)*p[2]);
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_gym_pendulum_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_gym_pendulum_cffi(void) { return NULL; }
#  else
     initgym_pendulum_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_gym_pendulum_cffi(void)
{
  return _cffi_init("gym_pendulum_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initgym_pendulum_cffi(void)
{
  _cffi_init("gym_pendulum_cffi", 0x2601, &_cffi_type_context);
}
#endif
