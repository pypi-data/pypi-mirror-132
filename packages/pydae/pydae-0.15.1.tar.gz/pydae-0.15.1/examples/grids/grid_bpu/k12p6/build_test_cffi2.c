...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_build_test_cffi2(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_build_test_cffi2(void) { return NULL; }
#  else
     initbuild_test_cffi2(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_build_test_cffi2(void)
{
  return _cffi_init("build_test_cffi2", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initbuild_test_cffi2(void)
{
  _cffi_init("build_test_cffi2", 0x2601, &_cffi_type_context);
}
#endif
