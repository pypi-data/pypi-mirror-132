...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_k12p6_pss(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_k12p6_pss(void) { return NULL; }
#  else
     initk12p6_pss(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_k12p6_pss(void)
{
  return _cffi_init("k12p6_pss", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initk12p6_pss(void)
{
  _cffi_init("k12p6_pss", 0x2601, &_cffi_type_context);
}
#endif
