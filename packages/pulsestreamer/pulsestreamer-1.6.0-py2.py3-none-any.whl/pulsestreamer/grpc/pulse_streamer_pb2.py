...
_SETNETWORKMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='dhcp', full_name='pulse_streamer.SetNetworkMessage.dhcp', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ip', full_name='pulse_streamer.SetNetworkMessage.ip', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='netmask', full_name='pulse_streamer.SetNetworkMessage.netmask', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='gateway', full_name='pulse_streamer.SetNetworkMessage.gateway', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='testmode', full_name='pulse_streamer.SetNetworkMessage.testmode', index=4,
...
_GETNETWORKMESSAGE = _descriptor.Descriptor(
  name='GetNetworkMessage',
  full_name='pulse_streamer.GetNetworkMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='permanent', full_name='pulse_streamer.GetNetworkMessage.permanent', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETNETWORKREPLY = _descriptor.Descriptor(
  ...
  full_name='pulse_streamer.GetNetworkReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dhcp', full_name='pulse_streamer.GetNetworkReply.dhcp', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ip', full_name='pulse_streamer.GetNetworkReply.ip', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='netmask', full_name='pulse_streamer.GetNetworkReply.netmask', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='gateway', full_name='pulse_streamer.GetNetworkReply.gateway', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SUPPLYSTATUSDATA = _descriptor.Descriptor(
  name='SupplyStatusData',
  full_name='pulse_streamer.SupplyStatusData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='efuse_current', full_name='pulse_streamer.SupplyStatusData.efuse_current', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='v12', full_name='pulse_streamer.SupplyStatusData.v12', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='v33', full_name='pulse_streamer.SupplyStatusData.v33', index=2,
      number=3, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SETSQUAREWAVEMESSAGE = _descriptor.Descriptor(
  name='SetSquareWaveMessage',
  full_name='pulse_streamer.SetSquareWaveMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='digi', full_name='pulse_streamer.SetSquareWaveMessage.digi', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['GetNetworkMessage'] = _GETNETWORKMESSAGE
...
DESCRIPTOR.message_types_by_name['SupplyStatusData'] = _SUPPLYSTATUSDATA
DESCRIPTOR.message_types_by_name['SetSquareWaveMessage'] = _SETSQUAREWAVEMESSAGE
...
GetNetworkMessage = _reflection.GeneratedProtocolMessageType('GetNetworkMessage', (_message.Message,), dict(
  DESCRIPTOR = _GETNETWORKMESSAGE,
  __module__ = 'pulse_streamer_pb2'
  # @@protoc_insertion_point(class_scope:pulse_streamer.GetNetworkMessage)
  ))
_sym_db.RegisterMessage(GetNetworkMessage)

GetNetworkReply = _reflection.GeneratedProtocolMessageType('GetNetworkReply', (_message.Message,), dict(
  DESCRIPTOR = _GETNETWORKREPLY,
  __module__ = 'pulse_streamer_pb2'
  # @@protoc_insertion_point(class_scope:pulse_streamer.GetNetworkReply)
  ))
...
SupplyStatusData = _reflection.GeneratedProtocolMessageType('SupplyStatusData', (_message.Message,), dict(
  DESCRIPTOR = _SUPPLYSTATUSDATA,
  __module__ = 'pulse_streamer_pb2'
  # @@protoc_insertion_point(class_scope:pulse_streamer.SupplyStatusData)
  ))
_sym_db.RegisterMessage(SupplyStatusData)

SetSquareWaveMessage = _reflection.GeneratedProtocolMessageType('SetSquareWaveMessage', (_message.Message,), dict(
  DESCRIPTOR = _SETSQUAREWAVEMESSAGE,
  __module__ = 'pulse_streamer_pb2'
  # @@protoc_insertion_point(class_scope:pulse_streamer.SetSquareWaveMessage)
  ))
_sym_db.RegisterMessage(SetSquareWaveMessage)
...
_PULSESTREAMER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='reboot',
    full_name='pulse_streamer.PulseStreamer.reboot',
    index=1,
    containing_service=None,
    input_type=_VOIDMESSAGE,
    output_type=_PULSESTREAMERREPLY,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='pulse_streamer.PulseStreamer.setNetworkConfiguration',
    index=20,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='pulse_streamer.PulseStreamer.getNetworkConfiguration',
    index=21,
    containing_service=None,
    input_type=_GETNETWORKMESSAGE,
    output_type=_GETNETWORKREPLY,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='applyNetworkConfiguration',
    full_name='pulse_streamer.PulseStreamer.applyNetworkConfiguration',
    index=22,
    containing_service=None,
    input_type=_VOIDMESSAGE,
    output_type=_PULSESTREAMERREPLY,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='pulse_streamer.PulseStreamer.getHardwareVersion',
    index=31,
    containing_service=None,
    input_type=_VOIDMESSAGE,
    output_type=_PULSESTREAMERSTRINGREPLY,
  ...
  _descriptor.MethodDescriptor(
    name='getSupplyState',
    full_name='pulse_streamer.PulseStreamer.getSupplyState',
    index=32,
    containing_service=None,
    input_type=_VOIDMESSAGE,
    output_type=_SUPPLYSTATUSDATA,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='setSquareWave125MHz',
    full_name='pulse_streamer.PulseStreamer.setSquareWave125MHz',
    index=33,
    containing_service=None,
    input_type=_SETSQUAREWAVEMESSAGE,
    output_type=_PULSESTREAMERREPLY,
    serialized_options=None,
  ),
])
...
try:
  ...
  class PulseStreamerStub(object):
    ...
    def __init__(self, channel):
      ...
      self.getNetworkConfiguration = channel.unary_unary(
          ...
          request_serializer=GetNetworkMessage.SerializeToString,
          response_deserializer=GetNetworkReply.FromString,
          )
      ...
      self.getSupplyState = channel.unary_unary(
          ...
          request_serializer=VoidMessage.SerializeToString,
          response_deserializer=SupplyStatusData.FromString,
          )
      self.setSquareWave125MHz = channel.unary_unary(
          '/pulse_streamer.PulseStreamer/setSquareWave125MHz',
          request_serializer=SetSquareWaveMessage.SerializeToString,
          response_deserializer=PulseStreamerReply.FromString,
          )
  ...
  def add_PulseStreamerServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'getNetworkConfiguration': grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=GetNetworkMessage.FromString,
            response_serializer=GetNetworkReply.SerializeToString,
        ),
        ...
        'getSupplyState': grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=VoidMessage.FromString,
            response_serializer=SupplyStatusData.SerializeToString,
        ),
        'setSquareWave125MHz': grpc.unary_unary_rpc_method_handler(
            servicer.setSquareWave125MHz,
            request_deserializer=SetSquareWaveMessage.FromString,
            response_serializer=PulseStreamerReply.SerializeToString,
        ),
    }
  ...
  class BetaPulseStreamerStub(object):
    ...
    def setNetworkConfiguration(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      # missing associated documentation comment in .proto file
      pass
      raise NotImplementedError()
    setNetworkConfiguration.future = None
    def getNetworkConfiguration(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      # missing associated documentation comment in .proto file
      pass
      raise NotImplementedError()
    getNetworkConfiguration.future = None
    def applyNetworkConfiguration(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      # missing associated documentation comment in .proto file
      pass
      raise NotImplementedError()
    applyNetworkConfiguration.future = None
    ...
    def getHardwareVersion(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      # missing associated documentation comment in .proto file
      pass
      raise NotImplementedError()
    getHardwareVersion.future = None
    def getSupplyState(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      # missing associated documentation comment in .proto file
      pass
      raise NotImplementedError()
    getSupplyState.future = None
    def setSquareWave125MHz(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      # missing associated documentation comment in .proto file
      pass
      raise NotImplementedError()
    setSquareWave125MHz.future = None
  ...
  def beta_create_PulseStreamer_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ('pulse_streamer.PulseStreamer', 'applyNetworkConfiguration'): VoidMessage.FromString,
      ...
      ('pulse_streamer.PulseStreamer', 'getHardwareVersion'): VoidMessage.FromString,
      ('pulse_streamer.PulseStreamer', 'getHostname'): VoidMessage.FromString,
      ('pulse_streamer.PulseStreamer', 'getNetworkConfiguration'): GetNetworkMessage.FromString,
      ('pulse_streamer.PulseStreamer', 'getSerial'): VoidMessage.FromString,
      ('pulse_streamer.PulseStreamer', 'getSupplyState'): VoidMessage.FromString,
      ...
      ('pulse_streamer.PulseStreamer', 'reboot'): VoidMessage.FromString,
      ...
      ('pulse_streamer.PulseStreamer', 'setNetworkConfiguration'): SetNetworkMessage.FromString,
      ('pulse_streamer.PulseStreamer', 'setSquareWave125MHz'): SetSquareWaveMessage.FromString,
    ...
    response_serializers = {
      ('pulse_streamer.PulseStreamer', 'applyNetworkConfiguration'): PulseStreamerReply.SerializeToString,
      ...
      ('pulse_streamer.PulseStreamer', 'getHardwareVersion'): PulseStreamerStringReply.SerializeToString,
      ('pulse_streamer.PulseStreamer', 'getHostname'): PulseStreamerStringReply.SerializeToString,
      ('pulse_streamer.PulseStreamer', 'getNetworkConfiguration'): GetNetworkReply.SerializeToString,
      ('pulse_streamer.PulseStreamer', 'getSerial'): PulseStreamerStringReply.SerializeToString,
      ('pulse_streamer.PulseStreamer', 'getSupplyState'): SupplyStatusData.SerializeToString,
      ...
      ('pulse_streamer.PulseStreamer', 'reboot'): PulseStreamerReply.SerializeToString,
      ...
      ('pulse_streamer.PulseStreamer', 'setNetworkConfiguration'): PulseStreamerReply.SerializeToString,
      ('pulse_streamer.PulseStreamer', 'setSquareWave125MHz'): PulseStreamerReply.SerializeToString,
    ...
    method_implementations = {
      ('pulse_streamer.PulseStreamer', 'applyNetworkConfiguration'): face_utilities.unary_unary_inline(servicer.applyNetworkConfiguration),
      ...
      ('pulse_streamer.PulseStreamer', 'getHardwareVersion'): face_utilities.unary_unary_inline(servicer.getHardwareVersion),
      ('pulse_streamer.PulseStreamer', 'getHostname'): face_utilities.unary_unary_inline(servicer.getHostname),
      ('pulse_streamer.PulseStreamer', 'getNetworkConfiguration'): face_utilities.unary_unary_inline(servicer.getNetworkConfiguration),
      ('pulse_streamer.PulseStreamer', 'getSerial'): face_utilities.unary_unary_inline(servicer.getSerial),
      ('pulse_streamer.PulseStreamer', 'getSupplyState'): face_utilities.unary_unary_inline(servicer.getSupplyState),
      ...
      ('pulse_streamer.PulseStreamer', 'reboot'): face_utilities.unary_unary_inline(servicer.reboot),
      ...
      ('pulse_streamer.PulseStreamer', 'setNetworkConfiguration'): face_utilities.unary_unary_inline(servicer.setNetworkConfiguration),
      ('pulse_streamer.PulseStreamer', 'setSquareWave125MHz'): face_utilities.unary_unary_inline(servicer.setSquareWave125MHz),
  ...
  def beta_create_PulseStreamer_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('pulse_streamer.PulseStreamer', 'applyNetworkConfiguration'): VoidMessage.SerializeToString,
      ...
      ('pulse_streamer.PulseStreamer', 'getHardwareVersion'): VoidMessage.SerializeToString,
      ('pulse_streamer.PulseStreamer', 'getHostname'): VoidMessage.SerializeToString,
      ('pulse_streamer.PulseStreamer', 'getNetworkConfiguration'): GetNetworkMessage.SerializeToString,
      ('pulse_streamer.PulseStreamer', 'getSerial'): VoidMessage.SerializeToString,
      ('pulse_streamer.PulseStreamer', 'getSupplyState'): VoidMessage.SerializeToString,
      ...
      ('pulse_streamer.PulseStreamer', 'reboot'): VoidMessage.SerializeToString,
      ...
      ('pulse_streamer.PulseStreamer', 'setNetworkConfiguration'): SetNetworkMessage.SerializeToString,
      ('pulse_streamer.PulseStreamer', 'setSquareWave125MHz'): SetSquareWaveMessage.SerializeToString,
    ...
    response_deserializers = {
      ('pulse_streamer.PulseStreamer', 'applyNetworkConfiguration'): PulseStreamerReply.FromString,
      ...
      ('pulse_streamer.PulseStreamer', 'getHardwareVersion'): PulseStreamerStringReply.FromString,
      ('pulse_streamer.PulseStreamer', 'getHostname'): PulseStreamerStringReply.FromString,
      ('pulse_streamer.PulseStreamer', 'getNetworkConfiguration'): GetNetworkReply.FromString,
      ('pulse_streamer.PulseStreamer', 'getSerial'): PulseStreamerStringReply.FromString,
      ('pulse_streamer.PulseStreamer', 'getSupplyState'): SupplyStatusData.FromString,
      ...
      ('pulse_streamer.PulseStreamer', 'reboot'): PulseStreamerReply.FromString,
      ...
      ('pulse_streamer.PulseStreamer', 'setNetworkConfiguration'): PulseStreamerReply.FromString,
      ('pulse_streamer.PulseStreamer', 'setSquareWave125MHz'): PulseStreamerReply.FromString,
    ...
    cardinalities = {
      'applyNetworkConfiguration': cardinality.Cardinality.UNARY_UNARY,
      ...
      'getHardwareVersion': cardinality.Cardinality.UNARY_UNARY,
      'getHostname': cardinality.Cardinality.UNARY_UNARY,
      'getNetworkConfiguration': cardinality.Cardinality.UNARY_UNARY,
      'getSerial': cardinality.Cardinality.UNARY_UNARY,
      'getSupplyState': cardinality.Cardinality.UNARY_UNARY,
      ...
      'setNetworkConfiguration': cardinality.Cardinality.UNARY_UNARY,
      'setSquareWave125MHz': cardinality.Cardinality.UNARY_UNARY,
