...
HP662XChannelCapabilities = {
    ...
    HP662XType.HP6627A: [PowerSupplyChannelCapability(min_voltage=0,
                         ...
                         PowerSupplyChannelCapability(min_voltage=0,
                                                      ...
                                                      max_ocv=55,
                                                      protection_modes=PowerSupplyProtectionModeAll)],
    HP662XType.HP6629A: [PowerSupplyChannelCapability(min_voltage=0,
                                                      max_voltage=50.5,
                                                      max_current=2.06,
                                                      max_ocv=55,
                                                      protection_modes=PowerSupplyProtectionModeAll),
...
HP662XInstrumentCapabilities = {
    ...
    HP662XType.HP6629A: PowerSupplyCapability()
}
...
class _HP662XAContext(PowerSupply):
    ...
    def set_output_voltage(self, channel: int, voltage: float):
        ...
        if voltage > self.channel_capabilities[channel].max_voltage \
            ...
            raise ValueError(
                f'{voltage} is outside of the voltage range [{self.channel_capabilities[channel].min_voltage}, ' +
                f'{self.channel_capabilities[channel].max_voltage}] for the {self.name} on channel #{channel + 1}.')
    ...
    def set_output_current(self, channel: int, current: float):
        ...
        if current > self.channel_capabilities[channel].max_current:
            raise ValueError(
                f'{current} is greater than the current max of {self.channel_capabilities[channel].max_current} ' +
                f'for the {self.name} on channel #{channel + 1}.')
...
class HP663XType(Enum):
    """Represents the specific HP 663X or 6038A implementation to use."""
    HP6632A = 0
    HP6633A = 1
    HP6634A = 2
    HP6038A = 3
...
HP663XChannelCapabilities = {
    ...
    HP663XType.HP6634A: [PowerSupplyChannelCapability(min_voltage=0,
                                                      ...
                                                      max_ocv=110,
                                                      protection_modes=PowerSupplyProtectionModeAll)],
    HP663XType.HP6038A: [PowerSupplyChannelCapability(min_voltage=0,
                                                      max_voltage=60,
                                                      max_current=10,
                                                      max_ocv=110,
                                                      protection_modes=PowerSupplyProtectionModeAll)]
...
HP663XInstrumentCapabilities = {
    ...
    HP663XType.HP6038A: PowerSupplyCapability()
}
_HP66XX_TERMINATOR = "\r\n"
...
class _HP663XAContext(PowerSupply):
    ...
    def get_output_voltage(self, channel: int) -> float:
        ...
        try:
            ...
            temp_resp = resp.split()
            resp = float(temp_resp[1])
        return resp
    ...
    def set_output_voltage(self, channel: int, voltage: float):
        ...
        if voltage > self.channel_capabilities[channel].max_voltage \
            ...
            raise ValueError(
                f'{voltage} is outside of the voltage range [{self.channel_capabilities[channel].min_voltage}, ' +
                f'{self.channel_capabilities[channel].max_voltage}] for the {self.name}')
...
@HP66XXAInstrument(HP662XType.HP6629A)
class HP6629A:
    """HP6629A"""
    pass
...
@HP66XXAInstrument(HP663XType.HP6038A)
class HP6038A:
    """HP6038A"""
    pass
