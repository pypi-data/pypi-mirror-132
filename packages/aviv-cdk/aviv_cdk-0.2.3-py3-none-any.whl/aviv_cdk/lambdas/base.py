...
class Construct(core.Construct):
    ...
    def __init__(self,  scope: core.Construct, id: str, *, lambdas: dict=None, layers: dict=None):
    ...
    def Function(self, id: str, *, **attr) -> aws_lambda.Function:
        ...
        core.CfnOutput(self, f"{id}-cfn", value=fx.function_arn)
        return fx
    ...
    def LayerVersion(self, id: str, *, remote_account_grant: bool=False, ssm_param: bool=True, **attr) -> aws_lambda.LayerVersion:
        ...
        core.CfnOutput(self, f"{id}-cfn", value=layv.from_layer_version_arn)
        return layv
