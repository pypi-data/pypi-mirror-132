...
class HostedZone(core.Construct):
    ...
    def __init__(self, scope: core.Construct, id: str, *, fqdn: str,  zone_id: str=None, **kwargs) -> None:
    ...
    def create_certificate(self, domain_name: str, subject_alternative_names: list=None, cert_authority: str=None):
        ...
        core.CfnOutput(self, f"{domid}-certificate-arn", value=self.cert.certificate_arn, export_name=f"{domid}-cert-arn")
        return self.cert
