...
# TIME
DATE_ISO_8601 = "%Y-%m-%d"
DATE_END = os.environ["DATE_END"] if "DATE_END" in os.environ else datetime.datetime.now().strftime(DATE_ISO_8601)
DATE_START = os.environ["DATE_START"] if "DATE_START" in os.environ else (datetime.datetime.now() - datetime.timedelta(days=7)).strftime(DATE_ISO_8601)
