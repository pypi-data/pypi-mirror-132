...
class EventTypeSchemaIn(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, schema, *args, **kwargs):  # noqa: E501
        """EventTypeSchemaIn - a model defined in OpenAPI

        Args:
            schema ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The schema for an event type
    ...
    @convert_js_args_to_python_args
    def __init__(self, schema, *args, **kwargs):  # noqa: E501
        """EventTypeSchemaIn - a model defined in OpenAPI
