...
class StatisticsPeriod(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """StatisticsPeriod - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Period length for a statistics data point., must be one of ["OneDay", "FiveMinutes", ]  # noqa: E501

        Keyword Args:
            value (str): Period length for a statistics data point., must be one of ["OneDay", "FiveMinutes", ]  # noqa: E501
