...
class MessageIn(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'payload_retention_period': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'payload_retention_period': 'payloadRetentionPeriod',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, event_type, payload, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            event_id (str): Optional unique identifier for the message. [optional]  # noqa: E501
            payload_retention_period (int): The retention period for the payload (in days).. [optional] if omitted the server will use the default value of 90  # noqa: E501
        """
