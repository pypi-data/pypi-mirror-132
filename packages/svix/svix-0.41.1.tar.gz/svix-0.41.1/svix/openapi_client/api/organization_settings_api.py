...
from svix.openapi_client.model.portal_settings_out import PortalSettingsOut
...
class OrganizationSettingsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_org_settings_api_v1_org_settings_get(
            self,
            **kwargs
        ):
            """Get Org Settings  # noqa: E501

            Get the organization's settings  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_org_settings_api_v1_org_settings_get(async_req=True)
            >>> result = thread.get()
        ...
        self.get_org_settings_api_v1_org_settings_get = _Endpoint(
            settings={
                'response_type': (PortalSettingsOut,),
                'auth': [
                    'HTTPBearer'
                ],
                'endpoint_path': '/api/v1/org/settings/',
                'operation_id': 'get_org_settings_api_v1_org_settings_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__get_org_settings_api_v1_org_settings_get
        )
