    ...
    def __init__(self, api_client=None):
        ...
        def __create_message_api_v1_app_app_id_msg_post(
            ...
            **kwargs
            ...
            Creates a new message and dispatches it to all of the application's endpoints.  The `eventId` is an optional custom unique ID. If a message with the same `eventId` already exists for any application in your environment, a 409 conflict error will be returned.  # noqa: E501
