...
class EndpointStats(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fail, pending, sending, success, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, fail, pending, sending, success, *args, **kwargs):  # noqa: E501
        """EndpointStats - a model defined in OpenAPI
