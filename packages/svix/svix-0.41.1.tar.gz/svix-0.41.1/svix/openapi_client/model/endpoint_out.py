...
class EndpointOut(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, id, updated_at, url, version, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_at, id, updated_at, url, version, *args, **kwargs):  # noqa: E501
        """EndpointOut - a model defined in OpenAPI
