...
def lazy_import():
    ...
    globals()['MessageAttemptExhaustedEventData'] = MessageAttemptExhaustedEventData


class MessageAttemptExhaustedEvent(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (MessageAttemptExhaustedEventData,),  # noqa: E501
            'type': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            type (str): [optional] if omitted the server will use the default value of "message.attempt.exhausted"  # noqa: E501
        """
