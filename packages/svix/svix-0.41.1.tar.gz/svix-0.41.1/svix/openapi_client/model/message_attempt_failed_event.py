...
class MessageAttemptFailedEvent(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, response_status_code, timestamp, *args, **kwargs):  # noqa: E501
        """MessageAttemptFailedEvent - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, response_status_code, timestamp, *args, **kwargs):  # noqa: E501
        """MessageAttemptFailedEvent - a model defined in OpenAPI
