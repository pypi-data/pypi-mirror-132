...
class MessageAttemptTriggerType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (int): The reason an attempt was made: - Scheduled = 0 - Manual = 1., must be one of [0, 1, ]  # noqa: E501

        Keyword Args:
            value (int): The reason an attempt was made: - Scheduled = 0 - Manual = 1., must be one of [0, 1, ]  # noqa: E501
