...
class EventTypeExampleOut(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, example, *args, **kwargs):  # noqa: E501
        """EventTypeExampleOut - a model defined in OpenAPI

        Args:
            example ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}):
    ...
    @convert_js_args_to_python_args
    def __init__(self, example, *args, **kwargs):  # noqa: E501
        """EventTypeExampleOut - a model defined in OpenAPI
