...
class MessageAttemptEndpointOut(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, response, response_status_code, status, timestamp, trigger_type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, response, response_status_code, status, timestamp, trigger_type, *args, **kwargs):  # noqa: E501
        """MessageAttemptEndpointOut - a model defined in OpenAPI
