...
class MessageOut(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, event_type, id, payload, timestamp, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, event_type, id, payload, timestamp, *args, **kwargs):  # noqa: E501
        """MessageOut - a model defined in OpenAPI
