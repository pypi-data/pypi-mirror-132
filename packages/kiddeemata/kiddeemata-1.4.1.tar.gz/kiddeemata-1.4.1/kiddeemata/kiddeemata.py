...
from kiddeemata.pin_data import PinData
from kiddeemata.private_constants import PrivateConstants
from kiddeemata import INPUT, OUTPUT, ANALOG, PWM

# noinspection PyPep8
class KiddeeMata(threading.Thread):
    """
    ...
    class motor:
        def __init__(self, board, AI1=None, AI2=None, PWMA=None, BI1=None, BI2=None, PWMB=None):
            if isinstance(AI1, int):
                ...
                if pins == None:
                    print('Invalid version entered: '+AI1+'!', 'Valid versions are: v1, v2, v3, v4, v5')
                    return
