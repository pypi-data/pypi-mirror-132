...
from src.popoto._archive.key_value import KeyValueModel
...
class SortedSetModel(KeyValueModel):
    ...
    def query(cls, key: str = "", key_suffix: str = "", key_prefix: str = "",
        ...
        if not score:
            ...
            try:
                [value, score] = query_response[0].decode(ENCODING).split(":")
            except:
    ...
    def publish(self, pipeline: redis.client.Pipeline = None):
