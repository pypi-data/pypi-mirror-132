...
* Installation:
        ...
        conda install -c bioconda "biobb_cmip>=3.7.3"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_cmip:3.7.3--pyhdfd78af_0


* Usage:


        docker run quay.io/biocontainers/biobb_cmip:3.7.3--pyhdfd78af_0 <command>
